 ...
 */function Se(e,o){if(!ln())return null;var t,c={typeOf:e.type||"Atalasoft.Controls.WebDocumentViewer"},s="",k=150,u=500,x="atala-ui-icon",n=document.createElement("div"),i=Qt({}),a=Qt({}),r=new pn({get:function(){return c},isInitialized:At,switchDocument:gt,closeDocument:mt}),y={
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function openUrl
   */function Vt(e,t,n,o){null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null));var i=0,a=!1,r=wt(t,e,C.annotations),l=wt(n||e,e,C.forms);M.annotationsurl=r?r.url:M.annotationsurl,M.formsurl=l?l.url:M.formsurl;var s,c,u,d,h=function(e,t){--i<=0&&(Dt(!0),jt({type:"documentloaded",customData:null==t?void 0:t.customData}),"function"==typeof o&&o.call(void 0,e,t))};if("string"==typeof e){if(0===e.length)Mt(h);else if(M.documenturl=e,S.initialized){Ft(),X(y.scrollH),X(y.scrollV),i++,0===e.length&&Mt(h);var f={};M.allowannotations&&r&&r.data&&(zt(),Qt.extend(f,r.data)),M.allowforms&&l&&l.data&&(Pt(),Qt.extend(f,l.data)),a=!0,vt(f,h)}}else!(e||!(0<M.documenturl.length)||!t&&""!==t&&!n&&""!==n)||F("openUrlError","string input expected for document url.");a||(r&&(i++,u=r,d=h,C.annotations&&(zt(),C.annotations.makeHandlerRequest(u,d))),l&&(i++,s=l,c=h,C.forms&&(Pt(),C.forms.makeHandlerRequest(s,c))))}
/**
...
/**
   ...
   * @returns debug info object if available, otherwise null
   */
return c.__getDebugInfo=function(){var e={version:mn.join(".")};M.debug&&Qt.extend(!0,e,{dom:y,controllers:C,page:E});return e}
/**
...
/**
   ...
   * @function dispose
   */
function(){if(!k&&r&&r.closeDocument(),Lt(),y.main&&y.main.remove(),y.toolbar&&(y.toolbar.controlgroup("destroy"),y.toolbar.remove(),y.toolbar.annoToolbar&&(y.toolbar.annoToolbar.controlgroup("destroy"),y.toolbar.annoToolbar.remove())),y.search&&y.search.dispose(),y.uploadCtrl&&y.uploadCtrl.remove(),y.main=null,y.toolbar=null,y.scroller=null,y.viewport=null,y.content=null,y.scrollH=null,y.scrollV=null,y.loadedImgs.length=0,y.pageDivs.length=0,y.pageLabel=null,y.status=null,y.search=null,y.uploadCtrl=null,y.edges){for(var e=0;e<y.edges.length;e++)y.edges[e]=null;y.edges=[]}for(var t in E)E.hasOwnProperty(t)&&null!==E[t]&&(E[t].dispose(),E[t]=null);M={prpr:0,batchoperation:0,loading:(S={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0,scrollTargetPage:0}},c.empty=Ht,c.fit=ut,c.getZoom=function(){return F.zoom},c.isReady=Bt,c.scrollTo=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);ye(e,t,n,null,o)}
/**
   * Scrolls by the given deltas, does not account for zoom, i.e. `dx` and `dy` values are passed in window coordinate space.
   * @param {number} dx - Indicating delta of the x axis.
   * @param {number} dy - Indicating delta of the y axis .
...
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=U,h.deselectThumb=W,h.isActive=k,h.activate=function(){C(f,h.getDocumentInfo())};var L=function(){};function B(){k()&&(y?y.closeDocument(D(),u):f.empty(),E()),R(),m=f=null}var R=function(){};function j(e,t,n,o){w.base&&Qt.each(w.base.dom.pageDivs,function(e,t){t.off(c),t.thumbInitialized=!1}),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(y.closeDocument(D(),u),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.x=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Ee(e,t,o)})}var N=function(){};function q(e){if(w.base){0===p.length&&p.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<p.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),null!==n&&-1<p.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection")),J(o,i)}}}
/** 
