...
/**
     * @private
     */},{key:"Platform",get:function(){return this.platform}}]),o}(m),x=new m,_n=new b,y=x,wn={
...
/**
   ...
   */
Name:3},_={FileUploadRejectReason:w,SelectedItemsOrder:$e,SelectionMode:Ke,ScrollArea:Tn,PageSelection:Pn,Fitting:kn,ScrollDirection:zn,MouseToolCursor:Be,MouseToolType:wn,Browser:y},Re={
/**
   * Image annotation.
   */
image:"image",
...
/**
   ...
   */
polygon:"polygon"},Dn=(n(43),n(30),n(17),n(10),n(23),n(83),n(87),n(14),{
...
/**
   ...
   */
valueHeightShort:"short"},En={annotations:M};
/**
 ...
 * @private
 */
function X(e,t,n){for(t||(t={x:0,y:0}),n||(n=e.target instanceof HTMLElement?e.target:null),_n.Explorer&&null===e&&(e=event),e instanceof MouseEvent?(t.x=e.clientX,t.y=e.clientY):(t.x=e.touches[0].clientX,t.y=e.touches[0].clientY);n&&!isNaN(n.offsetLeft)&&!isNaN(n.offsetTop);)t.x-=n.offsetLeft-n.scrollLeft,t.y-=n.offsetTop-n.scrollTop,n=n.offsetParent instanceof HTMLElement?n.offsetParent:null;return t}
/**
 * @private
 */function J(e,t,n){t||(t={x:0,y:0});var o=e.originalEvent;if(e.offsetX||e.offsetY)if(_n.Firefox){var i=e.target.raphaelParent?xn(e.target).parents("svg").offset():xn(e.target.offsetParent||e.target.parentNode).offset();t.y=i?(t.x=e.pageX-i.left,e.pageY-i.top):(t.x=e.pageX,e.pageY)}else if(void 0===o||o.currentTarget===o.target||n)t.x=e.offsetX,t.y=e.offsetY;else if(o.currentTarget.offsetLeft||o.currentTarget.offsetTop||!o.currentTarget.ownerSVGElement)t.x=o.currentTarget.offsetLeft+e.offsetX,t.y=o.currentTarget.offsetTop+e.offsetY;else{var a=_n.Explorer?o.currentTarget.ownerSVGElement.getBBox():o.currentTarget.getBBox();t.x=Math.round(a.x),t.y=Math.round(a.y)}else if(_n.Explorer)o instanceof MouseEvent?(t.x=o.x,t.y=o.y):(t.x=0,t.y=0);else{var r=null,l=e.target;o instanceof TouchEvent&&1===o.touches.length&&(l=document.elementFromPoint(o.touches[0].clientX,o.touches[0].clientY));var s=_n.Features.Touch&&o instanceof TouchEvent?o.touches[0]:null,c=xn(l),u={pageX:0,pageY:0};null!==s?(u.pageX=s.pageX,u.pageY=s.pageY):o instanceof MouseEvent&&(u.pageX=o.pageX,u.pageY=o.pageY),u.pageX||u.pageY||(u.pageX=e.pageX,u.pageY=e.pageY),e.target.raphael?r=c.parents("div:eq(0)").offset():(e.target.raphaelParent||0<c.parents("svg").length)&&(r=c.parents("svg").parents("div:eq(0)").offset()),r||(r=c.offset()),t.y=r?(t.x=u.pageX-r.left,u.pageY-r.top):(t.x=u.pageX,u.pageY)}return t}
/**
 ...
 */function Q(e,t){var n={left:0,top:0};if(e instanceof HTMLElement)n.left=e.offsetLeft,n.top=e.offsetTop;else{var o=xn(e).offset(),i=t.offset();o&&i&&(n.left=o.left-i.left,n.top=o.top-i.top)}return n}
/**
 * @private
 */
/**
...
/**
   ...
   */
function(){if(_n.Explorer){var e=parseInt(_n.Version,10);10<=e&&e<12&&d.node&&d.node.parentNode&&d.node.parentNode.insertBefore(d.node,d.node)}}()}}r.commitTransform=function(){var e,t,n;xn.extend(u,(e=m,t=s.getZoom(g._pageindex),{x:(n=e.split()).dx/t,y:n.dy/t,width:n.scalex/t,height:n.scaley/t})),d.transform(I()),S(),R=null},r.transformUI=function(e,t,n,o){m=yn.matrix(n,0,0,o,e,t),R||(R=function(e,t){var n;if(e.points&&1<e.points.length){var o=g.getBox();(n=yn.matrix(1,0,0,1,0,0)).scale(1/o.width,1/o.height,0,0),n.translate(-o.x,-o.y)}else(n=yn.matrix(t,0,0,t,0,0)).translate(e.x,e.y),n.scale(e.width,e.height,0,0);return n}(u,1)),m.add(R.a,R.b,R.c,R.d,R.e,R.f),d.transform(m.toTransformString()),h&&h.repaint()};var R=null;function j(e,t,n){return t>=e.x&&t<=e.x+e.width&&n>=e.y&&n<=e.y+e.height}},Ze=function(e,t,n){var i=e,a=n,r=this,o=new q(r),l=null,s=null,c=null,u=null,d=null,h=null,f=null,g=null,p=t.multiview?t:{
/**
...
/**
   ...
   */
function(){return c(i)},o.getSelected=function(){return c(u)},o.selectAll=function(){for(var e=0;e<i.length;e++)h(e)},o.selectPage=h};function L(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Ln=function(){function e(){}return e.SetLocalizationStrings=function(e){this._strings=e},e.LocalizationAvailable=function(){return!(void 0===this._strings||void 0===this._strings.annotations)},e.GetAnnotationLocalizedString=function(e){return void 0===this._strings.annotations||void 0===this._strings.annotations[e]?(void 0===this._englishStrings.annotations[e]&&console.error("Missed english string for %s",e),this._englishStrings.annotations[e]):this._strings.annotations[e]},e}();L(Ln,"_strings",{}),L(Ln,"_englishStrings",En);var Ge=function(t){var e=this,d=xn("<div />"),h=xn("<div />"),f=null,o=null,n={style:["None:none","Arrow:open","Filled Arrow:block","Filled Ellipse:oval","Filled Diamond:diamond"],width:["medium","wide","narrow"],height:["medium","long","short"]},i={fill:{color:!0,opacity:!0},rotation:!0,outline:{color:!0,opacity:!0,width:!0,startcap:n,endcap:n},text:{font:{bold:!0,italic:!0,color:!0,family:!0,size:!0}}};function a(){d.dialog("close")}function r(){l(),a()}function l(){f.set(o,!0),f.updateView(),f.repaint(),h.empty(),g(f.get(),"",i),m()}function s(){f&&function(){var e={};for(var t in i)if(i.hasOwnProperty(t)){var n={};n[t]=f.get(t),xn.extend(!0,e,n)}return JSON.stringify(e)!==JSON.stringify(o)}()&&f.notifyChanges(o),a()}function g(o,e,t){function n(e){var t=this.getAttribute("dataField");if(this.value&&"boolean"!=typeof this.value)if("number"==typeof o[t]){var n=parseFloat(this.value);isNaN(n)||"rotation"!==t||n===o[t]?"opacity"===t&&0<=n&&n<=1||"opacity"!==t&&0<=this.value?o[t]=n:this.value=o[t]:(f.set({rotation:n}),f.repaint())}else o[t]=this.value;else e&&"boolean"==typeof this.value?o[t]=0<=e.target.id.indexOf("true"):this.value=o[t];f.updateView(),f.repaint(),m()}for(var i in o)if(o.hasOwnProperty(i))if("object"==typeof o[i]){var a="text"!==i?v(i):"";t[i]&&("text"!==i||"text"===i&&"text"===f.get("type"))&&g(o[i],e+a,t[i])}else if("type"===i){var r=Ln.GetAnnotationLocalizedString(o[i].replace("fillrect","rectangle")+"DialogTitle");d.dialog("option","title",r)}else if(t[i]){var l=xn("<div/>"),s=p(i,o[i],n,t[i]);s.attr("dataField",i),s.title="",l.addClass("ui-helper-clearfix atala-ui-dialog-clearfix"),l.css({overflow:"hidden"}),s.appendTo(l);var c=Ln.GetAnnotationLocalizedString("label"+(e||e)+v(i));l.append((u=c,xn("<span/>").text(u))),l.appendTo(h)}var u}function p(a,e,t,n){var o=typeof e,r=null;if(xn.isArray(n))r=xn("<select/>").attr({}),xn.each(n,function(e,t){var n=t,o=t,i=t.split(":");1<i.length&&(o=i[0],n=i[1]),o=Ln.GetAnnotationLocalizedString("value"+v(a)+v(n)),r.append(xn("<option/>",{value:n,text:o}))}),r.change(t),r.val(e);else if("string"===o||"number"===o){r=xn("<input/>").attr({type:"text"});var i=e;"color"===a&&(i=function(e){if(!Ln.LocalizationAvailable())return e;var t=document.createElement("canvas");t.height=1,t.width=1;var n=t.getContext("2d");n.fillStyle=e,n.fillRect(0,0,1,1);var o=n.getImageData(0,0,1,1).data;return"#"+[0,1,2].map(function(e){return("0"+o[e].toString(16)).slice(-2)}).join("")}(e)),r.val(i),r.change(t),r.focus(function(){this.select(),this._focused=!0}),r.mouseup(function(e){this._focused&&(e.preventDefault(),this._focused=!1)})}else if("boolean"===o){var l="bool"+a;c(r=xn("<form/>").attr({id:l,datafield:a}),l+!0,l,Ln.GetAnnotationLocalizedString("radioButtonTrue"),e),c(r,l+!1,l,Ln.GetAnnotationLocalizedString("radioButtonFalse"),!e),r.controlgroup(),r.change(t),r[0].value=e,r.find(".ui-state-hover").each(function(e,t){xn(t).removeClass("ui-state-hover")})}else r=xn("<div>"+e+"</div>");return r.css({float:"right"}),r}function c(e,t,n,o,i){e.append(xn("<input/>").attr({type:"radio",id:t,name:n,checked:i})),e.append(xn("<label/>").attr({for:t}).text(o).height("1.5em"))}function v(e){return e.charAt(0).toUpperCase()+e.slice(1)}function m(){var e=f.getObject();e&&e.paper&&e.paper._page&&e.paper._page._grips.repaint()}return e.show=function(e){for(var t in f=e,h.empty(),o={},i)if(i.hasOwnProperty(t)){var n={};n[t]=f.get(t),xn.extend(!0,o,n)}g(f.get(),"",i),d.dialog("open")},e.hide=a,e.isVisible=function(){return d.dialog("isOpen")},e.cancel=r,e.reset=l,e.okhide=s,function(){h.appendTo(d);var e={};e[Ln.GetAnnotationLocalizedString("dialogButtonOk")]=s,e[Ln.GetAnnotationLocalizedString("dialogButtonReset")]=l,e[Ln.GetAnnotationLocalizedString("dialogButtonCancel")]=r,d.dialog({appendTo:t,minWidth:320,classes:{"ui-dialog":"atala-ui-dialog"},resizable:!0,autoOpen:!1,buttons:e,closeText:a,open:function(){var e=this;!function(e){for(var t=0,n=0;n<e.length;n++){var o=xn(e[n]).height();t<o&&(t=o)}for(var i=0;i<e.length;i++)xn(e[i]).height(t)}(d.parent().find(".ui-dialog-buttonset button")),d.dialog({width:Math.max(320,function(){var e='<span class="atala_title_span">'+d.parent().find(".ui-dialog-title").text()+"AAAAAAAAA</span>";xn("body").append(e);var t=xn("body").find("span:last").width();return xn("body").find("span:last").remove(),t+25}(),function(){for(var e=d.parent().find(".ui-dialog-buttonset button"),t=0,n=0;n<e.length;n++)t+=xn(e[n]).outerWidth(!0);var o=1.5*parseInt(xn(e[0]).css("font-size"));return t+o}()),height:"auto"}),setTimeout(function(){!function(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}(this,e),d.find("input")[0].focus()}.bind(this),100)},beforeClose:function(e){(e.keyCode===xn.ui.keyCode.ESCAPE||e.hasOwnProperty("currentTarget")&&e.currentTarget.classList.contains("ui-dialog-titlebar-close"))&&(_n.Explorer&&d.parent().find(".ui-dialog-buttonset button")[1].focus(),l())}}),d.keypress(function(e){e.keyCode===xn.ui.keyCode.ENTER&&(e.preventDefault(),d.parent().find(".ui-dialog-buttonset button")[0].focus(),s())})}(),e},Ye=function(l,e){var u,d=8,s=25,a=-22.5,c={e:0,ne:315,n:270,nw:225,w:180,sw:135,s:90,se:45},r={},h={},f=e,g=l._paper.set(),p=l._paper.set(),v=[],m=null,b={},x=null,y={x:0,y:0,width:1,height:1,x2:1,y2:1},o=[],_={},t={dragstart:function(){},dragmove:function(){g.hide()},moved:function(){k(),g.show();for(var e=0;e<v.length;++e){var t=v[e].get();(t.hasOwnProperty("rotatable")&&!t.rotatable||t.hasOwnProperty("readonly")&&!t.readonly)&&m.hide()}}};function w(e,t){return e.attr({fill:"#FFFFE1",cursor:(t||"ne")+"-resize"}),e.grip=!0,e.rect=e.getBBox(),e.hide(),e.center=function(e,t,n,o){var i=d/(n=n||1),a=d/n,r=i/2,l=Math.round(i/2)+.5,s=Math.round(a/2)+.5;_n.Explorer&&(s-=.5);var c=Math.round(e)-l,u=Math.round(t)-s;this.ellipse?(c+=r,this.attr({cx:c,cy:u,r:r,"stroke-width":1})):this.attr({x:c,y:u,width:i,height:a,"stroke-width":1}),this.node.setAttribute("stroke-width",1),this.transform(o)},t&&(e.d={key:t,n:~t.indexOf("n"),s:~t.indexOf("s"),w:~t.indexOf("w"),e:~t.indexOf("e")},e.mousedown(function(e){return function(e,t){if(e.stopPropagation(),!(1<v.length)){for(var n=0;n<v.length;n++){if(!v[n].get("resizable"))return void(o=[]);o[n]=xn.extend(!0,{},v[n].getClonedData()),delete o[n].update,delete o[n].getPageIndex}return xn.extend(b,y),x=c[t.key]===c.n||c[t.key]===c.s?1:0,u=c[t.key]===c.w||c[t.key]===c.e?1:0,(t.n||1===u)&&(b.y=b.y2),t.w&&(b.x=b.x2),xn(l._paper.canvas).on({mouseup:I,mousemove:S}),!1}}(e,this.d)})),e}function n(e){return-1!==xn.inArray(e,v)}function i(){for(var e=0;e<v.length;e++)z(v[e]);v.length=0,p.clear(),g.hide()}function z(e){e.getEventObject().unbind(t)}function k(){0<p.length?T():0<v.length?i():g.hide()}function P(e){for(var t in c)c.hasOwnProperty(t)&&F(g[c[t]],e)}function T(){if(0<p.length){var e=1===p.length?v[0].getBox():p.getBBox();y.x=e.x,y.y=e.y,y.width=e.width,y.height=e.height,y.x2=e.x+e.width,y.y2=e.y+e.height,y.xmid=e.x+e.width/2,y.ymid=e.y+e.height/2,D()}}function D(){var e=1===p.length,t=yn.matrix(),n=1,o="",i=f.getViewerTransform(l._index);if(t.add(i.a,i.b,i.c,i.d,i.e,i.f),e){var a=v[0].getTransform();a&&t.add(a.a,a.b,a.c,a.d,a.e,a.f),n=f.getZoom(l._index),o=t.toTransformString(!0)}g[c.nw].center(y.x,y.y,n,o),g[c.ne].center(y.x2,y.y,n,o),g[c.sw].center(y.x,y.y2,n,o),g[c.se].center(y.x2,y.y2,n,o),g[c.n].center(y.xmid,y.y,n,o),g[c.w].center(y.x,y.ymid,n,o),g[c.e].center(y.x2,y.ymid,n,o),g[c.s].center(y.xmid,y.y2,n,o);var r=v[0].get();r.hasOwnProperty("rotatable")&&(!r.rotatable||r.hasOwnProperty("readonly")&&r.readonly)?m.hide():(m.show(),m.center(y.xmid,y.y-s/n,n,o)),P((1===v.length?v[0].get().rotation:0)+f.getPageRotation(l._index))}function C(e){var t=l.offset(),n=Q(l._paper.canvas,l);return{x:e.pageX-(t.left+n.left),y:e.pageY-(t.top+n.top)}}function M(e){e.stopPropagation();var t,n,o,i=(t=C(e),n=f.getViewerTransform(l._index).invert(),o=n.x(t.x,t.y),t.y=n.y(t.x,t.y),t.x=o,t),a=180*Math.atan2(i.y-b.ymid,i.x-b.xmid)/Math.PI+90;return 1===v.length&&(v[0].set({rotation:a}),v[0].repaint()),l._grips.repaint(),!1}function E(e){return e.stopPropagation(),xn(l._paper.canvas).off({mouseup:E,mousemove:M}),1===v.length&&(v[0].getEventObject().trigger("rotated"),v[0].getEventObject().trigger({type:"annotationchanged",ann:v[0],annobefore:_})),!1}function S(e){if(e.stopPropagation(),1===p.length){var t=function(e){if(0<p.length){var t="set"===p[0].type?p[0][0]:p[0],n=t.matrix.invert(),o={x:n.x(e.x,e.y),y:n.y(e.x,e.y)};return o}return e}(C(e)),n=Math.abs(t.x-b.x),o=Math.abs(t.y-b.y),i=t.x<b.x?b.x-n:b.x,a=t.y<b.y?b.y-o:b.y;r=i,l=a,s=n,c=o,0===x&&(y.x=r,y.width=Math.max(s,1),y.x2=r+y.width,y.xmid=r+y.width/2),0===u&&(y.y=l,y.height=Math.max(c,1),y.y2=l+y.height,y.ymid=l+y.height/2),D(),function(){for(var e=0;e<v.length;e++)v[e].transform(y.x,y.y,y.width,y.height)}()}var r,l,s,c;return!1}function I(e){e.stopPropagation();for(var t=0;t<v.length;t++)v[t].getEventObject().trigger("resized"),v[t].getEventObject().trigger("annoresized"),v[t].getEventObject().trigger({type:"annotationchanged",ann:v[t],annobefore:o[t]}),v[t].repaint();return 0<p.length&&T(),xn(l._paper.canvas).off({mouseup:I,mousemove:S}),!1}function F(e,t){if(e&&e.d&&e.d.key){var n=yn.matrix();n.rotate(t);var o={x:n.x(r[e.d.key].x,r[e.d.key].y),y:n.y(r[e.d.key].x,r[e.d.key].y)};for(var i in h)if(h.hasOwnProperty(i)&&A(o,h[i].start,h[i].end)){e.attr({cursor:(h[i].dir||"ne")+"-resize"});break}}}function A(e,t,n){function o(e,t){return 0<-e.x*t.y+e.y*t.x}return!o(t,e)&&o(n,e)}!function(){var e,t;for(var n in c)if(c.hasOwnProperty(n)){var o=l._paper.rect(0,0,d,d),i=w(o,n);g.push(i),g[c[n]]=i,(e=yn.matrix()).rotate(c[n]),r[n]={x:e.x(1,0),y:e.y(1,0)}}(t=w(l._paper.circle(0,0,d/2)).attr({fill:"#00FF40",cursor:"pointer"})).ellipse=!0,g.push(t),t.mousedown(function(e){return function(e){if(e.stopPropagation(),1===v.length&&1===p.length){for(var t=0;t<v.length;t++){var n=v[t].get();if(n.hasOwnProperty("readonly")&&n.readonly||n.hasOwnProperty("rotatable")&&!n.rotatable)return}xn.extend(b,y);var o=v[0].getTransform(),i=o.x(b.xmid,b.ymid);b.ymid=o.y(b.xmid,b.ymid),b.xmid=i,delete(_=xn.extend(!0,{},v[0].getClonedData())).update,delete _.getPageIndex,xn(l._paper.canvas).on({mouseup:E,mousemove:M})}}(e)}),m=t,function(){var o=yn.matrix();o.rotate(a,0,0);for(var e=function(e,t){var n={dir:t,start:{x:o.x(r[e].x,r[e].y),y:o.y(r[e].x,r[e].y)},end:{x:o.x(r[t].x,r[t].y),y:o.y(r[t].x,r[t].y)}};return n},t=["e","ne","n","nw","w","sw","s","se"],n=0;n<t.length-1;++n)0===n&&(h[t[n]]=e(t[t.length-1],t[n])),h[t[n+1]]=e(t[n],t[n+1])}()}(),this.push=function(e){n(e)||(v.push(e),p.push(e.getObject()),!0===e.get("selectable")&&e.getEventObject().bind(t),k(),g.toFront(),g.show())},this.contains=n,this.remove=function(e){for(var t=0;t<v.length;t++)v[t]===e&&v.splice(t,1);p.exclude(e.getObject()),z(e)},this.clear=i,this.repaint=k,this.updateCursor=P};function Je(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}
/**
 ...
 */var Hn=function e(t,n,o){var i=this,a=this,h=t,x=n,s=new Xe(h),r={
...
/**
       ...
       * @function
       */
drawAnnotation:function(e,t,n){x._controllers.mouseTool.setTool(wn.None,wn.None),be(e,!0,function(){x._controllers.mouseTool.setTool(wn.Pan,wn.None),"function"==typeof t&&t()},function(){x._controllers.mouseTool.setTool(wn.Pan,wn.None),"function"==typeof n&&n()})},
/**
...
/**
       ...
       * @function
       */
saveAll:function(e,t){ce(xn.extend(!0,{},{atala_annossavemode:1,atala_xmpfilename:e||"",atala_annos:Ee()}),t),m.annoIdsCreated.length=0,m.annoIdsModified.length=0,m.annoIdsRemoved.length=0},
/**
...
/**
       ...
       * @function
       */
loadAll:function(e,t){ue(xn.extend(!0,{},{atala_annoloadmode:1,atala_xmpfilename:e||""}),t)},
/**
       ...
       * @function
       */
load:function(e,t,n,o){var i=n?t+n-1:t;ue(xn.extend(!0,{},{atala_annoloadmode:2,atala_xmpfilename:e||"",atala_annosstartindex:t,atala_annosendindex:i}),o)},
/**
       ...
       * @function
       */
loadSingle:function(e,t,n){ue(xn.extend(!0,{},{atala_annoloadmode:3,atala_xmpfilename:e||"",atala_annoid:t}),n)},
/**
...
/**
       ...
       * @function
       */
showAnnotationsPropertiesWindow:function(){m.activeanno&&U()},
/**
...
/**
   ...
   * @returns undefined
   */function P(e){v.translate(e.dx,e.dy)}function T(e){m.zoom=e.zoom}function D(e,t,n){e||"number"!=typeof t||(t=M(t)),t=t||[],null==n?n=m.annos.length:n<0&&(n=0);for(var o=m.annos.length,i=0;i<t.length;i++)X(t[i],n,null);if(o<n)for(var a=o;a<m.annos.length;++a)m.annos[a]||(m.annos[a]=[]);for(var r=m.annos[n].length,l=0;l<r;l++){var s=m.annos[n][l].get().annotationId;s&&0!==s&&!me(s)||(s=fe()+1,m.annos[n][l].setAnnotationId(s)),m.maxAnnotationId<s&&(m.maxAnnotationId=s),m.annos[n][l].setFIndex(n),pe(s)}return C(),n}function C(){if(m.annos){for(var e=1/0,t=m.annos.length,n=0;n<t;n++)if(m.annos[n])for(var o=m.annos[n].length,i=0;i<o;i++){var a=m.annos[n][i].get().annotationId;a<e&&(e=a)}if(e!==1/0&&1<e)for(var r=m.maxAnnotationId=0;r<t;r++)if(m.annos[r])for(var l=m.annos[r].length,s=0;s<l;s++){var c=m.annos[r][s].get().annotationId,u=c-e+1;m.annos[r][s].setAnnotationId(u),m.maxAnnotationId<u&&(m.maxAnnotationId=u);var d=m.annoIdsCreated.indexOf(c);-1<d&&(m.annoIdsCreated[d]=u),-1<(d=m.annoIdsModified.indexOf(c))&&(m.annoIdsModified[d]=u),-1<(d=m.annoIdsRemoved.indexOf(c))&&(m.annoIdsRemoved[d]=u)}}}function M(e){if(m.annos&&e<m.annos.length){if(m.annos[e])for(var t=m.annos[e].length,n=0;n<t;n++){var o=m.annos[e][n].get();o&&ve(o.annotationId)}for(var i=xn.extend(!0,{},m.annos[e]),a=m.annos[e].length-1;0<=a;a--)J(a,e);return i}return null}function E(e,t){return D(null,M(e),t)}function S(e){e&&e.remove&&!e.grip&&e.paper&&e.paper._trash&&e.paper._trash.push(e)}function I(e){F(e.index,e.page)}function F(e,t){if(e<m.annos.length&&(A(t),m.annos[e]&&m.annos[e].length))for(var n,o=0;o<m.annos[e].length;o++)(n=m.annos[e][o])._pageindex=e,n.repaint(t._paper),n.get("selected")&&s.select(n,e,!0)}function A(e){e._grips.clear(),e._paper._annos.remove(),e._paper._annos.clear(),e._paper.forEach(function(e){e&&e.remove&&!e.grip&&e.paper&&e.paper._trash&&e.paper._trash.push(e)}),e._paper._trash.remove(),e._paper._trash.clear(),Pe()}function O(e){m.activepage=e}function V(e){e.page._paper&&(A(e.page),e.page.append(e.page._paper.canvas))}function L(e){H(e.page)}function H(e){if(e&&0<=e._index&&m.annos[e._index]){for(var t=0;t<m.annos[e._index].length;t++)m.annos[e._index][t].repaint();e&&e._grips.repaint()}}function R(e){for(var t=m.annos.length,n=0;n<t;n++)if(m.annos[n])for(var o=m.annos[n].length,i=0;i<o;i++){var a=m.annos[n][i].get();if(a&&a.annotationId===e)return m.annos[n][i]}return null}function j(e){f&&(f.visible&&B(),f.remove());var t=xn.extend(!0,{},g);if(h.trigger("contextmenu",[m.activeanno.getClonedData(),t]),xn.isEmptyObject(t))f=null;else{for(var n in t)t.hasOwnProperty(n)&&(t[n]=q(t[n]));f=N(t)}!function(e){if(f){var t=Ln.GetAnnotationLocalizedString("menuPropertiesButton"),n=Ln.GetAnnotationLocalizedString("menuDeleteButton");if(m.activeanno.get("readonly"))f.children(":contains("+t+")").off("click").children("a, div").css("color","#cdc9c9"),f.children(":contains("+n+")").off("click").children("a, div").css("color","#cdc9c9");else{var o=f.children(":contains("+t+")");void 0!==o.data("events")&&"click"in o.data("events")||o.on("click",U),o.children("a").css("color","#000000")}0===f.closest().length&&d.prepend(f);var i={x:e.x-6,y:e.y-6};f.css({left:i.x,top:i.y}),f.show(),f.visible=!0}}(e)}function B(){f&&(f.hide(),f.visible=!1)}function N(e){var t=x.createMenu(e);return t.css({position:"fixed","z-index":99999}),t.mouseleave(B),t.visible=!1,t}function q(e){return function(){return B(),e.call(this,m.activeanno.getClonedData())}}function W(){var e=m.activepage?m.activepage._index:0;if(m.annos[e]){var t=xn.inArray(m.activeanno,m.annos[e]);-1!==t&&(m.activeanno=null,J(t,e))}B()}function U(){h.trigger({type:"annotationspropertieswindowopened",annotation:m.activeanno}),B(),p.show(m.activeanno)}
/**
   * Clears the annotations and related data from all pages
   */
function Z(){var e=m.annos.length;if(0<e){for(var t=0;t<e;t++)if(m.annos[t])for(var n=m.annos[t].length,o=0;o<n;o++){var i=m.annos[t][o].get();i&&ve(i.annotationId)}if(m.annos.length=0,c)for(var a=0;a<c.length;a++)c[a]._grips.clear(),c[a]._paper.forEach(S),c[a]._paper._trash.remove(),c[a]._paper._trash.clear(),c[a]._paper._annos.remove(),c[a]._paper._annos.clear();h.trigger({type:"annotationscleared"})}}
/**
   * Creates an annotation on the desired page with the given annotation data.
 ...
 * @inner
 * @memberOf Atalasoft.Controls.WebDocumentViewer
 */var Bn=function e(i,t,n){var o=this,p=i,v=t,m=n,a={document:{events:{
/**
 ...
 * @name TextController
 * @memberOf Atalasoft.Controls.WebDocumentViewer
 */var Nn=function e(t,n,o){var i=this,D=t,C=n,M=(n?n._internalEvents:null)||xn({}),a={
/**
...
/**
       ...
       * @function
       */
getPageText:function(i,a,e){var r=this,l=xn.Deferred();return ve(i).done(function(){tt(this,r);var e="",t=I(i);if(t)for(var n=0;n<t.regions.length;n++){var o=Z(t.regions[n]);o&&(e+=o)}l.resolve(e),a&&"function"==typeof a&&a(e)}.bind(this)).fail(function(){tt(this,r),l.reject(),e&&"function"==typeof e&&e()}.bind(this)),l.promise()},
/**
...
/**
       ...
       * @function
       */
reloadPageText:function(e,t,n){var o=this;return b(e),ve(e).done(function(){tt(this,o),t&&"function"==typeof t&&t(e)}.bind(this)).fail(function(){tt(this,o),n&&"function"==typeof n&&n(e)}.bind(this))},
/**             
...
/**
     ...
     */function n(){if(!u&&t.length){var e=t.shift();e&&"function"==typeof e.action&&e.action.apply(b,e.args)}}function _(n,o){if(w()){var e=n?1:-1,t=I(p);if(t&&t.searchResult&&t.searchResult.length&&(n?-1<=v&&v<m-1:0<v&&v<=m)){v+=e;var i=t.searchResult[v];y=T(p,i),X(p,i);var a=t?t.rotation:0,r=C.getViewerTransform(p,a),l=te(i.bounds,t.regions[i.region]),s=Re(r.x(l.x,l.y),r.y(l.x,l.y));C.showPagePoint(p,s,Pn.Center,function(){o(b,T(p,i))})}else u=u||z(c.text,0<=p?p+e:g,n).done(function(e,t){w()?0<=e&&t&&(p=e,m=t.searchResult.length,v=n?-1:m,_(n,o)):o(b,null)}).fail(function(){o(b,null)})}else o(b,null)}
/**
...
/**
     ...
     */
pageselectlocation:xn.extend({},Pn.TopLeft),
/**
...
/**
     ...
     * */
multiprocessing:!1};if(t){var f=t.mousetool;t.mousetool&&"object"!=typeof t.mousetool&&(t.mousetool=xn.extend({},U.mousetool,{type:f})),!t.tabular||t.direction!==zn.Horizontal&&1!==t.columns||(t.tabular=!1),xn.extend(!0,U,t),t.mousetool=f,t.localization&&Ln.SetLocalizationStrings(t.localization)}if(function(){x?(U.direction=zn.Vertical,U.tabular=!1):U.direction=U.direction===zn.Vertical||U.direction===zn.Horizontal?U.direction:zn.Vertical;U.fitting=U.fitting===kn.None||U.fitting===kn.Best||U.fitting===kn.Width||U.fitting===kn.Height?U.fitting:kn.Width,U.pageborderwidth=Ce(U.pageborderwidth)?parseInt(U.pageborderwidth,10):1,U.pagespacing=Ce(U.pagespacing)?parseInt(U.pagespacing,10):4,U.showpageborder=!!U.showpageborder,U.showpagenumber=!!U.showpagenumber,U.showstatus=!!U.showstatus,U.zoom=Ce(U.zoom,!0)?parseFloat(U.zoom):1,h=!1,U.scripturl=(e=U.scripturl,0<e.length&&-1===e.indexOf("/",e.length-1)&&-1===e.indexOf("\\",e.length-1)?U.scripturl+"/":U.scripturl),U.maxpagebuffersize=0<U.maxpagebuffersize&&U.pagebuffersize<U.maxpagebuffersize?U.maxpagebuffersize:0<U.pagebuffersize?U.pagebuffersize+10:50,function(){if((U.mousetool.type===wn.ZoomArea||U.mousetool.type===wn.Selection||U.mousetool.type===wn.Text)&&!U.showselecttools){if(null!==t.showselecttools&&void 0!==t.showselecttools)throw"The mouse tool type is incompatible with 'showselecttools' flag value.Please change the tool type or enable selection tools.";U.showselecttools=!0}}(),function(){U.upload||(U.upload={enabled:!1});var e=U.upload;!1!==e.enabled&&(e.allowedmaxfilesize=In(e.allowedmaxfilesize)?e.allowedmaxfilesize:Number.MAX_VALUE,e.allowdragdrop=!!e.allowdragdrop,e.allowmultiplefiles=!!e.allowmultiplefiles,e.allowedfiletypes="string"==typeof e.allowedfiletypes?e.allowedfiletypes:"",e.uploadpath="string"==typeof e.uploadpath?e.uploadpath:".",e.filesuploadconcurrency=In(e.filesuploadconcurrency)?e.filesuploadconcurrency:1,e.closeuiafterupload=!1!==e.closeuiafterupload)}();var e}(),e=U.allowannotations,n=U.allowtext,!Mn({checkjQueryOnly:!1,checkRaphael:e||n,checkClipboard:n}))return null;function g(){var e=N.memory.deallocateOldestEntry();!function(e){try{e.parentNode&&e.parentNode.removeChild(e),i.appendChild(e),i.innerHTML=""}catch(e){}}(e[0]),0<=e._cacheIndex&&(B.loadedImgs[e._cacheIndex]=null,e._cacheIndex=-1),e.remove(),e.length=0,e=null}function p(e){W.newpagedivsize={height:e.height,width:e.width},W.newpagedivfullzoom=e.fullzoom,U.minwidth=e.minwidth,U.zoom=e.fullzoom,Nt()}function v(e){var t=!1;if((q.smallest.width<=0||e.width<q.smallest.width)&&(q.smallest.width=e.width,t=!0),(q.smallest.height<=0||e.height<q.smallest.height)&&(q.smallest.height=e.height,t=!0),!L){if(x)Ie(e.dx,e.dy);else{var n=W.scrollTarget.Page-1;if(e.index<=n)if(U.direction===zn.Vertical&&0<Math.abs(e.dy)){var o=ge(B.pageDivs[0]._index).height;B.edges[0].height(o),Re(B.pageDivs[0]._index,null),Me(null,ge(n).height+W.scrollTarget.dy,!1)}else if(U.direction===zn.Horizontal&&1<Math.abs(e.dx)){var i=ge(B.pageDivs[0]._index).width;B.edges[0].width(i),Re(B.pageDivs[0]._index,null),He(),Me(ge(n).width+W.scrollTarget.dy,null,!1)}Ie(e.dx,e.dy),fe();var a=B.scroller[0].scrollLeft,r=B.scroller[0].scrollTop;if(!B.scroller.propagationPaused()&&B.scrollH&&B.scrollV){var l=Math.round(a/B.scrollH._ratio),s=Math.round(r/B.scrollV._ratio);l!==B.scrollH.scrollLeft()&&(B.scrollH.pauseEventPropagation(!0),B.scrollH.scrollLeft(l)),s!==B.scrollV.scrollTop()&&(B.scrollV.pauseEventPropagation(!0),B.scrollV.scrollTop(s))}}t&&ne(ie())>B.pageDivs.length&&Nt()}}function m(e,t,n,o){var i=t.getPageSize(e.index,y);if(!i){var a=t.getPageFitMultiplier(e.index,y),r=a,l={width:e.width,height:e.height};1===r&&U.forcepagefit&&(l.width!==n.width||l.height!==n.height)&&0<l.width&&0<l.height&&(r=l.width/n.width>l.height/n.height?n.width/l.width:n.height/l.height,t.setPageFitMultiplier(e.index,r,y)),t.setPageSize(e.index,xn.extend({},l),y),o&&(l.width*=U.zoom*r,l.height*=U.zoom*r,(i=xn.extend({},q.size)).width*=U.zoom*a,i.height*=U.zoom*a,e.dx=l.width-i.width,e.dy=l.height-i.height,v(e))}}function b(){_n.Mobile.Any()?window.addEventListener("orientationchange",dt):window.addEventListener("resize",dt),B.scroller.scroll(Ve),Q(q.buffer)}function w(e){var t=e.target||e.srcElement;return("TEXTAREA"===t.nodeName||"INPUT"===t.nodeName||"text"===t.type)&&(!(t.attributes.selectable&&"false"===t.attributes.selectable.value||t.attributes.hasOwnProperty("readonly")&&"true"===t.attributes.readonly.value)&&void 0)}function z(t,n){return function(e){try{e.currentTarget=n&&0<n.length?n[0]:e.currentTarget,t&&t(e)}catch(e){Te(e.message)}}}function Z(e,t){if(U.showerrors)throw void 0===t?e:e+": "+t;Te(e+": "+t),fn({type:"error",name:e,message:t})}function k(e){Z(e.name,e.msg)}function P(e,t,n,o){var i=xn("<"+e+"></"+e+">");return t&&t.append&&i.appendTo(t),n&&i.attr("id",n),o&&i.html(o),i}function X(e,t,n){return P("div",e,t,n)}function T(e){var t=xn('<div div class="atala_draw_layer"></div>');return t.toFront=function(){t.css({"z-index":"10"}),t.reflow&&t.reflow()},t.reset=function(){t.css({"z-index":""}),t.reflow&&t.reflow()},e&&e.prepend(t),t}function D(e){var t=X(e.parent),n=y+"_toolbar";t.buttons=[];for(var o=0;e.children&&o<e.children.length;o++){var i=null;switch(e.children[o].type){case"button":if(_n.Features.Touch&&("lines"===e.children[o].icon||"polygon"===e.children[o].icon))continue;e.children[o].id=n+"_"+e.children[o].id,(i=A(e.children[o],t)).addClass(Dn.atala_toolbar_button),t.buttons.push(i);break;case"pagelabel":B.pageLabel=P("span",t,n+"_"+e.children[o].id),(i=B.pageLabel).addClass("ui-controlgroup-item")}i&&e.children[o].cls&&i.addClass(e.children[o].cls)}return t}function C(e){var t=xn("<ul/>");for(var n in t.css({fontSize:"medium"}),t.addClass(Dn.atala_context_menu),e)if(e.hasOwnProperty(n)){var o=xn('<li><div href="#"> '+n+" </div></li>");_n.Features.Touch&&o.on({touchend:e[n]}),o.click(e[n]),o.appendTo(t)}return t.menu(),t}function M(e,t,n){var o=xn('<div title="'+t+'" />');return n&&o.append(n),o.dialog(),o}function E(e){var t=P("span",B.toolbar.annoToolbar).addClass("ui-controlgroup-item");return A(e,t),F(t,e.id+"_Drop","ui-icon-triangle-1-s","Click To Choose",null,function(){var e=xn(this).next();if(e.is(":visible"))return e.hide(),!1;var t=e.prev().prev().parent();return e.menu().show().css({position:"absolute",top:0,left:0,"min-width":t.width()+"px","z-index":11}).position({my:"left top",at:"left bottom",of:t}),!1}),t.controlgroup(),B.toolbar.annoToolbar.controlgroup("refresh"),t}function S(e,t,n){for(var o=xn(e.children().first()),i={},a=0;a<n.length;a++)i[n[a].name]=I(o,t,n[a]);o.menu=C(i),e.append(o.menu),o.menu.hide()}function I(e,t,n){var o=function(){return e.button("option","label","Draw "+n.name),e.data("_annoConfig",n),e.click(t.onclick),e.menu.hide(),e.trigger("click"),!1};return dn("menuselect"+t.icon+n.name,z(o,e)),o}function F(e,t,n,o,i,a){var r=xn('<button id="'+t+'" title="'+o+'">'+(i||o)+"</button>");return a&&r.click(a),r.button({icon:n,showLabel:null!=i&&U.showbuttontext}),r.addClass("atala-ui-button"),e&&r.appendTo(e),r}function A(e,t){var n,o="menuclick"+(e.custom?e.id:e.icon),i=F(t,e.id,e.custom?e.icon:_+" "+_+"-"+e.icon,e.tooltip,e.text,(n=o,function(e){e.preventDefault(),fn(n,arguments)}));return i.data("_config",e),dn(o,z(e.onclick,i)),i}function O(e){var t,n,o={clearable:"atala_search_input_clearable",onclear:"atala_search_input_clear_hover",inputEmpty:"atala_search_input_empty",loading:"atala_search_input_loading"},i=e.parent||B.toolbar,a=null,r=null;function l(){var e=n.val();return e?n.addClass(o.clearable):n.removeClass(o.clearable),!!(e&&a&&a.isValid()&&e===a.getQuery())||(clearTimeout(r),a=null,e&&3<=e.length?(p(!0),r=setTimeout(function(){a=N.text.search(e,un(),f),g(!0)},U.mousetool.text.searchdelay),!1):void h())}function s(e){var t=n.val();return 13===e.keyCode&&a&&t&&a.isValid()&&a.getQuery()===t?(e.shiftKey?u():c(),!1):13!==e.keyCode||a&&a.isValid()?27===e.keyCode?(d(),!1):void 0:(l(),!1)}function c(){a&&(g(!0),a.next(f))}function u(){a&&(g(!0),a.prev(f))}function d(){h(),x()}function h(){a=null,N.text.search(""),N.text.clearSelection(),g(!1),p(!0)}function f(e,t){e.isValid()&&(g(!1),e.wrap=U.mousetool.text.wrapsearch,t||p(t))}function g(e){m(o.loading,e)}function p(e){m(o.inputEmpty,!e)}function v(t){return function(e){e.preventDefault(),t&&t()}}function m(e,t){t?n.addClass(e):n.removeClass(e)}function b(e){m(o.onclear,this.offsetWidth-18<e.clientX-this.getBoundingClientRect().left)}function x(e){e&&e.preventDefault(),n.removeClass(o.clearable).removeClass(o.onclear).val("").change(),l()}!function(){t=X().addClass(Dn.atala_search_container).addClass("ui-controlgroup-item"),(n=xn('<input type="text" placeholder="Search..." />').addClass(Dn.atala_search_input).addClass("ui-widget")).on({keydown:s,"input propertychange":l}),P("span",t).css({width:"100%"}).append(n);var e=P("span",t);F(e,y+"_toolbar_search_button_next",_+" "+_+"-search-next","Next",null,v(c)).addClass(Dn.atala_search_next).addClass(Dn.atala_toolbar_button),F(e,y+"_toolbar_search_button_prev",_+" "+_+"-search-prev","Previous",null,v(u)).addClass(Dn.atala_search_prev).addClass(Dn.atala_toolbar_button),t.on("mousemove","."+o.clearable,b).on("touchstart click","."+o.onclear,x),i.append(t),i.append(xn("<div/>").css("clear","both"))}(),this.dispose=function(){n.off({keypress:s,"input propertychange":l}),t.off("mousemove","."+o.clearable,b).off("touchstart click","."+o.onclear,x),a&&a.dispose();t.remove()},this.ClearSearch=d}function V(){U.allowannotations&&c.annotations.cancelDraw(),N.mouseTool.setTool(wn.ZoomArea)}function G(o){return function(){var t=this,e=Y(q),i=e[0],n=[];e.forEach(function(e){return Un(this,t),n.push(N.document.getPageRotation(e)+o)}.bind(this)),N.document.rotatePages(e,n,function(){var e=Mt(i),t=xe(i),n=U.direction===zn.Vertical?t.height*e:0;st(U.pageselectlocation,Pn.Center)||st(U.pageselectlocation,Pn.MiddleLeft)?n/=2:st(U.pageselectlocation,Pn.TopLeft)&&(n=0);var o={x:U.direction===zn.Vertical?0:n,y:U.direction===zn.Vertical?n:0};lt(i,o,U.pageselectlocation,!0)})}}!function(){var e=U.parent.attr("id")+"_wdv";++Fn.instanceCounter;for(;document.getElementById(e+Fn.instanceCounter);)++Fn.instanceCounter;y=e+Fn.instanceCounter}(),
/**
...
c.domclasses=Dn,
/** WARNING: Changing values from these references can cause instability.*/
c.domattributes=Cn;var Y=function(e){return[e.number-1]};function J(e,t){var n=X(e,t);return U.direction===zn.Vertical?(n.height(1),n.css({display:"block"})):U.direction===zn.Horizontal&&(n.width(1),n.css({display:"inline-block",overflow:"hidden"})),n._zoom=1,U.backcolor&&n.css({backgroundColor:U.backcolor}),n}function Q(e){if(void 0===e){var t=ne(L&&W.newpagedivsize&&0<U.zoom&&isFinite(U.zoom)?U.zoom:ie());t>U.maxpagebuffersize&&(t=U.maxpagebuffersize),q.buffer<t&&(q.buffer=t),q.buffer=Math.min(q.buffer,N.document.getPageCount()),e=q.buffer}function n(t){return function(){var e;e=t,W.activepage=e}}if(B.pageDivs.length<e)for(var o=B.pageDivs.length;o<e;o++)B.pageDivs[o]=X(),B.pageDivs[o].addClass(Dn.atala_page_div),U.showselecttools&&(B.pageDivs[o]._rubberband=new Wn(c,{},B.pageDivs[o],{getViewportSize:_e,getMaxZoom:ae,getPageOffsets:ge,raiseDrawLayer:Vt,resetDrawLayer:Lt})),B.pageDivs[o].on({touchstart:n(B.pageDivs[o]),mousedown:n(B.pageDivs[o])}),B.pageDivs[o].attr("tabindex",0),N.annotations&&N.annotations.addDrawingSurface(B.pageDivs[o]),(U.showselecttools||U.allowannotations||U.allowforms||U.allowtext)&&(B.pageDivs[o]._draw=T(B.pageDivs[o])),N.forms&&!L&&N.forms.addFormLayer(B.pageDivs[o]),N.text&&!L&&N.text.addTextLayer(B.pageDivs[o]);else if(B.pageDivs.length>e)for(;B.pageDivs.length>e&&0!==B.pageDivs.length;){var i=B.pageDivs.pop();i._rubberband&&i._rubberband.dispose(),N.annotations&&N.annotations.removeDrawingSurface(i),N.forms&&!L&&N.forms.removeFormLayer(i),N.text&&!L&&N.text.removeTextLayer(i),i&&Ye(i),i=null}}function K(e,P,t,n){"function"==typeof t&&(n=t,t=void 0);var T,o="function"==typeof n?[n]:[];T=xn(new Image);var i=.9,r=xn.extend(!0,{atala_cb:void 0},t||{});T._domEl=X(),T._domEl.addClass(Dn.atala_page_image_anchor),T.addClass(Dn.atala_page_image),T._domEl.append(T);var a={load:p,error:function(){k(),Z("ImageError","Image at frameIndex "+c()+" failed to load.")},inserted:function(){T._loaded&&m()}};function c(){return T._page?T._page._index:N.document.getPageIndexByImageIndex(T._index)}function D(){return T._domEl}function l(e){return N.document.getPageFitMultiplier(void 0!==e?e:c())}function u(e,t){return(e=void 0===e?U.zoom:e)*l(t)}function s(){var e=xe(c())||q.size;return{height:e.height,width:e.width}}
/**
     * Returns physical size of the image without client transformations applied(like view rotation)
     */function d(){var e=s();return 90===T._viewrotation||270===T._viewrotation?V(e):e}function C(e,t){return t=t||s(),{height:Math.round(t.height*u(e)),width:Math.round(t.width*u(e))}}function h(){var n=this;if(T._tiled){var o=0;return T.find("."+Dn.atala_tile_column).first().find("img").each(function(e,t){Un(this,n),o+=t.naturalHeight}.bind(this)),o}return T.prop("naturalHeight")}function f(){var e=this;if(T._tiled){var t=0;return T.find("."+Dn.atala_tile_column).each(function(){Un(this,e),t+=xn(this).find("img").first().prop("naturalWidth")}.bind(this)),t}return T.prop("naturalWidth")}function g(e){var _=c(),w=q.vector&&(!P||!P.uri)?u():Math.min(u(),1),z=N.document.getPageRotation(_);if(e||w!==T._zoom||T._rotation!==z){var k=xn.extend({atala_docurl:P?P.uri:T.documenturl,atala_doczoom:w,atalamultiprocessing:U.multiprocessing,atala_framecount:q.count,atala_thumbpadding:!1},r);if(z&&(k.atala_angle=z),U.jpeg&&(k.atala_jpeg=!0),U.tiling&&U.forcepagefit&&!T._loaded)if(ye(j*q.dpi/96,_)){var t,n=_e(),o=xe(_);t=o.width>o.height?n.width/o.width:n.height/o.height,oe(w,t)||(w=t,k.atala_doczoom=w)}if(T._tiled=function(e,t){var n=!1,o=j*q.dpi/96;if(U.tiling&&!L&&ye(o,e)){var i=_e(),a=xe(e);a.height>o&&a.width>o&&(2<a.height*t/i.height||2<a.width*t/i.width)&&(n=!0)}return n}(_,w),T._tiled)!function(){var n=this,s=xe(_),e=C(),t=_e(),c=Math.min(R,Math.floor(e.height/t.height)),u=Math.min(R,Math.floor(e.width/t.width)),d={width:Math.ceil(s.width/u),height:Math.ceil(s.height/c)};if(c!==T._tilesV||u!==T._tilesH){et();var o=D(),i=T;T=X(),o.children().replaceWith(T),E(i),T.addClass(Dn.atala_tiled_page_image);for(var a=0;a<u;a++){var r=X(T);r.addClass(Dn.atala_tile_column);for(var l=0;l<c;l++){var h=X(r);h.attr("tile_index_h",a).attr("tile_index_v",l),h.width(d.width*w),h.height(d.height*w),h.addClass(Dn.atala_page_loading);var f=xn(new Image);f.css("display","none"),h.append(f)}}T._tilesH=u,T._tilesV=c}(B.loadedImgs[T._cacheIndex]=T)._needToInsert=!1,T.__tileRequests=[],T.__tilesArray=[];for(var g=0;g<u;g++)for(var p=0;p<c;p++)T.__tilesArray.push({x:g,y:p});var v={x:0,y:0},m=function(e,t){return Un(this,n),Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2)}.bind(this);T.__tilesArray.sort(function(e,t){return Un(this,n),m(v,e)-m(v,t)}.bind(this)),T.__tilesArray.forEach(function(e){var t,n,o,i,a=e.x,r=e.y;switch(z){case 0:t=Math.ceil(a*d.width),n=Math.ceil(r*d.height),o=a<u-1?d.width:s.width-t,i=r<c-1?d.height:s.height-n;break;case 90:t=Math.ceil(r*d.height),n=Math.ceil((u-1-a)*d.width),o=r<c-1?d.height:s.height-t,i=0!==a?d.width:s.width-n;break;case 270:t=Math.ceil((c-1-r)*d.height),n=Math.ceil(a*d.width),o=0!==r?d.height:s.height-t,i=a<u-1?d.width:s.width-n;break;case 180:t=Math.ceil((u-1-a)*d.width),n=Math.ceil((c-1-r)*d.height),o=0!==a?d.width:s.width-t,i=0!==r?d.height:s.height-n;break;default:Z("ImageError","Invalid rotation angle: "+z)}var l=xn.extend(!0,{},k,{atala_tilestart:t+"x"+n,atala_pagesize:o+"x"+i});l.atala_doczoom=w,T.__tileRequests.push({type:"docpage",serverurl:U.serverurl,query:"?ataladocpage="+(null===P?T._index:void 0!==P.index?P.index:P),method:"GET",data:l,cancel:!1})}),T._reqzoom=w,T._reqangle=z;for(var b=T._tilesLoadedCount=0;(b=Math.floor(2147483647*Math.random()))===W.tilingCorrelationId;);if(W.tilingCorrelationId=b,U.multiprocessing)for(var x=function(e){var t=this;tt(),setTimeout(function(){Un(this,t),M(e,d)}.bind(this),0)},y=0;y<T.__tilesArray.length;y++)x(y);else setTimeout(function(){Un(this,n),tt(),M(0,d)}.bind(this),0)}();else{if(1<T._tilesV||1<T._tilesH){var i=D(),a=T;T=xn(new Image),i.children().replaceWith(T),E(a),T.addClass(Dn.atala_page_image),i.addClass(Dn.atala_page_loading),T._tilesV=1,T._tilesH=1,T.__tilesArray=[],(B.loadedImgs[T._cacheIndex]=T)._needToInsert=!1}T._reqzoom=w,T._reqangle=z,$t({type:"docpage",serverurl:U.serverurl,query:"?ataladocpage="+(null===P?T._index:void 0!==P.index?P.index:P),method:"GET",data:k,cancel:!1,info:T},p,p)}}}function M(t,n){function o(){return e!==W.tilingCorrelationId||W.itch||T._reqzoom!==u()||T._reqangle!==N.document.getPageRotation(c())||void 0===T.__tileRequests[t]||void 0===T.__tilesArray[t]}var e=W.tilingCorrelationId;if(o())g();else{var i=T.__tileRequests[t],a=T.__tilesArray[t].x,r=T.__tilesArray[t].y,l=T.find('div[tile_index_h="'+a+'"][tile_index_v="'+r+'"]').find("img");l.attr("tile_index",t),l.attr("src",i.serverurl+i.query+"&"+xn.param(i.data)),l[0].onload=function(){if(T&&!o()){if(T._tilesLoadedCount++,l.css("display","block"),l.parent().css({width:"auto",height:"auto"}),l.parent().removeClass(Dn.atala_page_loading),0===t){var e=C();T.trigger({type:"pageresize",image:T,index:c(),width:e.width,height:e.height})}0===l.width()&&0===l.height()&&l.css({width:"auto",height:"auto"}),U.multiprocessing?T._tilesLoadedCount>=T.__tilesArray.length&&p():t<T.__tilesArray.length-1?M(t+1,n):p()}}}}function p(){T._loaded||T._domEl.removeClass(Dn.atala_page_loading),T._tiled&&W.zooming&&_t(),T._loaded=!0,T._zoom=T._reqzoom,T._rotation=T._reqangle;var e=c();if(0<=e){if(T._rotation!==N.document.getPageRotation(e))return void g();(T._viewrotation=0)<T.parent().length&&m(),F(T._viewrotation);var t=q.vector?u():Math.min(u(),1);y()&&T._zoom<t*i&&!oe(T._zoom,t)&&x(!1)}k()}function E(e){T._loaded=e._loaded,T._zoom=e._zoom,T._rotation=e._rotation,T._prevzoom=e._prevzoom,T._scaledzoom=e._scaledzoom,T._binds=e._binds,T.documenturl=e.documenturl,T._index=e._index,T._size=e._size,T._viewrotation=e._viewrotation,T._tiled=e._tiled,T._page=e._page,T._reqzoom=e._reqzoom,T._domEl=e._domEl,T._cacheIndex=e._cacheIndex,T.dispose=b,T.zoom=x,T.needsZoom=y,T.getSize=s,T.getScaledSize=C,T.getFitZoom=u,T.getFitMultiplier=l,T.needsRotate=S,T.rotate=I,T.getDomElement=D,T.invalidate=O,T.naturalHeight=h,T.naturalWidth=f,T.on(a)}function v(e){e&&(e.removeAttr("width height"),e.css({width:"auto",height:"auto"}))}function m(){v(T);var e=T.naturalWidth()||0,t=T.naturalHeight()||0,n=e||T.width(),o=t||T.height(),i=s(),a=u(),r=!1;if(_n.Explorer&&!L&&n<40&&T._zoom>ie()&&(n=i.width*a,o=i.height*a),0!==n&&0!==o){T._tiled||(T._size.width=Math.round(n/T._zoom),T._size.height=Math.round(o/T._zoom)),90!==T._viewrotation&&270!==T._viewrotation||(T._size=V(T._size)),T._size.width===q.size.width&&T._size.height===q.size.height||oe(T._size.width,i.width)&&oe(T._size.height,i.height)||(r=!0,N.document.setPageSize(c(),T._size)),null===N.document.getPageSize(c())&&(r=!0,N.document.setPageSize(c(),T._size)),U.forcepagefit?z():(T._zoom!==U.zoom||r||0!==T._viewrotation)&&w();var l=C();r&&T.trigger({type:"pagesizechanged",image:T,index:c(),width:T._size.width,height:T._size.height,dx:Math.round(l.width-i.width*a),dy:Math.round(l.height-i.height*a)}),T.trigger({type:"pageresize",image:T,index:c(),width:l.width,height:l.height})}}function b(){T.off(a),T._page=null,T=null}function x(e,t){!y()||T._size.isEmpty()&&!T._tiled?"function"==typeof t&&t.call(this,T):("function"==typeof t&&o.push(t),T._prevzoom=T._reqzoom,e&&!W.loading?T._tiled?T.find("img").each(function(){var e=xn(this);e.animate({height:Math.round(e.height()/T._reqzoom*u()),width:Math.round(e.width()/T._reqzoom*u())},{duration:H,easing:"easeOutQuad",complete:_,queue:!1})}):T.animate({height:Math.round(T._size.height*u()),width:Math.round(T._size.width*u())},{duration:H,easing:"easeOutQuad",complete:_,queue:!1}):(w(),_()))}function y(){if(!T._loaded&&!T._tiled)return!1;var e=!q.vector&&1===T._reqzoom&&1===T._prevzoom&&1<u(),t=oe(T._reqzoom,u())||e;if(!t){var n=Math.abs(T._reqzoom*T._size.width-u()*T._size.width),o=Math.abs(T._reqzoom*T._size.height-u()*T._size.height);n<1&&o<1&&(t=!0)}return!t||!oe(T._scaledzoom,u())}function _(){var e=u();T.trigger({type:"pagezoom",index:c(),height:Math.round(T._size.height*e),width:Math.round(T._size.width*e),prevzoom:T._prevzoom,zoom:e}),0===W.prpr?g():k()}function w(){var e,t,n,o=C(void 0,d()),i=C(),a=T.naturalWidth()||0,r=T.naturalHeight()||0,l=a&&Math.abs(a-o.width)/o.width<.01,s=r&&Math.abs(r-o.height)/o.height<.01;l&&s||(T._tiled&&0!==r&&0!==a?T.find("img").each(function(){var e=xn(this),t=e.prop("naturalHeight"),n=e.prop("naturalWidth");0!==t&&0!==n&&(e.height(t*u()),e.width(n*u()))}):(T.height(o.height),T.width(o.width))),T._domEl.width(i.width),T._domEl.height(i.height),T._scaledzoom=u(),T._tiled?A(T._viewrotation):F(T._viewrotation),e=c(),t=i.width,i.height,null!=(n=rt(e))&&null!=n._num&&n._num.css({left:t-20,right:0})}function z(){var e,t=function(e){var t=1;e=e||T._size;var n={width:U.forcepagesize.width*(L?1:U.zoom),height:U.forcepagesize.height*(L?1:U.zoom)};(n.width<1||n.height<1)&&(n.width=q.size.width*U.zoom,n.height=q.size.height*U.zoom);t=e.width/n.width>e.height/n.height?n.width/e.width:n.height/e.height;return t}();e=t/U.zoom,N.document.setPageFitMultiplier(c(),e),w()}function k(){0<o.length&&function(e){var t=Array.prototype.slice.call(arguments,1);for(;e.length;)e.shift().apply(this,t)}(o,T)}function S(){var e=N.document.getPageRotation(c());return 0===T._viewrotation&&e!==T._rotation||0!==T._viewrotation}function I(e){if("function"==typeof e&&o.push(e),S()){var t=N.document.getPageRotation(c());if(n=N.document.getPageRotation(c()),(0===T._viewrotation&&n!==T._rotation||0!==T._viewrotation&&(T._viewrotation+T._rotation)%360!==n)&&T&&T._page&&(t=(360+t-T._rotation)%360,!T._tiled&&T._loaded?(F(t),m()):T._tiled&&(A(t),function(){v(T);var e=c(),t=N.document.getPageSize(e);if(90===T._viewrotation||270===T._viewrotation){var n=V(t);T._size.width=n.width,T._size.height=n.height,N.document.setPageSize(e,T._size)}U.forcepagefit?z():T._zoom===U.zoom&&0===T._viewrotation||w()}(),0!==(i=t)&&T.find("img").each(function(){var e=xn(this),t={width:e.width(),height:e.height()};90!==i&&270!==i||(t=V(t));var n=e.parent();0!==t.width&&0!==t.height&&(n.width(t.width),n.height(t.height)),n.addClass(Dn.atala_page_loading);var o=xn(new Image);o.css("display","none"),n.children().replaceWith(o)}))),0===W.prpr&&T._loaded)return void g()}var i,n;k()}function F(e){var t=d(),n=C(void 0,t),o=0,i=0,a="";90!==e&&270!==e||(o=(n.height-n.width)/2,L&&t.width<t.height&&(o=0),i=(n.width-n.height)/2,n=V(n)),0!==e?(a+=" translate("+o+"px,"+i+"px)",a+="rotate("+e+"deg)",T.css(Sn(a))):T.css(Sn("")),D().css({width:n.width,height:n.height}),T._viewrotation=e}function A(e){var t=C(void 0,d());90!==e&&270!==e||(t=V(t)),D().css({width:t.width,height:t.height}),T._viewrotation=e}function O(e,t){"function"==typeof e&&(t=e,e={}),(r=xn.extend(!0,{},e)).atala_cb=Math.floor(1e9*Math.random()),"function"==typeof t&&o.push(t),g(!0)}function V(e){var t=e.width;return e.width=e.height,e.height=t,e}return T._binds=a,T.documenturl=U.documenturl,T._index=P?P.mapsto:e,T._loaded=!1,T._size={width:0,height:0,isEmpty:function(){return 0===this.width&&0===this.height}},T._zoom=-1,T._prevzoom=T._zoom,T._scaledzoom=-1,T._rotation=0,T._viewrotation=0,T._tiled=!1,T._tilesV=1,T._tilesH=1,T.dispose=b,T.zoom=x,T.needsZoom=y,T.getSize=s,T.getScaledSize=C,T.getFitZoom=u,T.getFitMultiplier=l,T.needsRotate=S,T.rotate=I,T.getDomElement=D,T.invalidate=O,T.naturalHeight=h,T.naturalWidth=f,function(){T.on(a);var e=U.pageborderwidth,t={bottom:0,top:0,right:0,left:0};T._loaded=!1,T._reqzoom=-1,T._needToInsert=!0,(U.direction===zn.Vertical||U.tabular)&&(t.bottom=U.pagespacing);(U.direction===zn.Horizontal||U.tabular)&&(t.right=U.pagespacing);var n=D();U.showpageborder&&n.css({"border-bottom":e+"px solid black","border-right":e+"px solid black","border-top":e+"px solid silver","border-left":e+"px solid silver","margin-bottom":t.bottom+"px","margin-right":t.right+"px"});n.css({display:"inline-block"}),n.addClass(Dn.atala_page_loading),g()}(),T}function $(e,t){var n=X(e);n.css({position:"absolute",display:"none","background-color":"white"});var o=null,i=!1;function a(){o._tooltip.hide(),q.number===o._pagenum||at(o._pagenum)||We(o._pagenum),Gt()}function r(e,t){if(U.forcepagefit){t*=e._ratio;var n=e.ScrollDirection===zn.Vertical?{x:0,y:t}:{x:t,y:0};return ce(n.x,n.y)+1}return Math.floor(t/(e._max/N.document.getPageCount()))+1}return t===zn.Horizontal?(o=_n.Firefox?xn('<div class="atala_scrollbar_firefox_x"></div>').appendTo(e):xn('<div class="atala_scrollbar_x"></div>').appendTo(e))._tray=xn("<div/>").css("height","1px").appendTo(o):(_n.Firefox?(o=xn('<div class="atala_scrollbar_firefox_y"></div>').css("width",function(){var e=X(xn("body")),t=X(e);e.css({width:"50px",height:"50px",overflow:"hidden",position:"absolute",visibility:"hidden"}),t.css({width:"100px",height:"100px"});var n=e.width();e.css({"overflow-y":"scroll"});var o=n-e[0].clientWidth;return xn(e).remove(),o}()+1+"px;").appendTo(e),i=!0):o=xn('<div class="atala_scrollbar_y"></div>').appendTo(e),o._explicitSize=i,o._tray=xn("<div/>").css("width","1px").appendTo(o)),te(o),o._ratio=1,o.ScrollDirection=t,o._tooltip=n,o._pagenum=-1,o._scrollSize=0,o.pageNum=function(e){o._pagenum=e},o.scrollbarHeight=function(){return o.height()-o[0].clientHeight},o.scrollSize=function(e){o._scrollSize=e},o.ratio=function(e){o._ratio=e},o.on({scroll:function(){if(!o.propagationPaused()){clearTimeout(o._tooltip._timeout),B.scroller.stop(),B.scroller.pauseEventPropagation(!0);var e={};o.ScrollDirection===zn.Vertical?(B.scroller.scrollTop(o[0].scrollTop*o._ratio),o._pagenum=x?un()+1:r(o,o[0].scrollTop),e.right=o.outerWidth()+10+"px",e.top=16+Math.round((o[0].offsetHeight-48)/o[0].scrollHeight*o[0].scrollTop)+"px",o.attr("aria-valuenow",o.scrollTop()/o._max)):o.ScrollDirection===zn.Horizontal&&(B.scroller.scrollLeft(o[0].scrollLeft*o._ratio),o._pagenum=x?un()+1:r(o,o[0].scrollLeft),e.bottom=o.outerHeight()+10+"px",e.left=16+Math.round((o[0].offsetWidth-48)/o[0].scrollWidth*o[0].scrollLeft)+"px",o.attr("aria-valuenow",o.scrollLeft()/o._max)),o.ScrollDirection===U.direction&&U.showpagenumbertooltip&&("none"===o._tooltip.css("display")&&(o._tooltip.css(e),o._tooltip.show()),U.showpagenumbertooltip&&o._tooltip.html("Page "+o._pagenum),o._tooltip._timeout=setTimeout(a,1e3))}}}),o}function ee(e){e&&e._tooltip&&(clearTimeout(e._tooltip._timeout),e._tooltip.hide())}function te(t){var n={scroll:function(){t.off(n),t.resumeEventPropagation()}};t._pauseEP=0,t.propagationPaused=function(){return 0<t._pauseEP},t.pauseEventPropagation=function(e){t._pauseEP++,e&&t.on(n)},t.resumeEventPropagation=function(){0<t._pauseEP&&t._pauseEP--}}function ne(e){var t=_e(),n=re(0,e);!W.hidden&&t.height<=0&&t.width<=0&&(W.hidden=!0,function(){var e=this;if(_n.Edge||_n.Explorer)var t=setInterval(function(){Un(this,e),0!==B.scroller.height()&&0!==B.scroller.width()&&(clearInterval(t),W.hidden=!1,fn("viewportunhide"))}.bind(this),500);else{var n=new ResizeObserver(function(){Un(this,e),W.hidden=!1,fn("viewportunhide"),n.unobserve(B.scroller[0])}.bind(this));n.observe(B.scroller[0])}}()),n.width=0<q.smallest.width&&q.smallest.width<n.width&&!L?q.smallest.width:n.width,n.height=0<q.smallest.height&&q.smallest.height<n.height&&!L?q.smallest.height:n.height;var o,i=Math.ceil(t.width/n.width)+2,a=Math.ceil(t.height/n.height)+2;return U.tabular?(U.direction===zn.Vertical&&0<U.columns?i=U.columns:U.direction===zn.Horizontal&&0<U.rows&&(a=U.rows),o=i*a):U.direction===zn.Vertical?o=a:U.direction===zn.Horizontal&&(o=i),o}function oe(e,t){return t<e+.001&&e-.001<t}function ie(){return 0!==q.size.width?U.minwidth/q.size.width:1}function ae(){return 0!==q.size.width?U.maxwidth/q.size.width:1}function re(e,t,n){if(N.document.getPageCount()<=0)return{width:0,height:0};if(n=void 0===n||n,W.newpagedivsize){var o={width:W.newpagedivsize.width,height:W.newpagedivsize.height},i=U.showpageborder&&n?2*U.pageborderwidth:0,a=(t||U.zoom)/W.newpagedivfullzoom;return o.height=Math.round(o.height*a)+i,o.width=Math.round(o.width*a)+i,o}return le(e,t||U.zoom,U.showpageborder&&n)}function le(e,t,n){var o,i=xn.extend({},xe(e)),a=n?2*U.pageborderwidth:0;return t*=(o=e,N.document.getPageFitMultiplier(o)),i.height=Math.round(i.height*t)+a,i.width=Math.round(i.width*t)+a,i}function se(e,t){return ge(null,e,t).index}function ce(e,t){var n=he(),o=_e();if(U.direction===zn.Vertical){var i=0;if(B.scrollH&&(i=1,"none"!==B.scrollH.find("div").css("display")||_n.Firefox||(i=B.scrollH.outerHeight(!0))),t>=n.height-o.height-i&&0<W.scrollTarget.Page)return W.scrollTarget.Page-1}var a=B.scrollV&&"none"!==B.scrollV.find("div").css("display")?1:0;if(U.direction===zn.Horizontal&&e===n.width-o.width-a&&0<W.scrollTarget.Page)return W.scrollTarget.Page-1;var r={x:e+U.pageselectlocation.x*o.width,y:t+U.pageselectlocation.y*o.height};return se(r.x,r.y)}function ue(e,t){for(var n={left:0,top:0},o=e;null!=o&&o!==t;o=o.offsetParent)n.left+=o.offsetLeft,n.top+=o.offsetTop;return n}var de={height:0,isEmpty:function(){return 0===this.width&&0===this.height},width:0,zero:function(){this.width=0,this.height=0},zoom:1};function he(){if(de.isEmpty()||de.zoom!==U.zoom){var e=ge(null,null,null,U.zoom);de.height=e.height,de.width=e.width,de.zoom=U.zoom}return de}function fe(){de.zero(),he()}function ge(e,t,n,o){return pe(0,e,t,n,o)}function pe(e,t,n,o,i){if(U.tabular)return function(e,t,n,o,i){if(t<e)return{width:0,height:0,index:t};var a=ve(e,n,o,i),r=ve(t,n,o,i);return r.height=U.direction===zn.Vertical?r.height-a.height:r.height,r.width=U.direction===zn.Horizontal?r.width-a.width:r.width,r}(e,t,n,o,i);var a=N.document.getPageCount();e=e||0,t=t||0===t?t:a,x&&(a=1,t=e=0);var r={height:0,width:0,index:e};if(U.direction===zn.Vertical)for(var l=null,s=e;s<a&&s<t&&(r.height+(l=re(s,i).height)<=o||null==o);s++)r.height+=l+U.pagespacing,r.index++;else if(U.direction===zn.Horizontal)for(var c=null,u=e;u<a&&u<t&&(r.width+(c=re(u,i).width)<=n||null==n);u++)r.width+=c+U.pagespacing,r.index++;return r.index>=a&&0<a&&(r.index=a-1),r}function ve(e,t,n,o){var i,a,r=N.document.getPageCount(),l={height:0,width:0,index:0},s=me(o);e=null==e?e=r:e,U.direction===zn.Vertical?(i=s||1,a=Math.ceil(r/i)):U.direction===zn.Horizontal&&(a=s||1,i=Math.ceil(r/a));var c=re(0,o);c.width+=U.pagespacing,c.height+=U.pagespacing;var u=null==n?Math.floor(e/i):Math.floor(n/c.height),d=null==t?e%i:Math.ceil(t/c.width);return l.height=u*c.height,l.width=d*c.width,l.index=u*i+d,l.index>=r&&0<r&&(l.index=r-1),l}function me(e){if(x)return 1;var t=1;if(U.tabular){var n=U.pagespacing||0,o=re(0,e);U.direction===zn.Vertical?(t=Math.floor(B.content.width()/o.width),t=Math.min(t,Math.floor((B.content.width()-t*n)/o.width))):U.direction===zn.Horizontal&&(t=Math.floor(B.content.height()/o.height),t=Math.min(t,Math.floor((B.content.height()-t*n)/o.height)))}return t||1}function be(e,t){var n=xe(e);return(Et(e)+(t||0))%180==0?n:{width:n.height,height:n.width}}function xe(e){var t=N.document.getPageSize(e);return t||q.size}function ye(e,t){return N.document.canBeTiled(e,t)}function _e(){return{width:B.scrollV?B.main.width()-B.scrollV.outerWidth():B.main.width(),height:B.scrollH?B.main.height()-B.scrollH.outerHeight():B.main.height()}}function we(){var e=_e(),t=U.showpageborder?2*U.pageborderwidth:0,n={width:e.width-t,height:e.height-t};return U.tabular&&(1<U.columns&&(n.width=Math.floor((e.width-(U.pagespacing+t)*U.columns)/U.columns)),1<U.rows&&(n.height=Math.floor((e.height-(U.pagespacing+t)*U.rows)/U.rows))),n}function ze(e,t){var n={status:"fail",started:!1,reason:e};return"function"==typeof t&&t.call(),n}function ke(e,t,n,o,i,a){var r=ue(e,t);return r.left<=i&&r.left+e.clientWidth>=n&&r.top<=a&&r.top+e.clientHeight>=o}function Pe(e,t,n){return t<e.length&&(e.splice(n,0,e.splice(t,1)[0]),!0)}function Te(e){U.showstatus&&B.status&&B.status.html(e),fn({type:"statusmessage",message:e})}function De(e,t){var n;if(1===e.length&&"object"==typeof e[0])n=e[0];else if("string"==typeof e[0]){n={};var o=null;3===e.length?o=e[2]:2===e.length&&(o=e[1]);for(var i=-1<e[0].indexOf(" ")?e[0].split(" "):[e[0]],a=0;a<i.length;a++)n[i[a]]=o}for(var r in n)if(n.hasOwnProperty(r)){var l=null;if(r in d?l=d:c&&r in c.annotations.events?l=c.annotations.events:c&&r in c.forms.events?l=c.forms.events:c&&r in c.document.events&&(l=c.document.events),null==l&&(l=d),null==l[r])t&&(l[r]=[n[r]]);else if(t)l[r].push(n[r]);else if(n[r])for(var s=0;s<l[r].length;s++)l[r][s]===n[r]&&l[r].splice(s,1);else l[r].length=0}}function Ce(e,t){return t?isFinite(parseFloat(e)):isFinite(parseInt(e,10))}function Me(e,t,n,o,i){if(null==i&&"function"==typeof o&&(i=o,o=null),e=null==e?B.scroller.scrollLeft():e,t=null==t?B.scroller.scrollTop():t,U.direction===zn.Horizontal){if(e>B.viewport.width()){var a=he();if(e<a.width&&0<B.content.width()){var r=a.width-(B.edges[0].width()+B.content.width());B.edges[1].width(r)}}}else if(U.direction===zn.Vertical&&t>B.viewport.height()){var l=he();if(t<l.height&&0<B.content.height()){var s=l.height-(B.edges[0].height()+B.content.height());B.edges[1].height(s)}}B.scroller.stop(),!n||W.loading||W.scrollPos.x===e&&W.scrollPos.y===t?(B.scroller.scrollLeft(e),B.scroller.scrollTop(t),"function"==typeof i&&i.call()):xn.when(B.scroller.animate({scrollLeft:e,scrollTop:t},{duration:o||u,easing:"easeOutQuad",queue:!1})).done(i)}function Ee(e,t){if(B.scroller.is(":animated"))return ze("scrolling",t);var n=ge(q.number+e-1);Me(n.width,n.height,!0,t)}function Se(){if(B.scrollH&&B.scrollV){var e=x?1:N.document.getPageCount();if(B.scrollH.pauseEventPropagation(),B.scrollV.pauseEventPropagation(),U.direction===zn.Vertical){Fe(B.scrollH,"width");var t=x?un():e-1,n=Math.round(ge(e-1).height+re(t).height);_n.Firefox&&(n+=Math.round(B.scrollH.scrollbarHeight())),B.scrollV.scrollSize(n-(B.scrollV.height()-B.scrollH.scrollbarHeight()-1)),3e4<n?(B.scrollV.ratio(n/(3e4-(B.scrollV.height()-B.scrollH.scrollbarHeight()-1))),B.scrollV._tray.height(3e4)):(B.scrollV._tray.height(n),B.scrollV.ratio(1)),Ae(B.scrollV)}else if(U.direction===zn.Horizontal){Fe(B.scrollV,"height");var o=x?un():e-1,i=Math.round(ge(e-1).width+re(o).width);B.scrollH.scrollSize(i),3e4<i?(B.scrollH.ratio(i/(3e4-(B.scrollH.width()-B.scrollV.width()-1))),B.scrollH._tray.width(3e4)):(B.scrollH._tray.width(i),B.scrollH.ratio(1)),Ae(B.scrollH),Re(o,null)}B.scrollV._max=Math.max(B.scrollV._tray.height()-B.scrollV.height(),0)+1,B.scrollH._max=Math.max(B.scrollH._tray.width()-B.scrollH.width(),0)+1,B.scrollH.resumeEventPropagation(),B.scrollV.resumeEventPropagation()}}function Ie(e,t){if(U.direction===zn.Vertical){if(B.scrollV)if(B.scrollV.scrollSize(Math.max(B.scrollV._scrollSize+t,0)),1===B.scrollV._ratio&&B.scrollV._scrollSize+t<3e4)B.scrollV._tray.height(B.scrollV._tray.height()+t),B.scrollV._max=Math.max(B.scrollV._tray.height()-B.scrollV[0].clientHeight,0)+1;else{var n=B.scrollV.height()-B.scrollH.scrollbarHeight()-1,o=(3e4-n)*B.scrollV._ratio;3e4<o+t?B.scrollV.ratio((o+t)/(3e4-n)):Se()}Ae(B.scrollV),Fe(B.scrollH,"width")}else if(U.direction===zn.Horizontal){if(B.scrollH)if(B.scrollH.scrollSize(Math.max(B.scrollH._scrollSize+e,0)),1===B.scrollH._ratio&&B.scrollH._scrollSize+e<3e4)B.scrollH._tray.width(B.scrollH._tray.width()+e),B.scrollH._max=Math.max(B.scrollH._tray.width()-B.scrollH[0].clientWidth,0)+1,B.scrollH.ratio(B.scrollH._scrollSize/B.scrollH._max);else{var i=B.scrollH.width()-B.scrollV.width()-1,a=(3e4-i)*B.scrollH._ratio;3e4<a+e?B.scrollH.ratio((a+e)/(3e4-i)):Se()}Ae(B.scrollH),Fe(B.scrollV,"height")}if((0!==e||0!==t)&&0!==t){var r=B.scroller[0].scrollLeft,l=B.scroller[0].scrollTop;Ze(x?un()+1:ce(r,l)+1),fn({type:"scroll",x:r,y:l,dx:0,dy:0})}}function Fe(e,t){if(e&&B.pageDivs.length){var n=Math.round(q.size[t]*U.zoom);if(U.tabular)n=B.content[t]();else for(var o=x?1:B.pageDivs.length,i=0;i<o;i++)null!=B.pageDivs[i]._index&&(n=Math.max(re(B.pageDivs[i]._index)[t],n));e._tray[t](n),e.scrollSize(n-e[t]()),Ae(e),e.ratio(1)}}function Ae(e){e&&(e._scrollSize<=0?e._tray.hide():e._tray.show())}var Oe=!1;function Ve(e){if(!W.zooming&&!W.scrollBuffer&&B.pageDivs.length){var t=(new Date).getTime(),a=B.scroller[0].scrollLeft,r=B.scroller[0].scrollTop;if(!W.loading){if(!x){var n=a+B.scroller[0].clientWidth,o=r+B.scroller[0].clientHeight,i=se(a,r)+1,l=Math.abs(i-q.number)/me(),s=N.document.getPageCount(),c=B.pageDivs[0]._index,u=B.pageDivs[B.pageDivs.length-1]._index,d=0===l&&(q.number-1<c||q.number-1>u);if(l<B.pageDivs.length&&!d)ke(B.edges[1][0],B.scroller[0],a,r,n,o)&&u<s-1?Ne(l):ke(B.edges[0][0],B.scroller[0],a,r,n,o)&&0<c?Be(l):i!==q.number&&null===rt(i-1)&&We(i);else{var h=B.scroller[0].scrollLeft,f=B.scroller[0].scrollTop;Ue(i,Oe=!1,null),U.direction===zn.Vertical&&h!==B.scroller[0].scrollLeft&&(B.scroller.scrollLeft(h),Oe=!0),U.direction===zn.Horizontal&&f!==B.scroller[0].scrollTop&&(B.scroller.scrollTop(f),Oe=!0)}}Tt()}if(Ze(x?q.number:ce(a,r)+1),!B.scroller.propagationPaused()&&B.scrollH&&B.scrollV){var g=Math.round(a/B.scrollH._ratio),p=Math.round(r/B.scrollV._ratio);g!==B.scrollH.scrollLeft()&&(B.scrollH.pauseEventPropagation(!0),B.scrollH.scrollLeft(g)),p!==B.scrollV.scrollTop()&&(B.scrollV.pauseEventPropagation(!0),B.scrollV.scrollTop(p))}fn({type:"scroll",x:a,y:r,dx:a-W.scrollPos.x,dy:r-W.scrollPos.y}),e&&(W.scrollTimeout&&clearTimeout(W.scrollTimeout),W.scrollTimeout=setTimeout(function(){var e,t,n,o,i;e=a,t=r,n=B.scroller[0].scrollLeft,o=B.scroller[0].scrollTop,i=n===W.scrollPos.x&&o===W.scrollPos.y,e===W.scrollPos.x&&t===W.scrollPos.y&&i?(Gt(),W.scrollTimeout=null,W.loading||Tt()):i?i&&Oe?Math.abs(e-W.scrollPos.x)<3&&Math.abs(t-W.scrollPos.y)<3&&(Gt(),W.scrollTimeout=null,W.loading||Tt()):i&&L&&q.buffer===U.maxpagebuffersize&&(Gt(),W.scrollTimeout=null,W.loading||Tt()):(Ve({}),W.scrollTimeout=null)},500),W.scrollPos.x=B.scroller[0].scrollLeft,W.scrollPos.y=B.scroller[0].scrollTop,W.scrollPos.t=t),W.scrollBuffer=e?setTimeout(Le,50):null}}function Le(){null!==W.scrollBuffer&&(clearTimeout(W.scrollBuffer),W.scrollBuffer=null)}function He(){if(U.direction===zn.Horizontal){var e=B.pageDivs.length?(L?Math.max(q.size.height,q.size.width):q.size.height)*U.zoom:0;U.thumbpadding&&"number"==typeof U.thumbpadding&&(e+=2*U.thumbpadding),B.edges[0].height(e),B.edges[1].height(e)}}function Re(e,t){t=t||0===t?t:e+B.pageDivs.length-1,t=Math.max(e,t);var n=U.tabular?me():1,o=U.tabular?(Math.floor(t/n)+1)*n-t:1,i=ge(e),a=x?1:N.document.getPageCount();x&&(t=e=0);var r=t<a?re(t):{width:0,height:0},l=x?un():a-1,s=t<a-n?re(l):{width:0,height:0},c=pe(e,t);c.width+=r.width,c.height+=r.height;var u=pe(t+1,a-1);if(u.width+=s.width,u.height+=s.height,U.direction===zn.Vertical)B.edges[0].height(i.height),(x?a:N.document.getPageCount())<=t+o?B.scrollH&&0===B.scrollH._tray[0].offsetWidth?B.edges[1].height(B.scrollH[0].offsetHeight-1):B.edges[1].height(0):(B.edges[1].height(u.height),_n.Chrome&&B.content.height(""));else if(U.direction===zn.Horizontal){if(B.edges[0].width(i.width),(x?a:N.document.getPageCount())<=t+o){var d=i.width+c.width+u.width;B.scrollV&&d>B.scroller[0].clientWidth&&B.content.height()<=B.scroller[0].clientHeight?B.scrollV._explicitSize?B.edges[1].width(B.scrollV.height()<B.scrollV._tray.height()?B.scrollV.width():0):B.edges[1].width(B.scrollV.width()):B.edges[1].width(0)}else B.edges[1].width(u.width),B.edges[1].height(1)}}function je(){return W.activepage}function Be(e){if(e=e||1,x)qe(un()-e);else if(0===W.prpr&&0<B.pageDivs.length){var t=me(U.zoom);Ke();for(var n=e;0<n;n--){var o=B.pageDivs[0]._index-t;if(0<=o&&o<N.document.getPageCount()){for(var i=t-1;0<=i;i--){var a=nt(-1);Ge(a),B.content.prepend(a),Je(a,it(o+i),o+i)}Re(o,null),He()}}setTimeout($e,10)}}function Ne(e){if(e=e||1,x){qe(un()+e)}else{var t=B.pageDivs[B.pageDivs.length-1]._index+1;if(0===W.prpr&&0<B.pageDivs.length&&t<N.document.getPageCount()){Ke();for(var n=me(U.zoom),o=N.document.getPageCount(),i=e;0<i;i--){var a=B.pageDivs[B.pageDivs.length-1]._index+1;if(a<o){for(var r=a+n-1-B.pageDivs.length,l=0;l<n;l++){var s=nt(1);Ge(s),B.content.append(s),Je(s,it(a+l),a+l)}Re(r+1,a),He()}}setTimeout($e,10)}}}
/**
...
/**
   ...
   */function We(e,t){var n=this;if(U.direction===zn.Vertical?B.scrollV&&clearTimeout(B.scrollV._tooltip._timeout):U.direction===zn.Horizontal&&B.scrollH&&clearTimeout(B.scrollH._tooltip._timeout),e=Math.max(1,e),e=Math.min(N.document.getPageCount(),e),x)Ue(e,!1,t);else{if(L||W.zooming||(W.scrollTarget.Page=e),q.number!==e){var o=e-q.number;Math.abs(o)<B.pageDivs.length?Ee(o,t):Ue(e,!0,t)}else Ee(0,t);setTimeout(function(){return Un(this,n),W.scrollTarget.Page=0}.bind(this),1e4)}}function Ue(e,t,n){var o=N.document.getPageCount(),i=e-1;if(0===W.prpr&&0<o){var a=function(){x?(Se(),$e()):$e(!t),"function"==typeof n&&n.call()};if(Ke(),x){if(U.direction===zn.Vertical){var r=ge(0).height;B.edges[0].height(r)}else if(U.direction===zn.Horizontal){var l=ge(0).width;B.edges[0].width(l)}Re(0,null),He(),Xe();for(var s=0;s<B.pageDivs.length;s++)Je(B.pageDivs[s],null,i+s);B.content.append(B.pageDivs[0]),Gt(),Ze(i+1),Tt(!1,a)}else{var c=0,u=0,d=i<=0?0:i;if(d+B.pageDivs.length>=o){if(d=o-B.pageDivs.length,U.tabular){var h=me();d=Math.ceil(d/h)*h}d=Math.max(d,0)}if(U.direction===zn.Vertical){c=ge(d).height,B.edges[0].height(c),Re(d,null),He(),Xe();for(var f=0;f<B.pageDivs.length;f++)B.content.append(B.pageDivs[f]),Je(B.pageDivs[f],null,d+f);var g=ge(Math.max(i,0)).height,p=q.number<e?-q.size.height:q.size.height;t&&g!==W.scrollPos.y?(Me(null,g+p,!1),Me(null,g,!0,a)):a.call()}else if(U.direction===zn.Horizontal){u=ge(d).width,B.edges[0].width(u),Re(d,null),He(),Xe();for(var v=0;v<B.pageDivs.length;v++)B.content.append(B.pageDivs[v]),Je(B.pageDivs[v],null,d+v);var m=ge(Math.max(i,0)).width,b=q.number<e?-q.size.width:q.size.width;t&&m!==W.scrollPos.x?(Me(m+b,null,!1),Me(m,null,!0,a)):a.call()}}}else ze("paused",n)}function Ze(e){var t=N.document.getPageCount();if(0<e&&e<=t){if(q.number!==e||q.numberoutof!==t){if(B.pageLabel.html(e+" / "+t),q.number!==e){q.number=e;for(var n=0;n<B.pageDivs.length;n++){var o=B.pageDivs[n];o._index===e-1?o.addClass(Dn.atala_active_page):o.removeClass(Dn.atala_active_page)}fn({type:"pagenumberchanged",number:q.number})}q.numberoutof!==t&&(q.numberoutof=t)}}else B.pageLabel.html(""),B.viewport.find("."+Dn.atala_active_page).removeClass(Dn.atala_active_page),q.numberoutof=0}function Xe(){for(var e=B.pageDivs.length-1;0<=e;e--)Ge(B.pageDivs[e])}function Ge(e){_n.Explorer&&document.activeElement&&e.has(document.activeElement).length&&B.scroller.focus(),U.allowannotations&&(_n.Firefox||_n.Edge)&&N.annotations.__clearAllSelection(e),U.tiling&&e._img&&0<=e._img._cacheIndex&&(B.loadedImgs[e._img._cacheIndex]._needToInsert=!0),e.detach(),null!=e._img&&(e._img._page=null,e._img.getDomElement().detach(),e._img=null),fn({type:"pagerecycled",index:e._index,page:e}),e.removeAttr(Cn.atala_page_index)}function Ye(e){Ge(e),e._index=-1,e.removeAttr(Cn.atala_page_index),e._img=null,e.remove()}function Je(t,e,n,o){if(t._index===n&&t._img===e&&!o)return!1;if(o&&!t.nullinserted&&n<0)return!1;if(e&&t._index===n&&!e._needToInsert)return!1;t._index=n,t.attr(Cn.atala_page_index,n);var i=L?"Thumbnailer page number "+(n+1):"Viewer page number "+(n+1);(t.attr("role","img").attr("aria-label",i),t._paper)&&xn(t._paper.canvas).attr("aria-hidden","true");if(n>=N.document.getPageCount())return t.hide(),!1;if(t._img&&t._img!==e&&(t._img._page=null,0<t.has(t._img.getDomElement()).length&&t._img.getDomElement().detach(void 0,!0)),t._rubberband&&t._rubberband.reset(),t._img=e,t._img&&((t._img._page=t)._img.attr("alt",i),_n.Firefox&&L&&t._img.attr("aria-hidden","true")),t.css({display:U.tabular||U.direction===zn.Horizontal?"inline-block":"block",position:"relative"}),U.showpagenumber&&(t._num||(t._num=xn('<div class="atala_pg_num"/>'),t._num.addClass(Dn.atala_page_number),t.append(t._num)),t._num.text(t._index+1)),t._img&&t._img._binds&&(t._img._binds.pageresize||(t._img._binds.pageresize=function(e){fn({type:"pageresize",page:e.image._page,image:e.image,index:e.image._page?e.image._page._index:N.document.getPageIndexByImageIndex(e.image._index),width:e.width,height:e.height})},t._img.on({pageresize:t._img._binds.pageresize})),t._img._binds.pagesizechanged||(t._img._binds.pagesizechanged=function(e){fn({type:"pagesizechanged",page:t,image:e.image,index:e.index,width:e.width,height:e.height,dx:e.dx,dy:e.dy})},t._img.on({pagesizechanged:t._img._binds.pagesizechanged}))),t._img){var a=t._img.getDomElement();if(t.append(a),t._img.trigger({type:"inserted",page:t}),!t._img._loaded)if(t.nullinserted)if(!L&&U.tiling&&U.forcepagefit){var r,l=t.width(),s=t.height();U.fitting===kn.Width?(r=(l=Math.ceil(q.size.width*U.zoom))/t.width(),s=Math.ceil(t.height()*r)):U.fitting===kn.Height&&(r=(s=Math.ceil(q.size.height*U.zoom))/t.height(),l=Math.ceil(t.width()*r)),t._img.css({width:l,height:s}),N.document.setPageFitMultiplier(t._index,r)}else t._img.css({width:t.width(),height:t.height()});else Qe(t._img,t._index);W.newpagedivsize||t.css({width:"",height:""}),t.nullinserted=!1}else t.nullinserted=!0,W.newpagedivsize||Qe(t,t._index);return fn({type:"pageshown",page:t,index:t._index}),!0}function Qe(e,t){var n=re(t,null,!1);e.css({width:n.width,height:n.height})}function Ke(){W.prpr++}function $e(e){0!==W.prpr&&(W.prpr--,0!==W.prpr||e||Ve())}function et(){W.itch=!0}function tt(){W.itch=!1}function nt(e){return 0<e?(Pe(B.pageDivs,0,B.pageDivs.length-1),B.pageDivs[B.pageDivs.length-1]):(Pe(B.pageDivs,B.pageDivs.length-1,0),B.pageDivs[0])}
/**
...
/**
   ...
   */
function ot(e,t){var n=xn.Deferred();0<=e.cacheIndex&&B.loadedImgs[e.cacheIndex]?B.loadedImgs[e.cacheIndex].invalidate(t,function(){n.resolve()}):n.resolve();return n.promise()}function it(e,t,n){"function"==typeof t&&(n=t,t=void 0);var o=N.document.getPageDefinition(e);if(o){if(o.cacheIndex<0||!B.loadedImgs[o.cacheIndex]){var i=W.nextImageCacheIndex++;o.cacheIndex=i,N.document.setPageCacheIndex(e,i),B.loadedImgs[i]=K(o.index,o.ref,t,function(e){e&&((B.loadedImgs[i]=e)._cacheIndex=i,N.memory.allocate(e)),"function"==typeof n&&n.call()}),U.allowtext&&N.text&&!L&&N.text.ensurePageTextLoaded(e)}else"function"==typeof n&&n.call();return B.loadedImgs[o.cacheIndex]}}function at(e){var t=rt(e);if(t){var n=B.scroller[0].scrollLeft,o=B.scroller[0].scrollTop;return ke(t[0],B.scroller[0],n,o,n+B.scroller[0].clientWidth,o+B.scroller[0].clientHeight)}return!1}function rt(e){for(var t=null,n=0;n<B.pageDivs.length&&null===t;n++)B.pageDivs[n]._index===e&&(t=B.pageDivs[n]);return t}function lt(r,l,s,c,u){var d=this;c&&"function"==typeof c&&(u=c,c=!1);var e=function(){var e=this;Un(this,d);var t,n=x?B.pageDivs[0]:rt(r);if(n){var o=B.scroller[0].scrollLeft,i=B.scroller[0].scrollTop;if((t=ue(n[0],B.scroller[0])).left+=l.x,t.top+=l.y,!c&&t.left>=o&&t.left<=o+B.scroller[0].clientWidth&&t.top>=i&&t.top<=i+B.scroller[0].clientHeight)return void(u&&u())}else(t=ge(x?0:r)).left=t.width+l.x,t.top=t.height+l.y;var a={x:B.scroller[0].clientWidth/2,y:B.scroller[0].clientHeight/2};st(s,Pn.BottomLeft)?(a.x=B.scroller[0].clientWidth,a.y=B.scroller[0].clientHeight):st(s,Pn.TopLeft)&&(a.x=0,a.y=0),W.scrollTarget.Page=r+1,W.scrollTarget.dx=l.x-a.x,W.scrollTarget.dy=l.y-a.y,Me(t.left-a.x,t.top-a.y,!0,u),setTimeout(function(){Un(this,e),W.scrollTarget.Page=0,W.scrollTarget.dx=0,W.scrollTarget.dy=0}.bind(this),1e4)}.bind(this);x&&r!==un()?Ue(r+1,!1,e):e()}function st(e,t){return e&&t&&e.x===t.x&&e.y===t.y}var ct,ut=null;function dt(){ut&&clearTimeout(ut),ut=setTimeout(function(){fn("documentchanged")},200)}function ht(){B.scroller.stop(),B.scroller.pauseEventPropagation(),Ke(),U.tiling&&et()}function ft(){Se();var e=x?un():N.document.getPageCount()-1;0<B.pageDivs.length&&at(e)&&Re(B.pageDivs[0]._index),He(),B.scroller.resumeEventPropagation(),$e()}function gt(){W.zooming=!0,ht(),fn("zoomstarted")}function pt(e){var t,n,o,i,a,r,l;e=Math.min(e,ae()),e=Math.max(e,ie()),t=e,n=!1,i=ge(q.number,null,null),a=ge(q.number,null,null,t),r=(B.scroller.scrollLeft()-i.width)/U.zoom*t,l=(B.scroller.scrollTop()-i.height)/U.zoom*t,Me(a.width+r,a.height+l,n,H,o),U.zoom=e,Tt(!1),kt(e,!1)}function vt(){W.zooming=!1,ft(),fn({type:"zoomchanged",zoom:U.zoom})}function mt(e,t,n){yt(xt(e,t),n)}function bt(e,t,n,o,i){if(o===kn.None){var a=xt(e,t),r=Ct(kn.Best,n);r.zoom>a?yt(r.zoom,i):yt(a,i)}else{yt(Ct(o,n).zoom,i)}}function xt(e,t){var n=we(),o=n.width/(e+.1*n.width),i=n.height/(t+.1*n.height);return Math.min(o,i)}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function zoom
   */function yt(e,n){var o=this;if(W.zooming)ze("zooming",n);else if(W.zooming=!0,ht(),fn("zoomstarted"),e!==U.zoom){e=Math.min(e,ae()),e=Math.max(e,ie());var t=x?0:q.number,i=ge(t,null,null),a=ge(t,null,null,e),r=(B.scroller.scrollLeft()-i.width)/U.zoom*e,l=(B.scroller.scrollTop()-i.height)/U.zoom*e;U.zoom=e,Tt(!0,function(){var t=this;Un(this,o),kt(e,!0,function(){var e=this;Un(this,t),_t(),Me(a.width+r,a.height+l,!1,H,function(){Un(this,e),B.scrollH&&B.scrollH.scrollLeft(B.scroller.scrollLeft()),B.scrollV&&B.scrollV.scrollTop(B.scroller.scrollTop()),null!=n&&n()}.bind(this))}.bind(this))}.bind(this))}else _t(),"function"==typeof n&&n.call()}function _t(){W.zooming=!1,ft(),fn({type:"zoomchanged",zoom:U.zoom})}function wt(e,t){yt(U.zoom+(e?-1:1)*U.zoom*.3,t)}function zt(){B.edges[0]._z=U.zoom}function kt(e,t,n){if(0<B.edges.length){n="function"==typeof n?(s=[zt,n],function(){for(;s.length;){var e=s.shift();e&&e.apply(this,arguments)}}):zt;var o=U.direction===zn.Vertical,i=B.pageDivs[0]&&B.pageDivs[0]._img?B.pageDivs[0]._index:0;x&&(i=0);var a=ge(i,null,null,e),r=o?a.height:a.width;if(t&&!W.loading){var l=o?{height:r}:{width:r};B.edges[0].animate(l,{duration:H,easing:"easeOutQuad",complete:n,queue:!1})}else o?B.edges[0].height(r):B.edges[0].width(r),"function"==typeof n&&n.call();Pt()}var s}function Pt(u){setTimeout(function(){var e=xn("<canvas/>");u=u||U.zoom;var t=U.direction===zn.Vertical,n=W.newpagedivsize?W.newpagedivsize:{width:q.size.width*u,height:q.size.height*u},o=Math.max(1,U.pagespacing),i=me();e[0].width=(n.width+o)*(t?i:1),e[0].height=n.height*(t?1:i);var a=e[0].getContext("2d");a.lineWidth=U.pageborderwidth,U.backcolor&&(a.fillStyle=U.backcolor);for(var r=0;r<i;++r){var l=t?1+r*n.width:1,s=t?1:1+r*n.height;a.strokeRect(l,s,n.width-2,n.height-2),U.backcolor&&a.fillRect(l+a.lineWidth,s+a.lineWidth,n.width-2*(1+a.lineWidth),n.height-2*(1+a.lineWidth))}var c={backgroundSize:"auto auto",backgroundRepeat:t?"repeat-y":"repeat-x"};B.edges[0].css(c),B.edges[1].css(c)},0)}function Tt(e,t){for(var n=0,o=!0,i=function(){if(--n<=0){if(U.direction===zn.Horizontal){var e=he().width;B.spacer||(B.spacer=X(),B.spacer.css({position:"absolute",top:"-1px",height:"1px"}),B.viewport.append(B.spacer)),B.spacer.width(e)}"function"==typeof t&&t.call(),0===W.prpr&&(_n.Safari||_n.Chrome)&&B.edges[1].hide().show()}},a=0;a<B.pageDivs.length;a++){if(B.pageDivs[a]._img)(B.pageDivs[a]._img.needsZoom()||B.pageDivs[a]._img.needsRotate())&&(o=!1,n++,B.pageDivs[a]._img.needsRotate()?B.pageDivs[a]._img.rotate(i):B.pageDivs[a]._img.needsZoom()&&B.pageDivs[a]._img.zoom(e,i))}o&&i.call()}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function fit
   */function Dt(e,t,n){null!=t?"function"==typeof t&&(n=t,t=q.number):t=q.number;var o=Ct(e,t-1),i=o.zoom,a=kn.Width===o.fit&&zn.Vertical===U.direction,r=kn.Height===o.height;a&&Me(0,null,!1),r&&Me(null,0,!1),yt(i,n)}function Ct(e,t){var n=we(),o=le(t,1,!1);0!==o.width&&0!==o.height||(e=null);var i=U.zoom;switch(e){case kn.None:break;case kn.Best:e=o.width/n.width>o.height/n.height?(i=n.width/o.width,kn.Width):(i=n.height/o.height,kn.Height);break;case kn.Height:i=n.height/o.height;break;case kn.Width:i=n.width/o.width;break;default:i=1,e=kn.None}return{zoom:i,fit:e}}function Mt(e){return U.zoom*N.document.getPageFitMultiplier(e)}function Et(e){return N.document.getPageRotation(e)}function St(e,t){t=t||0;var n=Et(e),o=Mt(e),i=be(e,t),a=yn.matrix();a.scale(o,o,0,0),a.rotate(n+t,0,0);var r,l,s=(r=a,l={x:i.width,y:i.height},{x:r.x(l.x,l.y),y:r.y(l.x,l.y)}),c=Math.min(0,s.x),u=Math.min(0,s.y),d=a.invert(),h=d.x(-c,-u),f=d.y(-c,-u);return a.translate(h,f),a}function It(e){var t=xn.data(e.currentTarget,"_config"),n=xn.data(e.currentTarget,"_annoConfig");!n&&t&&(n={type:t.icon,rotatable:U.showrotatetools}),n&&(N.mouseTool.setTool(wn.None,wn.None),N.annotations.drawAnnotation(n,!1,At,Ft))}function Ft(){N.mouseTool.setTool(wn.Pan,wn.None)}function At(){N.mouseTool.setTool(wn.Pan,wn.None)}
/**
   * Checks whether annotations support is enabled.
   * @private
   */function Ot(){return!1===U.allowannotations&&Z("InitError",'The "allowannotations" property in the WebDocumentViewer config is set to false.'),U.allowannotations}function Vt(){for(var e=0;e<B.pageDivs.length;e++)B.pageDivs[e]._draw.toFront()}function Lt(){for(var e=0;e<B.pageDivs.length;e++)B.pageDivs[e]._draw.reset()}function Ht(e,t,n){if(e){if(W.loading=!0,Xe(),q.size.width=e.pagewidth,q.size.height=e.pageheight,q.count=e.pagecount,q.buffer=U.pagebuffersize,q.dpi=e.dpi,q.vector=!0===e.vector,U.allowannotations=n.allowannotations,U.textAnnotationEditorIgnoredKeyCodes=n.textAnnotationEditorIgnoredKeyCodes,U.multiprocessing=n.multiprocessing,U.allowforms=n.allowforms,U.allowtext=n.allowtext,U.tiling=n.tiling,U.documenturl=n.documenturl,U.annotationsurl=n.annotationsurl,U.formsurl=n.formsurl,N.document.__linkChanges(t),N.annotations&&(N.annotations.clear(),N.annotations.loadAnnotations(e)),N.forms&&(N.forms.clear(),e.forms&&N.forms.loadForms(e)),N.text&&B.search&&B.search.ClearSearch(),n.showbookmarks&&(0<N.document.getBookmarks().length?xn("."+Dn.atala_tool_button_bookmarks).button("enable"):bn(),s={top:0,left:0,expanded:[]}),W.scrollTarget.Page=0,W.scrollTarget.dx=0,W.scrollTarget.dy=0,W.zooming=!1,e.zoom)U.zoom=e.zoom;else{var o=Ct(U.fitting,0);U.zoom=o.zoom}qt(e.pagenumber||0),N.mouseTool.setTool(U.mousetool.type&&!L?U.mousetool.type:wn.Pan,wn.None),Pt(),W.loading=!1,Tt(),Y=t.__getSelectedPagesIndices,fn({type:"activedocumentchanged"})}}function Rt(e,t){t&&tn(!0);for(var n=0;n<e._controllers.document.getPageCount();++n){var o=e._controllers.document.getPageDefinition(n,y);o&&0<=o.cacheIndex&&B.loadedImgs[o.cacheIndex]&&(N.memory.deallocate(B.loadedImgs[o.cacheIndex]),B.loadedImgs[o.cacheIndex].dispose(),B.loadedImgs[o.cacheIndex].remove(),B.loadedImgs[o.cacheIndex]=void 0)}}function jt(e,o){W.loading=!0;var t={atala_docurl:U.documenturl,atala_pagebuffer:U.pagebuffersize,atala_minwidth:U.minwidth,atala_tiling:U.tiling,atala_bookmarks:U.showbookmarks,atalamultiprocessing:U.multiprocessing};L&&(t.atala_thumb=L,t.atala_capt_format=U.thumbcaptionformat),U.tiling&&B.scroller.addClass(Dn.atala_page_loading),null!=e&&("function"==typeof e&&(o=e,e=null),xn.extend(t,e)),$t({type:"docinfo",serverurl:U.serverurl,query:"?ataladocinfo=",method:"GET",data:t,cancel:!1,info:{pagewidth:-1,pageheight:-1,pagecount:-1}},function(e){Bt(e,o)},function(e,t,n){!function(e,t,n,o){if(U.tiling&&B.scroller.removeClass(Dn.atala_page_loading),e.responseText){var i=e.responseText.substr(e.responseText.indexOf("</html>")+7);0<=i.indexOf("\x3c!--")?0<(i=i.replace("\x3c!--","").replace("--\x3e","")).length&&(n="<pre>"+i+"</pre>"):0<e.responseText.indexOf("web.config")&&0<e.responseText.indexOf("customErrors")&&(n+=": web.config customErrors attribute has disabled remote error messages.")}Z("DocumentLoadError",n),"function"==typeof o&&o.call(void 0,n)}(e,0,n,o)})}function Bt(n,o){var e,t;(U.tiling&&B.scroller.removeClass(Dn.atala_page_loading),n&&!1!==n.licensed)?(n.docurl&&(U.documenturl=n.docurl),n.annourl&&(U.annotationsurl=n.annourl),n.formurl&&(U.formurl=n.formurl),q.size.width=n.pagewidth,q.size.height=n.pageheight,q.count=n.pagecount,q.buffer=U.pagebuffersize,q.dpi=n.dpi,q.vector=!0===n.vector,q.caption=n.thumbcaptionformat||(U.showthumbcaption?"{0}":""),de.zero(),N.memory.clearEntries(),N.memory.colorDepth=n.colordepth,N.memory.pageSize={width:n.pagewidth,height:n.pageheight},fn({type:"documentinfochanged",info:{count:q.count,dpi:q.dpi,size:{height:q.size.height,width:q.size.width},vector:q.vector,pagesizes:n.pagesizes,bookmarks:n.bookmarks},customData:n.customData}),N.text&&(N.text.clear(),B.search&&B.search.ClearSearch(),n.text&&N.text.loadText(n)),W.loading&&(!0===h?U.zoom=1:h=!0,Q(),Me(0,0),B.scrollV&&B.scrollV.pageNum(1),Ze(1),Dt(U.fitting,1,function(){if(He(),Re(0,B.pageDivs.length-1),x){for(var e=0;e<B.pageDivs.length&&e<q.count;e++)Je(B.pageDivs[e],null,e);B.content.append(B.pageDivs[0])}else for(var t=0;t<B.pageDivs.length&&t<q.count;t++)B.content.append(B.pageDivs[t]),Je(B.pageDivs[t],null,t);0<B.pageDivs.length&&B.pageDivs[0].addClass(Dn.atala_active_page),n.layers&&n.layers.length?N.annotations.loadAnnotations(n):U.annotationsurl&&N.annotations&&N.annotations.clear(),N.forms&&(N.forms.clear(),n.forms&&N.forms.loadForms(n)),N.mouseTool.setTool(U.mousetool.type&&!L?U.mousetool.type:wn.Pan,wn.None),W.loading=!1,Pt(),"function"==typeof o&&o(n.error,n),n.error&&setTimeout(function(){Z("DocumentLoadError",n.error)},0)})),W.loading=!1):(t=n&&!1===n.licensed?(e="LicenseException",n.error?n.error:"LicenseException: Handler was unable to find a valid license."):(e="DocumentLoadError","HandlerException: Handler did not return any data."),W.loading=!1,"function"==typeof o&&o.call(void 0,t),e&&t&&Z(e,t))}function Nt(){qt()}function qt(e){if(Q(),0<B.pageDivs.length){var t=N.document.getPageCount(),n="number"==typeof e?e:B.pageDivs[0]._index;n=0<=n?Math.min(n,t-B.pageDivs.length):0;for(var o=0;o<B.pageDivs.length&&o<t;o++){var i=n+o;Ge(B.pageDivs[o]),Je(B.pageDivs[o],null,i),x&&0<o||B.content.append(B.pageDivs[o])}}if(Re(0<B.pageDivs.length?B.pageDivs[0]._index:0,null),He(),Gt(),Se(),fe(),x){Ze((0<B.pageDivs.length?B.pageDivs[0]._index:0)+1)}else{var a=ce(B.scroller[0].scrollLeft,B.scroller[0].scrollTop);Ze(a+1),0<=e&&a!==e&&qe(e)}}function Wt(e,t){var n={atala_docurl:U.documenturl,atala_spath:U.savepath};function o(e){!function(e){e.error?Z("DocumentSaveError",e.error):Te("DocumentSave: success="+e.success);fn({type:"documentsaved",success:e.success,customData:e.customData,fileName:e.fileName})}(e),"function"==typeof t&&t.call()}xn.extend(n,e),$t({type:"docsave",serverurl:U.serverurl,query:"?ataladocsave=",method:"POST",data:n,cancel:!1,info:{success:void 0,error:void 0}},o,function(e){var t=[];t.error=e.responseText,o(t)})}function Ut(e,t,n){var o=null;return"string"==typeof e?(o={},W.initialized&&n&&(0<e.length?(n.clear(),o=n.createHandlerRequest(U.serverurl,e,t)):0===e.length&&n.clear()),o.url=e):void 0!==e&&null!=e&&Z("openUrlError","string input expected for url."),o}function Zt(){dn({annotationsloaded:Qt})}function Xt(){dn({formsloaded:Kt})}function Gt(e){if(!(0<B.pageDivs.length&&void 0===B.pageDivs[0]._index))for(var t=0;t<B.pageDivs.length;t++)Jt(B.pageDivs[t],e)}function Yt(e,t){var n=rt(e);n&&Jt(n,t)}function Jt(e,t){(Je(e,it(e._index),e._index)||t)&&(N.annotations&&N.annotations.showLayer(e._index,e),N.forms&&!L&&N.forms.showLayer(e._index,e),N.text&&!L&&U.allowtext&&N.text.showLayer(e._index,e))}function Qt(e){e.error&&(Z("AnnotationsLoadError",e.error),U.annotationsurl=""),N.annotations&&hn({annotationsloaded:Qt})}function Kt(e){e.error&&(Z("FormsLoadError",e.error),U.formsurl=""),N.forms&&hn({formsloaded:Kt})}function $t(o,t,i,n){var a,r,e,l=this,s=(a=o,r=function(e){t(e.request.info)},dn({handlerreturned:e=function e(t){t.request===a&&(hn({handlerreturned:e}),"function"==typeof r&&r.call(this,t))}}),e);if(fn({type:"beforehandlerrequest",request:o}),!o.cancel&&(hn({handlerreturned:s}),o.serverurl&&!xn.isEmptyObject(o.data))){if(!(o.info instanceof xn&&"docpage"===o.type)){if("fileupload"!==o.type)return xn.ajax({type:o.method,url:o.serverurl+o.query+"?",dataType:"json",data:o.data,success:t,error:i,crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0});var c="&"+xn.param(o.data),u=new FormData;u.append("file",o.file,o.file.name);var d=xn.ajax({type:o.method,url:o.serverurl+o.query+"??"+c,dataType:"json",data:u,contentType:!1,processData:!1,success:function(e){Un(this,l),e.success&&(e.success=JSON.parse(e.success)),e.canceled&&(e.canceled=JSON.parse(e.canceled)),t(e,o.file.name)}.bind(this),error:function(e,t,n){Un(this,l),i(t,n,o.file.name)}.bind(this),crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0,xhr:function(){var t=this;Un(this,l);var e=new XMLHttpRequest;return e.upload.addEventListener("progress",function(e){Un(this,t),e.lengthComputable&&(n(o.file.name,e.loaded,e.total)||d.abort())}.bind(this),!1),e}.bind(this)});return d}o.info.attr("src",o.serverurl+o.query+"&"+xn.param(o.data))}}
/**
   ...
   * @function empty
   */
function en(e){W.loading=!0;tn(),Bt({pagewidth:0,pageheight:0,pagecount:-1},function(){Se(),fn({type:"documentunloaded"}),"function"==typeof e&&e.call()})}function tn(e){var t;W.initialized&&(Xe(),Q(0),e||function(){for(var e=0;e<B.loadedImgs.length;e++)B.loadedImgs[e]&&(B.loadedImgs[e].dispose(),B.loadedImgs[e].remove());B.loadedImgs.length=0}(),B.edges[0].width(0).height(0),B.edges[1].width(0).height(0),B.scrollH&&(B.scrollH.scrollSize(0),Ae(B.scrollH)),B.scrollV&&(B.scrollV.scrollSize(0),Ae(B.scrollV)),x&&Ze(1),t={backgroundImage:"",backgroundSize:"",backgroundRepeat:"",backgroundColor:""},B.edges[0].css(t),B.edges[1].css(t))}
/**
...
/**
   ...
   * @returns {boolean}
   */
function nn(){return W.initialized}
/**
...
/**
   ...
   * @function next
   */
function on(e,t){var n=U.direction===zn.Vertical?me():1;null==t&&"function"==typeof e&&(t=e,e=n),isFinite(e)||(e=n),Ee(e,t)}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function previous
   */function an(e,t){var n=U.direction===zn.Vertical?me():1;null==t&&"function"==typeof e&&(t=e,e=n),isFinite(e)||(e=n),Ee(-e,t)}
/**
   * Zooms in one level.
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function openUrl
   */function sn(e,t,n,o){null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null));var i=0,a=!1,r=Ut(t,e,N.annotations),l=Ut(n||e,e,N.forms);U.annotationsurl=r?r.url:U.annotationsurl,U.formsurl=l?l.url:U.formsurl;var s,c,u,d,h=function(e,t){--i<=0&&(Gt(!0),fn({type:"documentloaded",customData:null==t?void 0:t.customData}),"function"==typeof o&&o.call(void 0,e,t))};if("string"==typeof e){if(0===e.length)en(h);else if(U.documenturl=e,W.initialized){tn(),ee(B.scrollH),ee(B.scrollV),i++;var f={};U.allowannotations&&r&&r.data&&(Zt(),xn.extend(f,r.data)),U.allowforms&&l&&l.data&&(Xt(),xn.extend(f,l.data)),a=!0,jt(f,h)}}else!(e||!(0<U.documenturl.length)||!t&&""!==t&&!n&&""!==n)||Z("openUrlError","string input expected for document url.");a||(r&&(i++,u=r,d=h,N.annotations&&(Zt(),N.annotations.makeHandlerRequest(u,d))),l&&(i++,s=l,c=h,N.forms&&(Xt(),N.forms.makeHandlerRequest(s,c))))}
/**
   ...
   * _viewer.save(‘’, ‘tif’)
   */function cn(e,t,n,o){"function"==typeof n&&(o=n,n={}),"function"==typeof t&&(o=t,t=U.savefileformat),"function"==typeof e&&(o=e,e=null),void 0===t&&(t=U.savefileformat);var i=xn.extend(!0,n,{atala_subpath:e||"",atala_sformat:t});N.annotations&&xn.extend(i,{atala_iuname:U.annotations.saveusername,atala_annos:N.annotations.stringifyChanges()}),N.forms&&xn.extend(i,{atala_forms:N.forms.stringifyChanges()}),N.document&&xn.extend(i,{atala_document:N.document.stringifyChanges()}),U.savepreviouslysigneddocument&&xn.extend(i,{atala_savesigned:"true"}),Wt(i,o)}
/**
...
/**
   ...
   */function gn(e){var t="#"+y+"_"+Dn.atala_bookmark_content;!xn(e.target).closest(t).length&&xn(t).is(":visible")&&(mn(),xn(t).remove(),vn())}function pn(){var e="#"+y+"_"+Dn.atala_bookmark_content;xn(e).is(":visible")&&(mn(),xn(e).remove(),vn())}function vn(){document.removeEventListener("click",gn)}function mn(){var e="#"+y+"_"+Dn.atala_bookmark_content;s.top=xn(e).scrollTop(),s.left=xn(e).scrollLeft(),s.expanded=[],xn("ul.atala-bookmark-active").each(function(){s.expanded.push(xn(this).attr("id"))})}function bn(){xn("#"+(y+"_toolbar_Button_Bookmarks")).button("disable")}
/**
   * [Internal] Gets debug info object
   * @returns debug info object if available, otherwise null
   */
return c.__getDebugInfo=function(){var e={version:Vn.join(".")};U.debug&&xn.extend(!0,e,{dom:B,controllers:N,page:q});return e}
/**
...
/**
   ...
   */,c.reloadPage=function(o,e,t,n,i){var a=xn.Deferred(),r=xn.Deferred(),l=xn.Deferred(),s=xn.Deferred();"function"==typeof n&&(i=n,n=void 0),"function"==typeof t&&(i=t,t=!1),"function"==typeof e&&(i=e,e=!1),"function"==typeof i&&a.done(i);var c=N.document.getPageDefinition(o);if(!c)return a.resolve(),a.promise();0<=c.cacheIndex&&B.loadedImgs[c.cacheIndex]?s=ot(c,n):it(o,n,function(){s.resolve()});var u="string"==typeof e?e:c.uri?null:U.annotationsurl;U.allowannotations&&e&&(u||c.uri)?N.annotations.loadAnnotationsUrl(U.serverurl,u,c.uri,c.index,1,o,function(){r.resolve(!0)}):(e&&N.annotations.loadAnnotations({layers:[[]],offset:o}),r.resolve(!!e));var d="string"==typeof t?t:c.uri?null:U.formsurl;return U.allowforms&&t&&(U.formsurl||d)?N.forms.loadFormUrl(U.serverurl,d,c.uri,c.index,1,o,function(){l.resolve(!0)}):l.resolve(),xn.when(s,r,l).done(function(e,t,n){(t||n)&&Yt(o,!0),a.resolve(o)}),a.promise()},c.showPage=qe,c.showPageNumber=We,Hn(),Bn(),Rn(),Nn(),c.annotations=Hn.__exposedApi,c.document=Bn.__exposedApi,c.forms=Rn.__exposedApi,c.text=Nn.__exposedApi,function(){nn()||(W={prpr:0,batchoperation:0,loading:(q={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0,scrollTarget:{Page:0,dx:0,dy:0},hidden:!1,itch:!1,tilingCorrelationId:0});var e={_config:U,_id:y,_dom:B,_document:B.loadedImgs,_pages:B.pageDivs,_state:W,_internalEvents:r,_controllers:N,createDOM:P,createDiv:X,createDialog:M,createDropDownButton:E,createDropDownMenu:S,createMenu:C,drawAnnotation:It,redrawVisiblePages:Gt,adjustVisiblePages:Tt,startDomManipulation:ht,endDomManipulation:ft,redrawPageFromIndex:Yt,makeHandlerRequest:$t,getPageScale:Mt,getPageSize:xe,getSourcePageSize:be,getPageRotation:Et,getViewerTransform:St,isPageInView:at,findPageFromIndex:rt,showPagePoint:lt,disableBookmarkButton:bn,throwError:Z,triggerEvent:fn,zoomToAnno:mt,zoomToAnnoOrBestFit:bt};N.document=new Bn(c,e,y),c.document=N.document.__exposedApi,U.allowannotations?(N.annotations=new Hn(c,e,L),c.annotations=N.annotations.__exposedApi):(c.deselectAll=Ot,c.createAnnotationOnPage=Ot,c.getAnnotationsFromPage=Ot,c.deleteAnnotationOnPageAtIndex=Ot,c.setAnnotationDefaults=Ot,c.setImages=Ot,c.setStamps=Ot),U.allowforms&&!N.forms&&(N.forms=new Rn(c,e),c.forms=N.forms.__exposedApi),U.allowtext&&(N.text=new Nn(c,e,U.mousetool?U.mousetool.text:{}),c.text=N.text.__exposedApi),N.upload=new jn(c,e),!1===W.initialized&&(W.initialized=!0,dn({throwerror:k,pagedivsresized:p,documentchanged:Nt,pagesizechanged:v}),U.parent?(U.parent instanceof xn||(U.parent=xn(U.parent)),U.parent.length||Z("InitError","Parent element not found.")):Z("InitError","No parent element given."),B.toolbar=(t=U.toolbarparent||U.parent,(n=function(e){var t=this,n={id:y+"_toolbar",parent:e,children:[{type:"button",id:"Button_PagePrev",cls:Dn.atala_tool_button_page_prev,icon:"page-prev",tooltip:"Previous Page",text:null,onclick:function(){x?Be():an()}},{type:"pagelabel",id:"Label_PageNumber",cls:Dn.atala_page_label},{type:"button",id:"Button_PageNext",cls:Dn.atala_tool_button_page_next,icon:"page-next",tooltip:"Next Page",text:null,onclick:function(){x?Ne():on()}},{type:"button",id:"Button_ZoomOut",cls:Dn.atala_tool_button_zoom_out,icon:"zoom-out",tooltip:"Zoom Out",text:"",onclick:function(){ln()}},{type:"button",id:"Button_ZoomIn",cls:Dn.atala_tool_button_zoom_in,icon:"zoom-in",tooltip:"Zoom In",text:"",onclick:function(){rn()}},{type:"button",id:"Button_FitNone",cls:Dn.atala_tool_button_fit_none,icon:"zoom-full",tooltip:"Full Size",text:"",onclick:function(){yt(1)}},{type:"button",id:"Button_FitBest",cls:Dn.atala_tool_button_fit_best,icon:"fit-best",tooltip:"Best Fit",text:"",onclick:function(){Dt(kn.Best)}},{type:"button",id:"Button_FitWidth",cls:Dn.atala_tool_button_fit_width,icon:"fit-width",tooltip:"Fit To Width",text:"",onclick:function(){Dt(kn.Width)}}]};return U.showselecttools&&n.children.splice(5,0,{type:"button",id:"Button_ZoomArea",cls:Dn.atala_tool_button_zoom_area,icon:"zoom-area",tooltip:"Zoom Area",text:"",onclick:V}),U.allowtext&&(n.children.splice(3,0,{type:"button",id:"Button_Text",cls:Dn.atala_tool_button_text_tool,icon:"text-tool",tooltip:"Text Selection",text:"",onclick:function(){N.mouseTool.setTool(wn.Text)}}),n.children.splice(3,0,{type:"button",id:"Button_Pan",cls:Dn.atala_tool_button_pan_tool,icon:"pan-tool",tooltip:"Pan",text:"",onclick:function(){N.mouseTool.setTool(wn.Pan)}})),U.showrotatetools&&(n.children.push({type:"button",id:"Button_RotateLeft",cls:Dn.atala_tool_button_rotate_left,icon:"rotate-left",tooltip:"Rotate Left",text:"",onclick:G(270)}),n.children.push({type:"button",id:"Button_RotateRight",cls:Dn.atala_tool_button_rotate_right,icon:"rotate-right",tooltip:"Rotate Right",text:"",onclick:G(90)})),0<U.savepath.length&&n.children.unshift({type:"button",id:"Button_Save",cls:Dn.atala_tool_button_save,icon:"save",tooltip:"Save Changes",text:null,onclick:function(){cn()}}),!1!==U.upload.enabled&&n.children.unshift({type:"button",id:"Button_Upload",cls:Dn.atala_tool_button_upload,icon:"upload",tooltip:"Upload document",text:null,onclick:function(){!function(){var t=this;L||N.upload.uploadWithUi(function(e){Un(this,t),e?(B.toolbar.controlgroup("enable"),U.allowannotations&&B.toolbar.annoToolbar.controlgroup("enable"),B.toolbar.find(".atala_page_label, .atala_search_container").removeClass("ui-state-disabled")):(B.toolbar.controlgroup("disable"),B.toolbar.annoToolbar&&B.toolbar.annoToolbar.controlgroup("disable"),B.toolbar.find(".atala_page_label, .atala_search_container").addClass("ui-state-disabled"))}.bind(this))}()}}),!1!==U.showbookmarks&&n.children.unshift({type:"button",id:"Button_Bookmarks",cls:Dn.atala_tool_button_bookmarks,icon:"bookmarks",tooltip:"Show bookmarks",text:null,onclick:function(){!function(){var t=this;if(!L){var e=y+"_"+Dn.atala_bookmark_content,n="#"+e;if(0<xn(n).length)return mn(),xn(n).remove(),vn();var o,i=N.document.getBookmarks();if(0<i.length){var a=.85*B.main.height();ct=0,U.allowtext&&U.mousetool.text.allowsearch||xn("<div/>").css("clear","both").appendTo(B.toolbar);var r=xn("<div/>").addClass("ui-widget").addClass(Dn.atala_bookmark_content).css("max-height",a+"px").attr("id",e).appendTo(B.toolbar),l=xn("<ul></ul>");xn('<span id = "atala_bkm_header" class ="'+Dn.atala_bookmark_header+'">Bookmarks</span>').appendTo(l),_n.Chrome&&l.attr("aria-labelledby","atala_bkm_header"),l.appendTo(r),i.forEach(function(e){return Un(this,t),function t(e,n){var o=this;if(0<e.Children.length){var i=xn('<li><span class="atala-bookmark-caret"></span></li>'),a=xn("<a>"+e.Text+"</a>");if(_n.Chrome){var r=h();a.attr("id",r),i.attr("aria-labelledby",r)}a.click(function(){N.document.scrollToBookmark(e)}),a.appendTo(i);var l=xn('<ul class = "atala-bookmark-nested"></ul>').attr("id","expandable_bookmark_"+e.id);l.appendTo(i),i.find("span").click(function(){this.parentElement.querySelector(".atala-bookmark-nested").classList.toggle("atala-bookmark-active"),this.classList.toggle("atala-bookmark-caret-down")}),i.appendTo(n);var s=N.document.getChildBookmarks(e);s.forEach(function(e){return Un(this,o),t(e,l)}.bind(this))}else{var c=xn("<li></li>"),u=xn("<a>"+e.Text+"</a>");if(_n.Chrome){var d=h();u.attr("id",d),c.attr("aria-labelledby",d)}u.click(function(){N.document.scrollToBookmark(e)}),u.appendTo(c),c.appendTo(n)}function h(){return"bkm_"+ ++ct}}(e,l)}.bind(this)),r.contextmenu(function(){return!1}),r.show(),o="#"+Dn.atala_bookmark_content+y,s.expanded.forEach(function(e){var t=xn("#"+e);t.toggleClass("atala-bookmark-active"),t.parent().children(".atala-bookmark-caret").toggleClass("atala-bookmark-caret-down")}),xn(o).scrollTop(s.top),xn(o).scrollLeft(s.left),setTimeout(function(){document.addEventListener("click",gn)},50),xn(document).one("viewportclick",pn)}}}()}}),U.toolbarbuttons&&U.toolbarbuttons.reverse().forEach(function(e){Un(this,t),n.children.unshift({type:"button",id:e.id,cls:e.class,tooltip:e.tooltip,onclick:e.onclick,text:null,icon:e.icon,custom:!0})}.bind(this)),D(n)}(t)).controlgroup(),U.allowannotations&&(n.annoToolbar=D({id:y+"_toolbar",parent:t,children:[{type:"button",id:"Button_Ellipse",cls:Dn.atala_tool_button_ellipse_anno,icon:"ellipse",tooltip:"Draw Ellipse",text:"",onclick:It},{type:"button",id:"Button_Highlight",cls:Dn.atala_tool_button_highlight_anno,icon:"highlight",tooltip:"Draw Highlight",text:"",onclick:It},{type:"button",id:"Button_Line",cls:Dn.atala_tool_button_line_anno,icon:"line",tooltip:"Draw Line",text:"",onclick:It},{type:"button",id:"Button_Lines",cls:Dn.atala_tool_button_lines_anno,icon:"lines",tooltip:"Draw Poly Lines",text:"",onclick:It},{type:"button",id:"Button_Freehand",cls:Dn.atala_tool_button_freehand_anno,icon:"freehand",tooltip:"Draw Freehand",text:"",onclick:It},{type:"button",id:"Button_Polygon",cls:Dn.atala_tool_button_polygon_anno,icon:"polygon",tooltip:"Draw Polygon",text:"",onclick:It},{type:"button",id:"Button_Rectangle",cls:Dn.atala_tool_button_rect_anno,icon:"rectangle",tooltip:"Draw Rectangle",text:"",onclick:It},{type:"button",id:"Button_Text_Anno",cls:Dn.atala_tool_button_text_anno,icon:"text",tooltip:"Draw Text",text:"",onclick:It}]}),n.annoToolbar.addClass(Dn.atala_annotation_toolbar),n.annoToolbar.controlgroup()),U.showstatus&&(B.status=xn('<div id="'+y+'_status"></div>'),B.status.addClass(Dn.atala_statusbar),B.status.css("display","inline"),n.append("Status:"),n.append(B.status)),U.allowtext&&U.mousetool.text.allowsearch&&(B.search=new O({parent:n})),n),B.toolbar.addClass(Dn.atala_toolbar),B.main=X(U.parent),B.main.addClass(Dn.atala_main_container),B.scroller=X(B.main),B.scroller.addClass(Dn.atala_scroller),B.main.on({selectstart:w}),B.toolbar.attr("id",y+"_toolbar"),B.main.attr("id",y+"_main"),B.scroller.attr("id",y+"_scroller"),B.main.css({height:"100%",width:"100%",position:"relative"}),B.scroller.css({height:"100%",width:"100%",position:"relative"}),B.viewport=X(B.scroller,y+"_vp"),B.viewport.css({overflow:"hidden",fontSize:0,"touch-action":"none"}),B.viewport.addClass(Dn.atala_viewport),B.viewport.attr("tabindex",-1),B.edges[0]=J(B.viewport,y+"_e0"),B.edges[0].addClass(Dn.atala_dom_edge_first),B.content=X(B.viewport,y+"_ct"),B.content.addClass(Dn.atala_content),B.content.attr("tabindex",-1),B.content.attr("role","figure"),_n.Explorer&&B.content.attr("aria-label",L?"Thumbnailer":"Viewer"),B.content.css({"-ms-touch-action":"none",fontSize:0,overflow:"hidden"}),U.direction===zn.Horizontal&&B.content.css({display:"inline-block"}),B.edges[1]=J(B.viewport,y+"_e1"),B.edges[1].addClass(Dn.atala_dom_edge_last),_n.Features.Compatibility&&Z("InitError","Compatibility Mode is not supported."),!1===U.upload.enabled||L||(B.uploadCtrl=N.upload.getUploadControl()),_n.Mobile.Any()?B.scroller.css({overflow:"hidden"}):U.showscrollbars?(x?B.scroller.css({overflow:"scroll"}):B.scroller.css({overflow:"auto"}),B.scrollH=$(B.main,zn.Horizontal),B.scrollH.attr("id",y+"_sH"),B.scrollH.addClass(Dn.atala_scroll_horizontal),B.scrollH.attr("role","scrollbar"),B.scrollH.attr("aria-controls",y+"_scroller"),B.scrollH.attr("aria-orientation","horizontal"),B.scrollH.attr("aria-valuemin","0"),B.scrollH.attr("aria-valuemax","1"),B.scrollH.attr("aria-valuenow","0"),B.scrollV=$(B.main,zn.Vertical),B.scrollV.attr("id",y+"_sV"),B.scrollV.addClass(Dn.atala_scroll_vertical),B.scrollV.attr("role","scrollbar"),B.scrollV.attr("aria-controls",y+"_scroller"),B.scrollV.attr("aria-orientation","vertical"),B.scrollV.attr("aria-valuemin","0"),B.scrollV.attr("aria-valuemax","1"),B.scrollV.attr("aria-valuenow","0")):B.scroller.css({overflow:"hidden"}),N.mouseTool=new qn(c,{_internalEvents:r,_controllers:N,zoomStart:gt,zoom:pt,zoomEnd:vt,getActivePage:je,raiseDrawLayer:Vt,resetDrawLayer:Lt,getViewerTransform:St},B.viewport,B.scroller,xn.extend({allowflick:U.allowflick},U.mousetool)),N.memory=new On({highWaterMark:U.memorythreshold}),N.memory.bind({exceededhighwatermark:g}),N.annotations&&N.annotations.setViewPort(B.viewport),fn("initialized"),U.direction===zn.Horizontal&&B.viewport.css({"white-space":"nowrap"}),B.viewport.css({display:"table-cell"}),te(B.scroller),B.scrollH&&B.edges[1].height(B.scrollH.scrollbarHeight()),N.mouseTool.setTool(wn.Pan,wn.None),(U.documenturl||U.annotationsurl||U.formurl)&&sn(U.documenturl,U.annotationsurl,U.formurl,o),xn(b));var t,n}(),c};n(125);function ot(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}
/**
...
/**
     ...
     */
selecteditemsorder:$e.ItemIndexOrder,
/**
    * @property {Atalasoft.Controls.WebDocumentViewer} [viewer=null] - Defines the reference to the WebDocumentViewer object.
    */
viewer:null},t={type:"Atalasoft.Controls.WebDocumentThumbnailer",debug:!0,showpageborder:!0,forcepagefit:!0,toolbarparent:xn("<div/>")},i={
/**
...
/**
   ...
   * @returns {number[]}
   */
function V(){var n=this,e=g.slice(0);return k.selecteditemsorder===$e.ItemIndexOrder&&e.sort(function(e,t){return ot(this,n),e-t}.bind(this)),e}function L(e){var t=1,n=function(){--t<=0&&(D()&&y&&f&&C(f,h.getDocumentInfo(),!0),"function"==typeof e&&e.call())};D()&&(y?y.closeDocument(P(),u):f.isReady()&&(t++,f.empty(n))),H(n)}h.getSelectedPageIndex=
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=W,h.deselectThumb=U,h.isActive=D,h.activate=function(){C(f,h.getDocumentInfo())};var H=function(){};function R(){D()&&(y?y.closeDocument(P(),u):f.empty(),M()),j(),v=f=null}var j=function(){};function B(e,t,n,o){w.base&&xn.each(w.base.dom.pageDivs,function(e,t){t.off(c),t.thumbInitialized=!1}),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(y.closeDocument(P(),u),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.x=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Fe(e,t,o)})}var N=function(){};function q(e){if(w.base){0===g.length&&g.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<g.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),o.attr("aria-label").endsWith(" Selected")||o.attr("aria-label",o.attr("aria-label")+" Selected"),null!==n&&-1<g.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection"),o.attr("aria-label",o.attr("aria-label").replace(" Selected",""))),Q(o,i)}}}
/** 
   ...
   */function W(e,t,n){var o=this;if(v._controllers.upload&&v._controllers.upload.abort(),!(null===(e=et(e))||e<0||e>=h.getDocumentInfo().count||void 0!==t&&"boolean"!=typeof t&&null!==t||void 0!==n&&"function"!=typeof n&&null!==n)){if(t=!!t&&k.selectionmode!==Ke.SingleSelect){if(-1<g.indexOf(e))return;g.push(e)}else V().forEach(function(e){ot(this,o),h.trigger({type:"thumbdeselected",index:e})}.bind(this)),g.length=0,g.push(e);Z(),h.trigger({type:"thumbselected",index:e}),"function"==typeof n&&n()}}
/** 
   ...
   */function U(e,t){if(null!==(e=et(e))&&(void 0===t||"function"==typeof t||null===t)){var n=g.indexOf(e);-1!==n&&1!==g.length&&(g.splice(n,1),Z(),h.trigger({type:"thumbdeselected",index:e}),"function"==typeof t&&t())}}function Z(){var e=V();if(y?(w.viewer.pagenumber=e[0],C(f,h.getDocumentInfo())):q(!0),!(1<g.length)&&f){var t=f.getCurrentPageIndex(),n=e[0];0<=t&&n!==t&&(w.scrolling=!0,f.showPage(n,ye))}}
/**
