...
/**
   ...
   */
function(){if(gn.Explorer){var e=parseInt(gn.Version,10);10<=e&&e<12&&d.node&&d.node.parentNode&&d.node.parentNode.insertBefore(d.node,d.node)}}()}}a.commitTransform=function(){var e,t,n;hn.extend(c,(e=p,t=r.getZoom(h._pageindex),{x:(n=e.split()).dx/t,y:n.dy/t,width:n.scalex/t,height:n.scaley/t})),d.transform(M()),E(),L=null},a.transformUI=function(e,t,n,o){p=fn.matrix(n,0,0,o,e,t),L||(L=function(e,t){var n;if(e.points&&1<e.points.length){var o=h.getBox();(n=fn.matrix(1,0,0,1,0,0)).scale(1/o.width,1/o.height,0,0),n.translate(-o.x,-o.y)}else(n=fn.matrix(t,0,0,t,0,0)).translate(e.x,e.y),n.scale(e.width,e.height,0,0);return n}(c,1)),p.add(L.a,L.b,L.c,L.d,L.e,L.f),d.transform(p.toTransformString()),s&&s.repaint()};var L=null;function H(e,t,n){return t>=e.x&&t<=e.x+e.width&&n>=e.y&&n<=e.y+e.height}},we=function(e,t){var o=t,i=this,a=new R(i),r=null,l=null,s=null,n=null,u=null,c=null,d=null,h=null,f=e.multiview?e:{
/**
...
pagebuffersize:-1,
/**
     * @property {number} [pagebuffersize] - The maximum number of pages to keep in memory while scrolling. Should be greater then pagebuffersize value. It can helps to avoid loading too many pages if automatically calculated value is big. It is not recommended to set small values (less then viewer can fit).
     * */
...
/**
   ...
   */
function $e(e,t){var n=hn.Deferred();0<=e.cacheIndex&&N.loadedImgs[e.cacheIndex]?N.loadedImgs[e.cacheIndex].invalidate(t,function(){n.resolve()}):n.resolve();return n.promise()}function et(e,t,n){"function"==typeof t&&(n=t,t=void 0);var o=q.document.getPageDefinition(e);if(o){if(o.cacheIndex<0||!N.loadedImgs[o.cacheIndex]){var i=W.nextImageCacheIndex++;o.cacheIndex=i,q.document.setPageCacheIndex(e,i),N.loadedImgs[i]=Q(o.index,o.ref,t,function(e){e&&((N.loadedImgs[i]=e)._cacheIndex=i,q.memory.allocate(e)),"function"==typeof n&&n.call()}),Z.allowtext&&q.text&&!j&&q.text.ensurePageTextLoaded(e)}else"function"==typeof n&&n.call();return N.loadedImgs[o.cacheIndex]}}function tt(e){var t=nt(e);if(t){var n=N.scroller[0].scrollLeft,o=N.scroller[0].scrollTop;return _e(t[0],N.scroller[0],n,o,n+N.scroller[0].clientWidth,o+N.scroller[0].clientHeight)}return!1}function nt(e){for(var t=null,n=0;n<N.pageDivs.length&&null===t;n++)N.pageDivs[n]._index===e&&(t=N.pageDivs[n]);return t}function ot(r,l,s,u,c){var d=this;u&&"function"==typeof u&&(c=u,u=!1);var e=function(){var e=this;Hn(this,d);var t,n=y?N.pageDivs[0]:nt(r);if(n){var o=N.scroller[0].scrollLeft,i=N.scroller[0].scrollTop;if((t=ue(n[0],N.scroller[0])).left+=l.x,t.top+=l.y,!u&&t.left>=o&&t.left<=o+N.scroller[0].clientWidth&&t.top>=i&&t.top<=i+N.scroller[0].clientHeight)return void(c&&c())}else(t=he(y?0:r)).left=t.width+l.x,t.top=t.height+l.y;var a={x:N.scroller[0].clientWidth/2,y:N.scroller[0].clientHeight/2};it(s,bn.BottomLeft)?(a.x=N.scroller[0].clientWidth,a.y=N.scroller[0].clientHeight):it(s,bn.TopLeft)&&(a.x=0,a.y=0),W.scrollTarget.Page=r+1,W.scrollTarget.dx=l.x-a.x,W.scrollTarget.dy=l.y-a.y,Te(t.left-a.x,t.top-a.y,!0,c),setTimeout(function(){Hn(this,e),W.scrollTarget.Page=0,W.scrollTarget.dx=0,W.scrollTarget.dy=0}.bind(this),1e4)}.bind(this);y&&r!==nn()?Ne(r+1,!1,e):e()}function it(e,t){return e&&t&&e.x===t.x&&e.y===t.y}var at,rt=null;function lt(){rt&&clearTimeout(rt),rt=setTimeout(function(){rn("documentchanged")},200)}function st(){N.scroller.stop(),N.scroller.pauseEventPropagation(),Ye(),Z.tiling&&Qe()}function ut(){Ce();var e=y?nn():q.document.getPageCount()-1;0<N.pageDivs.length&&tt(e)&&Ve(N.pageDivs[0]._index),Ie(),N.scroller.resumeEventPropagation(),Je()}function ct(){W.zooming=!0,st(),rn("zoomstarted")}function dt(e){var t,n,o,i,a,r,l;e=Math.min(e,ie()),e=Math.max(e,oe()),t=e,n=!1,i=he(U.number,null,null),a=he(U.number,null,null,t),r=(N.scroller.scrollLeft()-i.width)/Z.zoom*t,l=(N.scroller.scrollTop()-i.height)/Z.zoom*t,Te(a.width+r,a.height+l,n,T,o),Z.zoom=e,yt(!1),vt(e,!1)}function ht(){W.zooming=!1,ut(),rn({type:"zoomchanged",zoom:Z.zoom})}
/**
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function openUrl
   */function en(e,t,n,o){null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null));var i=0,a=!1,r=Ht(t,e,q.annotations),l=Ht(n||e,e,q.forms);Z.annotationsurl=r?r.url:Z.annotationsurl,Z.formsurl=l?l.url:Z.formsurl;var s,u,c,d,h=function(e,t){--i<=0&&(Rt(!0),rn({type:"documentloaded",customData:null==t?void 0:t.customData}),"function"==typeof o&&o.call(void 0,e,t))};if("string"==typeof e){if(0===e.length)Xt(h);else if(Z.documenturl=e,W.initialized){Gt(),$(N.scrollH),$(N.scrollV),i++;var f={};Z.allowannotations&&r&&r.data&&(jt(),hn.extend(f,r.data)),Z.allowforms&&l&&l.data&&(Bt(),hn.extend(f,l.data)),a=!0,At(f,h)}}else!(e||!(0<Z.documenturl.length)||!t&&""!==t&&!n&&""!==n)||X("openUrlError","string input expected for document url.");a||(r&&(i++,c=r,d=h,q.annotations&&(jt(),q.annotations.makeHandlerRequest(c,d))),l&&(i++,s=l,u=h,q.forms&&(Bt(),q.forms.makeHandlerRequest(s,u))))}
/**
...
/**
   ...
   * @function bind
   */
function on(e,t){return ke(arguments,!0),a.on.apply(a,arguments),u}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function unbind
   */function an(e,t){return ke(arguments,!1),a.off.apply(a,arguments),u}
/**
   * Triggers the event.
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function trigger
   */function rn(e,t){return a.trigger.apply(a,arguments),u}
/**
   ...
   */function ln(e){var t="#"+x+"_"+xn.atala_bookmark_content;!hn(e.target).closest(t).length&&hn(t).is(":visible")&&(cn(),hn(t).remove(),un())}function sn(){var e="#"+x+"_"+xn.atala_bookmark_content;hn(e).is(":visible")&&(cn(),hn(e).remove(),un())}function un(){document.removeEventListener("click",ln)}function cn(){var e="#"+x+"_"+xn.atala_bookmark_content;s.top=hn(e).scrollTop(),s.left=hn(e).scrollLeft(),s.expanded=[],hn("ul.atala-bookmark-active").each(function(){s.expanded.push(hn(this).attr("id"))})}function dn(){hn("#"+(x+"_toolbar_Button_Bookmarks")).button("disable")}
/**
   * [Internal] Gets debug info object
   * @returns debug info object if available, otherwise null
   */
return u.__getDebugInfo=function(){var e={version:En.join(".")};Z.debug&&hn.extend(!0,e,{dom:N,controllers:q,page:U});return e}
/**
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function scrollBy
   */,u.scrollBy=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);i=e,a=t,r=n,l=null,s=o,Te(N.scroller.scrollLeft()+i,N.scroller.scrollTop()+a,r,l,s);var i,a,r,l,s},u.next=y?je:Jt,u.previous=y?He:Qt,u.zoom=ft,u.zoomIn=Kt,u.zoomOut=$t,u.openUrl=u.OpenUrl=en,u.save=tn,u.uploadFiles=
/**
...
/**
   ...
   */,u.filterFilesForUpload=function(e,t,n){if(j)return;return q.upload.filterFilesPublic(e,t,n)},u.getCurrentPageIndex=nn,u.bind=on,u.unbind=an,u.trigger=rn,u.getDocumentInfo=function(){return{count:q.document.getPageCount(),dpi:U.dpi,size:{height:U.size.height,width:U.size.width},vector:U.vector}},u.setMouseTool=function(e){for(var t in pn)if(pn.hasOwnProperty(t)&&pn[t]===e){q.mouseTool.setTool(e);break}},u.isPageLoaded=function(e){var t=q.document.getPageDefinition(e);return 0<=t.cacheIndex&&N.loadedImgs[t.cacheIndex]&&N.loadedImgs[t.cacheIndex]._loaded}
/**
...
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=U,h.deselectThumb=W,h.isActive=D,h.activate=function(){C(f,h.getDocumentInfo())};var H=function(){};function j(){D()&&(x?x.closeDocument(P(),c):f.empty(),E()),B(),m=f=null}var B=function(){};function R(e,t,n,o){w.base&&hn.each(w.base.dom.pageDivs,function(e,t){t.off(u),t.thumbInitialized=!1}),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(x.closeDocument(P(),c),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.x=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Me(e,t,o)})}var N=function(){};function q(e){if(w.base){0===g.length&&g.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<g.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),o.attr("aria-label").endsWith(" Selected")||o.attr("aria-label",o.attr("aria-label")+" Selected"),null!==n&&-1<g.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection"),o.attr("aria-label",o.attr("aria-label").replace(" Selected",""))),Q(o,i)}}}
/** 
