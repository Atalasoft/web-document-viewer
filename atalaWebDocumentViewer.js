...
/**
   ...
   */
function(){if(nn.Explorer){var e=parseInt(nn.Version,10);10<=e&&e<12&&d.node&&d.node.parentNode&&d.node.parentNode.insertBefore(d.node,d.node)}}()}}a.commitTransform=function(){var e,t,n;en.extend(u,(e=p,t=r.getZoom(h._pageindex),{x:(n=e.split()).dx/t,y:n.dy/t,width:n.scalex/t,height:n.scaley/t})),d.transform(E()),M(),H=null},a.transformUI=function(e,t,n,o){p=tn.matrix(n,0,0,o,e,t),H||(H=function(e,t){var n;if(e.points&&1<e.points.length){var o=h.getBox();(n=tn.matrix(1,0,0,1,0,0)).scale(1/o.width,1/o.height,0,0),n.translate(-o.x,-o.y)}else(n=tn.matrix(t,0,0,t,0,0)).translate(e.x,e.y),n.scale(e.width,e.height,0,0);return n}(u,1)),p.add(H.a,H.b,H.c,H.d,H.e,H.f),d.transform(p.toTransformString()),s&&s.repaint()};var H=null;function L(e,t,n){return t>=e.x&&t<=e.x+e.width&&n>=e.y&&n<=e.y+e.height}},we=function(e,t){var o=t,i=this,a=new j(i),r=null,l=null,s=null,n=null,c=null,u=null,d=null,h=null,g=e.multiview?e:{
/**
...
/**
   ...
   */
function(){return l(o)},n.getSelected=function(){return l(c)},n.selectAll=function(){for(var e=0;e<o.length;e++)s(e)},n.selectPage=s};function L(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var xn=function(){function e(){}return e.SetLocalizationStrings=function(e){this._strings=e},e.LocalizationAvailable=function(){return!(void 0===this._strings||void 0===this._strings.annotations)},e.GetAnnotationLocalizedString=function(e){return void 0===this._strings.annotations||void 0===this._strings.annotations[e]?(void 0===this._englishStrings.annotations[e]&&console.error("Missed english string for %s",e),this._englishStrings.annotations[e]):this._strings.annotations[e]},e}();L(xn,"_strings",{}),L(xn,"_englishStrings",gn);var Pe=function(t){var e=this,d=en("<div />"),h=en("<div />"),g=null,o=null,n={style:["None:none","Arrow:open","Filled Arrow:block","Filled Ellipse:oval","Filled Diamond:diamond"],width:["medium","wide","narrow"],height:["medium","long","short"]},i={fill:{color:!0,opacity:!0},rotation:!0,outline:{color:!0,opacity:!0,width:!0,startcap:n,endcap:n},text:{font:{bold:!0,italic:!0,color:!0,family:!0,size:!0}}};function a(){d.dialog("close")}function r(){l(),a()}function l(){g.set(o,!0),g.updateView(),g.repaint(),h.empty(),f(g.get(),"",i),v()}function s(){g&&function(){var e={};for(var t in i)if(i.hasOwnProperty(t)){var n={};n[t]=g.get(t),en.extend(!0,e,n)}return JSON.stringify(e)!==JSON.stringify(o)}()&&g.notifyChanges(o),a()}function f(o,e,t){function n(e){var t=this.getAttribute("dataField");if(this.value&&"boolean"!=typeof this.value)if("number"==typeof o[t]){var n=parseFloat(this.value);isNaN(n)||"rotation"!==t||n===o[t]?"opacity"===t&&0<=n&&n<=1||"opacity"!==t&&0<=this.value?o[t]=n:this.value=o[t]:(g.set({rotation:n}),g.repaint())}else o[t]=this.value;else e&&"boolean"==typeof this.value?o[t]=0<=e.target.id.indexOf("true"):this.value=o[t];g.updateView(),g.repaint(),v()}for(var i in o)if(o.hasOwnProperty(i))if("object"==typeof o[i]){var a="text"!==i?m(i):"";t[i]&&("text"!==i||"text"===i&&"text"===g.get("type"))&&f(o[i],e+a,t[i])}else if("type"===i){var r=xn.GetAnnotationLocalizedString(o[i].replace("fillrect","rectangle")+"DialogTitle");d.dialog("option","title",r)}else if(t[i]){var l=en("<div/>"),s=p(i,o[i],n,t[i]);s.attr("dataField",i),s.title="",l.addClass("ui-helper-clearfix atala-ui-dialog-clearfix"),l.css({overflow:"hidden"}),s.appendTo(l);var c=xn.GetAnnotationLocalizedString("label"+(e||e)+m(i));l.append((u=c,en("<span/>").text(u))),l.appendTo(h)}var u}function p(a,e,t,n){var o=typeof e,r=null;if(en.isArray(n))r=en("<select/>").attr({}),en.each(n,function(e,t){var n=t,o=t,i=t.split(":");1<i.length&&(o=i[0],n=i[1]),o=xn.GetAnnotationLocalizedString("value"+m(a)+m(n)),r.append(en("<option/>",{value:n,text:o}))}),r.change(t),r.val(e);else if("string"===o||"number"===o){r=en("<input/>").attr({type:"text"});var i=e;"color"===a&&(i=function(e){if(!xn.LocalizationAvailable())return e;var t=document.createElement("canvas");t.height=1,t.width=1;var n=t.getContext("2d");n.fillStyle=e,n.fillRect(0,0,1,1);var o=n.getImageData(0,0,1,1).data;return"#"+[0,1,2].map(function(e){return("0"+o[e].toString(16)).slice(-2)}).join("")}(e)),r.val(i),r.change(t),r.focus(function(){this.select(),this._focused=!0}),r.mouseup(function(e){this._focused&&(e.preventDefault(),this._focused=!1)})}else if("boolean"===o){var l="bool"+a;c(r=en("<form/>").attr({id:l,datafield:a}),l+!0,l,xn.GetAnnotationLocalizedString("radioButtonTrue"),e),c(r,l+!1,l,xn.GetAnnotationLocalizedString("radioButtonFalse"),!e),r.controlgroup(),r.change(t),r[0].value=e,r.find(".ui-state-hover").each(function(e,t){en(t).removeClass("ui-state-hover")})}else r=en("<div>"+e+"</div>");return r.css({float:"right"}),r}function c(e,t,n,o,i){e.append(en("<input/>").attr({type:"radio",id:t,name:n,checked:i})),e.append(en("<label/>").attr({for:t}).text(o))}function m(e){return e.charAt(0).toUpperCase()+e.slice(1)}function v(){var e=g.getObject();e&&e.paper&&e.paper._page&&e.paper._page._grips.repaint()}return e.show=function(e){for(var t in g=e,h.empty(),o={},i)if(i.hasOwnProperty(t)){var n={};n[t]=g.get(t),en.extend(!0,o,n)}f(g.get(),"",i),d.dialog("open")},e.hide=a,e.isVisible=function(){return d.dialog("isOpen")},e.cancel=r,e.reset=l,e.okhide=s,function(){h.appendTo(d);var e={};e[xn.GetAnnotationLocalizedString("dialogButtonOk")]=s,e[xn.GetAnnotationLocalizedString("dialogButtonReset")]=l,e[xn.GetAnnotationLocalizedString("dialogButtonCancel")]=r,d.dialog({appendTo:t,minWidth:320,classes:{"ui-dialog":"atala-ui-dialog"},resizable:!0,autoOpen:!1,buttons:e,closeText:a,open:function(){!function(e){for(var t=0,n=0;n<e.length;n++){var o=en(e[n]).height();t<o&&(t=o)}for(var i=0;i<e.length;i++)en(e[i]).height(t)}(d.parent().find(".ui-dialog-buttonset button")),d.dialog({width:Math.max(320,function(){var e='<span style="display:none">'+d.parent().find(".ui-dialog-title").text()+"AAAAAAAAA</span>";en("body").append(e);var t=en("body").find("span:last").width();return en("body").find("span:last").remove(),t+25}(),function(){for(var e=d.parent().find(".ui-dialog-buttonset button"),t=0,n=0;n<e.length;n++)t+=en(e[n]).outerWidth(!0);var o=1.5*parseInt(en(e[0]).css("font-size"));return t+o}()),height:"auto"})}})}(),e},De=function(l,e){var u,d=8,s=25,a=-22.5,c={e:0,ne:315,n:270,nw:225,w:180,sw:135,s:90,se:45},r={},h={},g=e,f=l._paper.set(),p=l._paper.set(),m=[],v=null,_={},b=null,y={x:0,y:0,width:1,height:1,x2:1,y2:1},o=[],x={},t={dragstart:function(){},dragmove:function(){f.hide()},moved:function(){P(),f.show();for(var e=0;e<m.length;++e){var t=m[e].get();t.hasOwnProperty("rotatable")&&!t.rotatable&&v.hide()}}};function w(e,t){return e.attr({fill:"#FFFFE1",cursor:(t||"ne")+"-resize"}),e.grip=!0,e.rect=e.getBBox(),e.hide(),e.center=function(e,t,n,o){var i=d/(n=n||1),a=d/n,r=i/2,l=Math.round(i/2)+.5,s=Math.round(a/2)+.5;nn.Explorer&&(s-=.5);var c=Math.round(e)-l,u=Math.round(t)-s;this.ellipse?(c+=r,this.attr({cx:c,cy:u,r:r,"stroke-width":1})):this.attr({x:c,y:u,width:i,height:a,"stroke-width":1}),this.node.setAttribute("stroke-width",1),this.transform(o)},t&&(e.d={key:t,n:~t.indexOf("n"),s:~t.indexOf("s"),w:~t.indexOf("w"),e:~t.indexOf("e")},e.mousedown(function(e){return function(e,t){if(e.stopPropagation(),!(1<m.length)){for(var n=0;n<m.length;n++){if(!m[n].get("resizable"))return void(o=[]);o[n]=en.extend(!0,{},m[n].getClonedData()),delete o[n].update,delete o[n].getPageIndex}return en.extend(_,y),b=c[t.key]===c.n||c[t.key]===c.s?1:0,u=c[t.key]===c.w||c[t.key]===c.e?1:0,(t.n||1===u)&&(_.y=_.y2),t.w&&(_.x=_.x2),en(l._paper.canvas).on({mouseup:F,mousemove:S}),!1}}(e,this.d)})),e}function n(e){return-1!==en.inArray(e,m)}function i(){for(var e=0;e<m.length;e++)z(m[e]);m.length=0,p.clear(),f.hide()}function z(e){e.getEventObject().unbind(t)}function P(){0<p.length?T():0<m.length?i():f.hide()}function D(e){for(var t in c)c.hasOwnProperty(t)&&A(f[c[t]],e)}function T(){if(0<p.length){var e=1===p.length?m[0].getBox():p.getBBox();y.x=e.x,y.y=e.y,y.width=e.width,y.height=e.height,y.x2=e.x+e.width,y.y2=e.y+e.height,y.xmid=e.x+e.width/2,y.ymid=e.y+e.height/2,k()}}function k(){var e=1===p.length,t=tn.matrix(),n=1,o="",i=g.getViewerTransform(l._index);if(t.add(i.a,i.b,i.c,i.d,i.e,i.f),e){var a=m[0].getTransform();a&&t.add(a.a,a.b,a.c,a.d,a.e,a.f),n=g.getZoom(l._index),o=t.toTransformString(!0)}f[c.nw].center(y.x,y.y,n,o),f[c.ne].center(y.x2,y.y,n,o),f[c.sw].center(y.x,y.y2,n,o),f[c.se].center(y.x2,y.y2,n,o),f[c.n].center(y.xmid,y.y,n,o),f[c.w].center(y.x,y.ymid,n,o),f[c.e].center(y.x2,y.ymid,n,o),f[c.s].center(y.xmid,y.y2,n,o);var r=m[0].get();r.rotatable||!r.hasOwnProperty("rotatable")?(v.show(),v.center(y.xmid,y.y-s/n,n,o)):v.hide(),D((1===m.length?m[0].get().rotation:0)+g.getPageRotation(l._index))}function C(e){var t=l.offset(),n=Q(l._paper.canvas,l);return{x:e.pageX-(t.left+n.left),y:e.pageY-(t.top+n.top)}}function M(e){e.stopPropagation();var t,n,o,i=(t=C(e),n=g.getViewerTransform(l._index).invert(),o=n.x(t.x,t.y),t.y=n.y(t.x,t.y),t.x=o,t),a=180*Math.atan2(i.y-_.ymid,i.x-_.xmid)/Math.PI+90;return 1===m.length&&(m[0].set({rotation:a}),m[0].repaint()),l._grips.repaint(),!1}function E(e){return e.stopPropagation(),en(l._paper.canvas).off({mouseup:E,mousemove:M}),1===m.length&&(m[0].getEventObject().trigger("rotated"),m[0].getEventObject().trigger({type:"annotationchanged",ann:m[0],annobefore:x})),!1}function S(e){if(e.stopPropagation(),1===p.length){var t=function(e){if(0<p.length){var t="set"===p[0].type?p[0][0]:p[0],n=t.matrix.invert(),o={x:n.x(e.x,e.y),y:n.y(e.x,e.y)};return o}return e}(C(e)),n=Math.abs(t.x-_.x),o=Math.abs(t.y-_.y),i=t.x<_.x?_.x-n:_.x,a=t.y<_.y?_.y-o:_.y;r=i,l=a,s=n,c=o,0===b&&(y.x=r,y.width=Math.max(s,1),y.x2=r+y.width,y.xmid=r+y.width/2),0===u&&(y.y=l,y.height=Math.max(c,1),y.y2=l+y.height,y.ymid=l+y.height/2),k(),function(){for(var e=0;e<m.length;e++)m[e].transform(y.x,y.y,y.width,y.height)}()}var r,l,s,c;return!1}function F(e){e.stopPropagation();for(var t=0;t<m.length;t++)m[t].getEventObject().trigger("resized"),m[t].getEventObject().trigger("annoresized"),m[t].getEventObject().trigger({type:"annotationchanged",ann:m[t],annobefore:o[t]}),m[t].repaint();return 0<p.length&&T(),en(l._paper.canvas).off({mouseup:F,mousemove:S}),!1}function A(e,t){if(e&&e.d&&e.d.key){var n=tn.matrix();n.rotate(t);var o={x:n.x(r[e.d.key].x,r[e.d.key].y),y:n.y(r[e.d.key].x,r[e.d.key].y)};for(var i in h)if(h.hasOwnProperty(i)&&I(o,h[i].start,h[i].end)){e.attr({cursor:(h[i].dir||"ne")+"-resize"});break}}}function I(e,t,n){function o(e,t){return 0<-e.x*t.y+e.y*t.x}return!o(t,e)&&o(n,e)}!function(){var e,t;for(var n in c)if(c.hasOwnProperty(n)){var o=l._paper.rect(0,0,d,d),i=w(o,n);f.push(i),f[c[n]]=i,(e=tn.matrix()).rotate(c[n]),r[n]={x:e.x(1,0),y:e.y(1,0)}}(t=w(l._paper.circle(0,0,d/2)).attr({fill:"#00FF40",cursor:"pointer"})).ellipse=!0,f.push(t),t.mousedown(function(e){return function(e){if(e.stopPropagation(),1===m.length&&1===p.length){for(var t=0;t<m.length;t++){var n=m[t].get();if(n.hasOwnProperty("rotatable")&&!n.rotatable)return}en.extend(_,y);var o=m[0].getTransform(),i=o.x(_.xmid,_.ymid);_.ymid=o.y(_.xmid,_.ymid),_.xmid=i,delete(x=en.extend(!0,{},m[0].getClonedData())).update,delete x.getPageIndex,en(l._paper.canvas).on({mouseup:E,mousemove:M})}}(e)}),v=t,function(){var o=tn.matrix();o.rotate(a,0,0);for(var e=function(e,t){var n={dir:t,start:{x:o.x(r[e].x,r[e].y),y:o.y(r[e].x,r[e].y)},end:{x:o.x(r[t].x,r[t].y),y:o.y(r[t].x,r[t].y)}};return n},t=["e","ne","n","nw","w","sw","s","se"],n=0;n<t.length-1;++n)0===n&&(h[t[n]]=e(t[t.length-1],t[n])),h[t[n+1]]=e(t[n],t[n+1])}()}(),this.push=function(e){n(e)||(m.push(e),p.push(e.getObject()),!0===e.get("selectable")&&e.getEventObject().bind(t),P(),f.toFront(),f.show())},this.contains=n,this.remove=function(e){for(var t=0;t<m.length;t++)m[t]===e&&m.splice(t,1);p.exclude(e.getObject()),z(e)},this.clear=i,this.repaint=P,this.updateCursor=D};function Te(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}
/**
