...
/**
     ...
     * @private
     */
Upload:Atalasoft.Upload||{}},Atalasoft.Controls.Version=[11,1,0,395];var _Statics={instanceCounter:0};
/**
...
/**
             ...
             * @function
             */
insertLayer:function(t,e,n,a){n=C(t,e,n),"function"==typeof a&&a();s.trigger({type:b.layerinserted,srcurl:t,srcindex:e,index:n}),s.trigger(b.layerschanged)},
/**
             ...
             * @function
             */
removeLayer:function(t,e){var n=S(t);"function"==typeof e&&e();s.trigger({type:b.layerremoved,layer:n,index:t}),s.trigger(b.layerschanged)},
/**
             ...
             * @function
             */
moveLayer:function(t,e,n){e=V(t,e),"function"==typeof n&&n();s.trigger({type:b.layermoved,srcindex:t,destindex:e}),s.trigger(b.layerschanged)},
/**
...
/**
    ...
    */function Q(t,e,n){var a={};t.multiview?a=t:(t&&t.type&&v[t.type]&&_.extend(!0,a,v[t.type]),_.extend(!0,a,t));var o=new Atalasoft.Annotations.Annotation(a,x);return o._pageindex=e,void 0===x.annos[e]&&(x.annos[e]=[]),x.annos[e].push(o),w.redrawPageFromIndex(e,!0),"function"==typeof n&&n(o),ht(o),o}function Z(t,e,n){var a=Q(t,e,n).getClonedData();return s.trigger({type:b.annocreate,anno:a,annotation:a,page:e}),a}function J(t,e){X(e,t)}
/**
    ...
    */function X(t,e){var n=x.annos[e].splice(t,1)[0];x.activepage&&x.activepage._paper&&x.activepage._paper._annos.exclude(n.getObject()),x.activeanno===n&&(x.activeanno=null),n.dispose(),x.activepage&&x.activepage._grips&&x.activepage._grips.repaint(),s.trigger({type:"annotationdeleted",page:e,index:t})}function Y(t){var e=[];if(0===x.annos.length||void 0===x.annos[t])return e;for(var n=0;n<x.annos[t].length;n++)e[n]=x.annos[t][n].getClonedData();return e}function $(t,e){if(isFinite(e)){if(e<x.annos.length)for(var n=0;n<x.annos[e].length;++n)if(x.annos[e][n].isCloneSource(t))return x.annos[e][n]}else for(var a=0;a<x.annos.length;++a){var o=$(t,a);if(o)return o}return null}function K(t){r.annotations.defaults=t;for(var e=0;e<t.length;e++)"string"==typeof t[e].type&&(v[t[e].type]=t[e]);return s}function tt(t){r.annotations.stamps=t;for(var e=0;e<t.length;e++)At(t[e]);if(p){var n={type:"button",id:w._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},a=w.createDropDownButton(n);n.onclick=w.drawAnnotation,w.createDropDownMenu(a,n,t)}return s}function et(t){r.annotations.images=t;for(var e=0;e<t.length;e++)Dt(t[e]);if(p){var n={type:"button",id:w._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},a=w.createDropDownButton(n);n.onclick=w.drawAnnotation,w.createDropDownMenu(a,n,t)}return s}
/**
