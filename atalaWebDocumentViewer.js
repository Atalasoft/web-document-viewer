...
/**
   ...
   */
Name:3},_={FileUploadRejectReason:w,SelectedItemsOrder:$e,SelectionMode:Ke,ScrollArea:wn,PageSelection:_n,Fitting:yn,ScrollDirection:xn,MouseToolCursor:Be,MouseToolType:bn,Browser:y},Ae={
/**
   * Image annotation.
   */
image:"image",
 ...
 */var An=function e(t,n,o){var i=this,a=this,h=t,x=n,s=new Le(h),r={
...
/**
       ...
       * @function
       */
drawAnnotation:function(e,t,n){x._controllers.mouseTool.setTool(bn.None,bn.None),fe(e,!0,function(){x._controllers.mouseTool.setTool(bn.Pan,bn.None),"function"==typeof t&&t()},function(){x._controllers.mouseTool.setTool(bn.Pan,bn.None),"function"==typeof n&&n()})},
/**
...
/**
       ...
       * @function 
       */
scrollTo:function(e,t){var n=this,o=function(){Ue(this,n),"function"==typeof t&&t()}.bind(this),i=e.getPageIndex(),a=Q(e,i);if(a){var r=a.getZoom(),l=Ae,s={x:0,y:0};if(e.type===l.line||e.type===l.lines||e.type===l.freehand){var c=e.points.map(function(e){return Ue(this,n),e.x}.bind(this)),u=e.points.map(function(e){return Ue(this,n),e.y}.bind(this));s.x=(Math.min.apply(Math,c)+Math.max.apply(Math,c))/2,s.y=(Math.min.apply(Math,u)+Math.max.apply(Math,u))/2}else s.x=e.x+e.width/2,s.y=e.y+e.height/2;s.x*=r,s.y*=r,x.showPagePoint(i,s,_n.Center,!0,o)}else o()},
/**
       ...
       * @function
       */
saveAll:function(e,t){ie(pn.extend(!0,{},{atala_annossavemode:1,atala_xmpfilename:e||"",atala_annos:Pe()}),t),m.annoIdsCreated.length=0,m.annoIdsModified.length=0,m.annoIdsRemoved.length=0},
/**
       ...
       * @function
       */
save:function(e,t,n,o){var i=n?t+n-1:t;ie(pn.extend(!0,{},{atala_annossavemode:2,atala_xmpfilename:e||"",atala_annosstartindex:t,atala_annosendindex:i,atala_annos:Pe(t,i)}),o);for(var a=t;a<=i;a++)if(m.annos.hasOwnProperty(a)&&m.annos[a])for(var r=m.annos[a].length,l=0;l<r;l++)if(m.annos[a][l]){var s=m.annos[a][l].get();s&&ce(s.annotationId)}},
/**
...
/**
       ...
       * @function
       */
isAnnotationsPropertiesWindowShown:function(){return Ue(this,i),null!=p&&p.isVisible()}.bind(this),
/**
...
/**
   ...
   */function Z(e,t,n){var o={};e.multiview?o=e:(e&&e.type&&b[e.type]&&pn.extend(!0,o,b[e.type]),pn.extend(!0,o,e));var i=new Ve(h,o,m);i._pageindex=t,i.setFIndex(t);var a=i.get().annotationId;a&&0!==a&&!he(a)||(a=se()+1,i.setAnnotationId(a)),m.maxAnnotationId<a&&(m.maxAnnotationId=a),void 0===m.annos[t]&&(m.annos[t]=[]),m.annos[t].push(i),ue(a),x.redrawPageFromIndex(t,!0),"function"==typeof n&&n(i),we(i);var r=i.getClonedData();return h.trigger({type:w.annocreate,anno:r,annotation:r,page:t}),i}function X(e,t,n){return Z(e,t,n).getClonedData()}function G(e,t){Y(t,e)}
/**
   ...
   */function Y(e,t){var n=m.annos[t].splice(e,1)[0],o=n.get();o&&de(o.annotationId),m.activepage&&m.activepage._paper&&m.activepage._paper._annos.exclude(n.getObject()),m.activeanno===n&&(m.activeanno=null),n.dispose(),m.activepage&&m.activepage._grips&&m.activepage._grips.repaint(),h.trigger({type:"annotationdeleted",page:t,index:e})}function J(e){var n=this,t=[];if(0===m.annos.length||void 0===m.annos[e])return t;for(var o=0;o<m.annos[e].length;o++)t[o]=m.annos[e][o].getClonedData();return t.sort(function(e,t){return Ue(this,n),e.tabindex-t.tabindex}.bind(this))}function Q(e,t){if(isFinite(t)){if(t<m.annos.length)for(var n=0;n<m.annos[t].length;++n)if(m.annos[t][n].isCloneSource(e))return m.annos[t][n]}else for(var o=0;o<m.annos.length;++o){var i=Q(e,o);if(i)return i}return null}function K(e){l.annotations.defaults=e;for(var t=0;t<e.length;t++)"string"==typeof e[t].type&&(b[e[t].type]=e[t]);return h}function $(e){l.annotations.stamps=e;for(var t=0;t<e.length;t++)Fe(e[t]);if(u){var n={type:"button",id:x._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},o=x.createDropDownButton(n);n.onclick=x.drawAnnotation,x.createDropDownMenu(o,n,e)}return h}function ee(e){l.annotations.images=e;for(var t=0;t<e.length;t++)e[t].type="image";if(u){var n={type:"button",id:x._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},o=x.createDropDownButton(n);n.onclick=x.drawAnnotation,x.createDropDownMenu(o,n,e)}return h}
/**
...
/**
       ...
       * @function
       */
getPageText:function(i,a,e){var r=this,l=pn.Deferred();return ve(i).done(function(){Ze(this,r);var e="",t=I(i);if(t)for(var n=0;n<t.regions.length;n++){var o=Z(t.regions[n]);o&&(e+=o)}l.resolve(e),a&&"function"==typeof a&&a(e)}.bind(this)).fail(function(){Ze(this,r),l.reject(),e&&"function"==typeof e&&e()}.bind(this)),l.promise()},
/**
...
/**
       ...
       * @function
       */
reloadPageText:function(e,t,n){var o=this;return b(e),ve(e).done(function(){Ze(this,o),t&&"function"==typeof t&&t(e)}.bind(this)).fail(function(){Ze(this,o),n&&"function"==typeof n&&n(e)}.bind(this))},
/**             
...
/**
   ...
   * @returns {number[]}
   */
function V(){var n=this,e=g.slice(0);return k.selecteditemsorder===$e.ItemIndexOrder&&e.sort(function(e,t){return nt(this,n),e-t}.bind(this)),e}function L(e){var t=1,n=function(){--t<=0&&(D()&&y&&f&&C(f,h.getDocumentInfo(),!0),"function"==typeof e&&e.call())};D()&&(y?y.closeDocument(P(),u):f.isReady()&&(t++,f.empty(n))),H(n)}h.getSelectedPageIndex=
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=W,h.deselectThumb=U,h.isActive=D,h.activate=function(){C(f,h.getDocumentInfo())};var H=function(){};function R(){D()&&(y?y.closeDocument(P(),u):f.empty(),M()),j(),v=f=null}var j=function(){};function B(e,t,n,o){w.base&&pn.each(w.base.dom.pageDivs,function(e,t){t.off(c),t.thumbInitialized=!1}),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(y.closeDocument(P(),u),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.x=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Fe(e,t,o)})}var N=function(){};function q(e){if(w.base){0===g.length&&g.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<g.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),o.attr("aria-label").endsWith(" Selected")||o.attr("aria-label",o.attr("aria-label")+" Selected"),null!==n&&-1<g.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection"),o.attr("aria-label",o.attr("aria-label").replace(" Selected",""))),Q(o,i)}}}
/** 
   ...
   */function W(e,t,n){var o=this;if(v._controllers.upload&&v._controllers.upload.abort(),!(null===(e=et(e))||e<0||e>=h.getDocumentInfo().count||void 0!==t&&"boolean"!=typeof t&&null!==t||void 0!==n&&"function"!=typeof n&&null!==n)){if(t=!!t&&k.selectionmode!==Ke.SingleSelect){if(-1<g.indexOf(e))return;g.push(e)}else V().forEach(function(e){nt(this,o),h.trigger({type:"thumbdeselected",index:e})}.bind(this)),g.length=0,g.push(e);Z(),h.trigger({type:"thumbselected",index:e}),"function"==typeof n&&n()}}
/** 
