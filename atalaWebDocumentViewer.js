...
/**
   ...
   */
Name:3},_={FileUploadRejectReason:w,SelectedItemsOrder:Ye,SelectionMode:Ge,ScrollArea:on,PageSelection:nn,Fitting:tn,ScrollDirection:en,MouseToolCursor:Re,MouseToolType:$t,Browser:x},xe={
/**
   * Image annotation.
   */
image:"image",
...
/** Triggers after thumbnail drag & drop operation is complete.
     ...
     * @param {ThumbDragCompleteEventArgs} args - The event data.
     */
thumbdragcomplete:null};function D(){return{get:function(){return h},detachViewer:E,activateViewer:C}}function T(e,t){if(e){var n=t?e.bind:e.unbind,o=t?h.unbind:h.bind;n.call(e,{beforehandlerrequest:Pe,documentloaded:fe,scroll:be,pagerotated:we,pageinserted:ge,pageremoved:me,pagemoved:ve}),o.call(h,{pagerotated:pe,pageinserted:pe,pageremoved:pe,pagemoved:pe}),a(e,e.document.events,n),P.allowannotations&&(n.call(e,{annotationresized:ze,annotationmoved:ze,annotationrotated:ze,annotationchanged:ze,annotationcreated:xe,annotationdeleted:_e}),e.annotations&&a(e,e.annotations.events,n))}}function a(e,t,n){var o={};for(var i in t)t.hasOwnProperty(i)&&(o[i]=r);n.call(e,o)}function r(){h.trigger.apply(h,arguments)}
/**
...
/**
   ...
   * @returns {number[]}
   */
function V(){var n=this,e=p.slice(0);return P.selecteditemsorder===Ye.ItemIndexOrder&&e.sort(function(e,t){return Ke(this,n),e-t}.bind(this)),e}function H(e){var t=1,n=function(){--t<=0&&(k()&&x&&f&&C(f,h.getDocumentInfo(),!0),"function"==typeof e&&e.call())};k()&&(x?x.closeDocument(D(),u):f.isReady()&&(t++,f.empty(n))),L(n)}h.getSelectedPageIndex=
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=U,h.deselectThumb=W,h.isActive=k,h.activate=function(){C(f,h.getDocumentInfo())};var L=function(){};function B(){k()&&(x?x.closeDocument(D(),u):f.empty(),E()),R(),m=f=null}var R=function(){};function j(e,t,n,o){w.base&&Qt.each(w.base.dom.pageDivs,function(e,t){t.off(c),t.thumbInitialized=!1}),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(x.closeDocument(D(),u),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.x=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Ee(e,t,o)})}var N=function(){};function q(e){if(w.base){0===p.length&&p.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<p.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),null!==n&&-1<p.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection")),J(o,i)}}}
/** 
...
/** 
   ...
   */function W(e,t){if(null!==(e=Qe(e))&&(void 0===t||"function"==typeof t||null===t)){var n=p.indexOf(e);-1!==n&&1!==p.length&&(p.splice(n,1),Z(),h.trigger({type:"thumbdeselected",index:e}),"function"==typeof t&&t())}}function Z(){var e=V();if(x?(w.viewer.pagenumber=e[0],C(f,h.getDocumentInfo())):q(!0),!(1<p.length)&&f){var t=f.getCurrentPageIndex(),n=e[0];0<=t&&n!==t&&(w.scrolling=!0,f.showPage(n,ye))}}
/**
