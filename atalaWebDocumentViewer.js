...
Text:{},/**
     ...
     */
Utils:{}});!function(){Atalasoft.Controls.Version=[11,0,0,432];var t={instanceCounter:0};/**
...
/**
         ...
         * @memberOf Atalasoft.Controls.WebDocumentViewer
         */
function n(){return{get:function(){return Dn},isInitialized:sn,switchDocument:Eo,closeDocument:Bo}}function i(){sn()||(Fn=a(),Wn=r()),Atalasoft.Utils._scriptLoader=Atalasoft.Utils.__loadDependencies(Nn.scripturl,Nn.allowannotations,w);var t={_config:Nn,_id:Tn,_dom:En,_document:En.loadedImgs,_pages:En.pageDivs,_state:Wn,_internalEvents:In,_controllers:Bn,createDOM:b,createDiv:y,createDialog:C,createDropDownButton:H,createDropDownMenu:M,createMenu:V,drawAnnotation:Vo,redrawVisiblePages:Go,adjustVisiblePages:xo,startDomManipulation:ro,endDomManipulation:lo,redrawPageFromIndex:Xo,makeHandlerRequest:tn,getPageScale:Do,getPageSize:se,getSourcePageSize:le,getPageRotation:Po,getViewerTransform:To,isPageInView:Ye,findPageFromIndex:to,showPagePoint:eo};Bn.document=new Atalasoft.Document.ManipulationController(Dn,t,Tn),Dn.document=Bn.document.__exposedApi,Nn.allowannotations?(Bn.annotations=new Atalasoft.Annotations.AnnotationController(Dn,t,Pn),Dn.annotations=Bn.annotations.__exposedApi):(Dn.deselectAll=Mo,Dn.createAnnotationOnPage=Mo,Dn.getAnnotationsFromPage=Mo,Dn.deleteAnnotationOnPageAtIndex=Mo,Dn.setAnnotationDefaults=Mo,Dn.setImages=Mo,Dn.setStamps=Mo),Nn.allowforms&&!Bn.forms&&(Bn.forms=new Atalasoft.Forms.FormController(Dn,t),Dn.forms=Bn.forms.__exposedApi),Nn.allowtext&&!Atalasoft.Utils.Browser.Explorer8&&(Bn.text=new Atalasoft.Text.TextController(Dn,t,Nn.mousetool?Nn.mousetool.text:{}),Dn.text=Bn.text.__exposedApi);var e="undefined"==typeof zn.easing||"undefined"==typeof zn.ui||Nn.allowannotations&&"undefined"==typeof Raphael;e?Atalasoft.Utils._scriptLoader&&Atalasoft.Utils._scriptLoader.bind({scriptsloaded:l}):l()}function a(){return{size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:""}}function r(){return{prpr:0,loading:!1,zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0}}function l(){Wn.initialized===!1&&(Wn.initialized=!0,wn({throwerror:x,pagedivsresized:h,documentchanged:Fo,pagesizechanged:g}),Nn.parent?(Nn.parent instanceof jQuery||(Nn.parent=zn(Nn.parent)),Nn.parent.length||w("InitError","Parent element not found.")):w("InitError","No parent element given."),En.toolbar=D(Nn.toolbarparent||Nn.parent),En.toolbar.addClass(Rn.atala_toolbar),En.main=y(Nn.parent),En.main.addClass(Rn.atala_main_container),En.scroller=y(En.main),En.scroller.addClass(Rn.atala_scroller),En.main.bind({selectstart:m}),En.toolbar.attr("id",Tn+"_toolbar"),En.main.attr("id",Tn+"_main"),En.scroller.attr("id",Tn+"_scroller"),En.main.css({height:"100%",width:"100%",position:"relative"}),En.scroller.css({height:"100%",width:"100%",position:"relative"}),En.viewport=y(En.scroller,Tn+"_vp"),En.viewport.css({overflow:"hidden",fontSize:0,"touch-action":"none"}),En.viewport.addClass(Rn.atala_viewport),En.viewport.attr("tabindex",-1),En.edges[0]=L(En.viewport,Tn+"_e0"),En.edges[0].addClass(Rn.atala_dom_edge_first),En.content=y(En.viewport,Tn+"_ct"),En.content.addClass(Rn.atala_content),En.content.css({"-ms-touch-action":"none",fontSize:0,overflow:"hidden"}),Nn.direction===Un.Horizontal&&En.content.css({display:"inline-block"}),En.edges[1]=L(En.viewport,Tn+"_e1"),En.edges[1].addClass(Rn.atala_dom_edge_last),Atalasoft.Utils.Browser.Features.Compatibility&&w("InitError","Compatibility Mode is not supported."),Atalasoft.Utils.Browser.Mobile.Any()?En.scroller.css({overflow:"hidden"}):Nn.showscrollbars?(En.scroller.css({overflow:"auto"}),En.scrollH=R(En.main,Un.Horizontal),En.scrollH.attr("id",Tn+"_sH"),En.scrollH.addClass(Rn.atala_scroll_horizontal),En.scrollV=R(En.main,Un.Vertical),En.scrollV.attr("id",Tn+"_sV"),En.scrollV.addClass(Rn.atala_scroll_vertical)):En.scroller.css({overflow:"hidden"}),Bn.mouseTool=new Atalasoft.Controls.ToolController(Dn,{_internalEvents:In,_controllers:Bn,zoomStart:so,zoom:co,zoomEnd:uo,getActivePage:Ie,raiseDrawLayer:Io,resetDrawLayer:ko,getViewerTransform:To},En.viewport,En.scroller,zn.extend({allowflick:Nn.allowflick},Nn.mousetool)),Bn.memory=new Atalasoft.Document.MemoryTracker({highWaterMark:Nn.memorythreshold}),Bn.memory.bind({exceededhighwatermark:d}),Bn.annotations&&Bn.annotations.setViewPort(En.viewport),bn("initialized"),c(),zn(document).ready(p))}function s(){var e=Nn.parent.attr("id")+"_wdv";for(++t.instanceCounter;document.getElementById(e+t.instanceCounter);)++t.instanceCounter;Tn=e+t.instanceCounter}function c(){Atalasoft.Utils.Browser.Explorer&&parseInt(Atalasoft.Utils.Browser.Version,10)<8?En.viewport.css({"float":"left"}):(Nn.direction===Un.Horizontal&&En.viewport.css({"white-space":"nowrap"}),En.viewport.css({display:"table-cell"})),q(En.scroller),En.scrollH&&En.edges[1].height(En.scrollH.scrollbarHeight()),Bn.mouseTool.setTool(Ln.Pan,Ln.None),(Nn.documenturl||Nn.annotationsurl||Nn.formurl)&&pn(Nn.documenturl,Nn.annotationsurl,Nn.formurl,o)}/**
...
function Se(t,e){if(t=Math.max(1,t),t=Math.min(Bn.document.getPageCount(),t),Fn.number!==t){var o=t-Fn.number;Math.abs(o)<En.pageDivs.length?ye(o,e):Ue(t,!0,e)}else"function"==typeof e&&e.call()}function Ue(t,e,o){var n=Bn.document.getPageCount(),i=t-1;if(0===Wn.prpr&&n>0){var a=function(){Ze(!e),"function"==typeof o&&o.call()};Qe();var r=0,l=0,s=0>=i?0:i;if(s+En.pageDivs.length>=n){if(s=n-En.pageDivs.length,Nn.tabular){var c=re();s=Math.ceil(s/c)*c}s=Math.max(s,0)}if(Nn.direction===Un.Vertical){r=oe(s).height,En.edges[0].height(r),Me(s,null),He(),We();for(var u=0;u<En.pageDivs.length;u++)En.content.append(En.pageDivs[u]),Ne(En.pageDivs[u],null,s+u);var d=oe(Math.max(i,0)).height,h=Fn.number<t?-Fn.size.height:Fn.size.height;e&&d!==Wn.scrollPos.y?(xe(null,d+h,!1),xe(null,d,!0,a)):a.call()}else if(Nn.direction===Un.Horizontal){l=oe(s).width,En.edges[0].width(l),Me(s,null),He(),We();for(var g=0;g<En.pageDivs.length;g++)En.content.append(En.pageDivs[g]),Ne(En.pageDivs[g],null,s+g);var f=oe(Math.max(i,0)).width,p=Fn.number<t?-Fn.size.width:Fn.size.width;e&&f!==Wn.scrollPos.x?(xe(f+p,null,!1),xe(f,null,!0,a)):a.call()}}else he("paused",o)}function Le(t){Wn.activepage=t}function Fe(t){var e=Bn.document.getPageCount();if(t>0&&e>=t){if(Fn.number!==t||Fn.numberoutof!==e){if(En.pageLabel.html(t+" / "+e),Fn.number!==t){Fn.number=t;for(var o=0;o<En.pageDivs.length;o++){var n=En.pageDivs[o];n._index===t-1?n.addClass(Rn.atala_active_page):n.removeClass(Rn.atala_active_page)}bn({type:"pagenumberchanged",number:Fn.number})}Fn.numberoutof!==e&&(Fn.numberoutof=e)}}else En.pageLabel.html(""),En.viewport.find("."+Rn.atala_active_page).removeClass(Rn.atala_active_page),Fn.numberoutof=0}function We(){for(var t=En.pageDivs.length-1;t>=0;t--)Oe(En.pageDivs[t])}function Re(){for(var t=0;t<En.loadedImgs.length;t++)En.loadedImgs[t]&&(En.loadedImgs[t].dispose(),En.loadedImgs[t].remove());En.loadedImgs.length=0}function Oe(t){Atalasoft.Utils.Browser.Explorer&&document.activeElement&&t.has(document.activeElement).length&&En.scroller.focus(),t.detach(),null!=t._img&&(t._img._page=null,t._img.getDomElement().detach(),t._img=null),bn({type:"pagerecycled",index:t._index,page:t}),t._index=-1,t.removeAttr(On.atala_page_index)}function qe(t){Oe(t),t._index=-1,t.removeAttr(On.atala_page_index),t._img=null,t.remove()}function Ne(t,e,o,n){if(t._index===o&&t._img===e&&!n)return!1;if(n&&!t.nullinserted&&0>o)return!1;if(t._index=o,t.attr(On.atala_page_index,o),o>=Bn.document.getPageCount())return t.hide(),!1;t._img&&t._img!==e&&(t._img._page=null,t.has(t._img.getDomElement()).length>0&&t._img.getDomElement().detach(void 0,!0)),t._rubberband&&t._rubberband.reset(),t._img=e,t._img&&(t._img._page=t),t.css({display:Nn.tabular||Nn.direction===Un.Horizontal?"inline-block":"block"}),Nn.showpagenumber&&(t.css({position:"relative"}),t._num||(t._num=zn('<div style="position:absolute; right:20px; bottom:16px;z-index:1"/>'),t._num.addClass(Rn.atala_page_number),t.append(t._num)),t._num.text(t._index+1));var i=Atalasoft.Utils.Browser.Explorer&&parseInt(Atalasoft.Utils.Browser.Version,10)<=8,a=i&&t._img&&!t._img._loaded;if(t._img&&t._img._binds&&(t._img._binds.pageresize||(t._img._binds.pageresize=function(t){bn({type:"pageresize",page:t.image._page,image:t.image,index:t.image._page?t.image._page._index:Bn.document.getPageIndexByImageIndex(t.image._index),width:t.width,height:t.height})},t._img.bind({pageresize:t._img._binds.pageresize})),t._img._binds.pagesizechanged||(t._img._binds.pagesizechanged=function(e){bn({type:"pagesizechanged",page:t,image:e.image,index:e.index,width:e.width,height:e.height,dx:e.dx,dy:e.dy})},t._img.bind({pagesizechanged:t._img._binds.pagesizechanged}))),t._img&&!a){var r=t._img.getDomElement();i&&0===r.find(t._img).length&&r.append(t._img),t.append(r),t._img.trigger({type:"inserted",page:t}),t._img._loaded||(t.nullinserted?t._img.css({width:t.width(),height:t.height()}):je(t._img,t._index)),Wn.newpagedivsize||t.css({width:"",height:""}),t.nullinserted=!1}else t.nullinserted=!0,Wn.newpagedivsize||je(t,t._index);return bn({type:"pageshown",page:t,index:t._index}),!0}function je(t,e){var o=$(e,null,!1);t.css({width:o.width,height:o.height})}function Qe(){Wn.prpr++}function Ze(t){0!==Wn.prpr&&(Wn.prpr--,0!==Wn.prpr||t||Ae())}function Ge(t){return t>0?(fe(En.pageDivs,0,En.pageDivs.length-1),En.pageDivs[En.pageDivs.length-1]):(fe(En.pageDivs,En.pageDivs.length-1,0),En.pageDivs[0])}/**
         ...
         */
function Xe(t){var e=Bn.document.getPageDefinition(t);return e.cacheIndex>=0&&En.loadedImgs[e.cacheIndex]&&En.loadedImgs[e.cacheIndex]._loaded}/**
        ...
        */
function $e(t,e,o,n,i){var a=zn.Deferred(),r=zn.Deferred(),l=zn.Deferred(),s=zn.Deferred();"function"==typeof n&&(i=n,n=void 0),"function"==typeof o&&(i=o,o=!1),"function"==typeof e&&(i=e,e=!1),"function"==typeof i&&a.done(i);var c=Bn.document.getPageDefinition(t);if(!c)return a.resolve(),a.promise();c.cacheIndex>=0&&En.loadedImgs[c.cacheIndex]?r=Ke(c,n):Je(t,n,function(){r.resolve()});var u="string"==typeof e?e:c.uri?null:Nn.annotationsurl;Nn.allowannotations&&e&&(u||c.uri)?Bn.annotations.loadAnnotationsUrl(Nn.serverurl,u,c.uri,c.index,1,t,function(){l.resolve(!0)}):(e&&Bn.annotations.loadAnnotations({layers:[[]],offset:t}),l.resolve(!!e));var d="string"==typeof o?o:c.uri?null:Nn.formsurl;return Nn.allowforms&&o&&(Nn.formsurl||d)?Bn.forms.loadFormUrl(Nn.serverurl,d,c.uri,c.index,1,t,function(){s.resolve(!0)}):s.resolve(),zn.when(r,l,s).done(function(e,o,n){(o||n)&&Xo(t,!0),a.resolve(t)}),a.promise()}/**
        ...
        */
function Ke(t,e){var o=zn.Deferred();if(t.cacheIndex>=0&&En.loadedImgs[t.cacheIndex]){var n=En.loadedImgs[t.cacheIndex];n.invalidate(e,function(){o.resolve()})}else o.resolve();return o.promise()}function Je(t,e,o){"function"==typeof e&&(o=e,e=void 0);var n=Bn.document.getPageDefinition(t);if(n){if(n.cacheIndex<0||!En.loadedImgs[n.cacheIndex]){var i=Wn.nextImageCacheIndex++;n.cacheIndex=i,Bn.document.setPageCacheIndex(t,i),En.loadedImgs[i]=W(n.index,n.ref,e,function(t){t&&(En.loadedImgs[i]=t,t._cacheIndex=i,Bn.memory.allocate(t)),"function"==typeof o&&o.call()}),Nn.allowtext&&Bn.text&&!Pn&&Bn.text.ensurePageTextLoaded(t)}else"function"==typeof o&&o.call();return En.loadedImgs[n.cacheIndex]}}function Ye(t){var e=to(t);if(e){var o=En.scroller[0].scrollLeft,n=En.scroller[0].scrollTop;return ge(e[0],En.scroller[0],o,n,o+En.scroller[0].clientWidth,n+En.scroller[0].clientHeight)}return!1}function to(t){for(var e=null,o=0;o<En.pageDivs.length&&null===e;o++)En.pageDivs[o]._index===t&&(e=En.pageDivs[o]);return e}function eo(t,e,o,n,i){n&&"function"==typeof n&&(i=n,n=!1);var a,r=to(t);if(r){var l=En.scroller[0].scrollLeft,s=En.scroller[0].scrollTop;if(a=te(r[0],En.scroller[0]),a.left+=e.x,a.top+=e.y,!n&&a.left>=l&&a.left<=l+l+En.scroller[0].clientWidth&&a.top>=s&&a.top<=s+En.scroller[0].clientHeight)return i&&i(),void 0}else a=oe(t),a.left=a.width+e.x,a.top=a.height+e.y;var c={x:En.scroller[0].clientWidth/2,y:En.scroller[0].clientHeight/2};oo(o,Atalasoft.Utils.PageSelection.BottomLeft)?(c.x=En.scroller[0].clientWidth,c.y=En.scroller[0].clientHeight):oo(o,Atalasoft.Utils.PageSelection.TopLeft)&&(c.x=0,c.y=0),xe(a.left-c.x,a.top-c.y,!0,i)}function oo(t,e){return t&&e&&t.x===e.x&&t.y===e.y}function no(t,e){var o=to(t);null!=o&&null!=o._num&&o._num.css({left:e-20,right:0})}function io(){Zn&&clearTimeout(Zn),Zn=setTimeout(function(){bn("documentchanged")},200)}function ao(){0===Wn.prpr&&(Atalasoft.Utils.Browser.Safari||Atalasoft.Utils.Browser.Chrome?En.edges[1].hide().show():En.edges[1][0].className=En.edges[1][0].className)}function ro(){En.scroller.stop(),En.scroller.pauseEventPropagation(),Qe()}function lo(){ze(),En.pageDivs.length>0&&Ye(Bn.document.getPageCount()-1)&&Me(En.pageDivs[0]._index),He(),En.scroller.resumeEventPropagation(),Ze()}function so(){Wn.zooming=!0,ro(),bn("zoomstarted")}function co(t){t=Math.min(t,X()),t=Math.max(t,G()),po(t,!1),Nn.zoom=t,xo(!1),_o(t,!1)}function uo(){Wn.zooming=!1,lo(),bn({type:"zoomchanged",zoom:Nn.zoom})}/**
...
function ho(t,e){Wn.zooming?he("zooming",e):(Wn.zooming=!0,ro(),bn("zoomstarted"),e=null==e?go:Atalasoft.Utils.__functionFromArray([go,e]),t!==Nn.zoom?(t=Math.min(t,X()),t=Math.max(t,G()),po(t,!0),Nn.zoom=t,xo(!0),_o(t,!0,e)):"function"==typeof e&&e.call())}function go(){Wn.zooming=!1,lo(),Ae(),bn({type:"zoomchanged",zoom:Nn.zoom})}function fo(t,e){var o=Nn.zoom+(t?-1:1)*Nn.zoom*.3;ho(o,e)}function po(t,e,o){var n=oe(Fn.number,null,null),i=oe(Fn.number,null,null,t),a=(En.scroller.scrollLeft()-n.width)/Nn.zoom*t,r=(En.scroller.scrollTop()-n.height)/Nn.zoom*t;xe(i.width+a,i.height+r,e,An,o)}function mo(){En.edges[0]._z=Nn.zoom}function _o(t,e,o){if(En.edges.length>0){o="function"==typeof o?Atalasoft.Utils.__functionFromArray([mo,o]):mo;var n=Nn.direction===Un.Vertical,i=En.pageDivs[0]&&En.pageDivs[0]._img?En.pageDivs[0]._index:0,a=oe(i,null,null,t),r=n?a.height:a.width;if(e&&!Wn.loading){var l=n?{height:r}:{width:r};En.edges[0].animate(l,{duration:An,easing:"easeOutQuad",complete:o,queue:!1})}else n?En.edges[0].height(r):En.edges[0].width(r),"function"==typeof o&&o.call();vo()}}function vo(t){setTimeout(function(){var e=zn("<canvas/>"),o=zn('<span style="position:absolute; visibility:hidden; left: -5000px;">{[|,0123456789Thqkbfjplyg</span>');zn(document.body).append(o),t=t||Nn.zoom;var n=Nn.direction===Un.Vertical,i=Wn.newpagedivsize?Wn.newpagedivsize:{width:Fn.size.width*t,height:Fn.size.height*t},a=Math.max(1,Nn.pagespacing),r=re();e[0].width=(i.width+a)*(n?r:1),e[0].height=i.height*(n?1:r);var l=e[0].getContext("2d");l.lineWidth=Nn.pageborderwidth,Nn.backcolor&&(l.fillStyle=Nn.backcolor);for(var s=1,c=0;r>c;++c){var u=n?s+c*i.width:s,d=n?s:s+c*i.height;l.strokeRect(u,d,i.width-2*s,i.height-2*s),Nn.backcolor&&l.fillRect(u+l.lineWidth,d+l.lineWidth,i.width-2*(s+l.lineWidth),i.height-2*(s+l.lineWidth))}var h=e[0].toDataURL(),g={backgroundImage:"url("+h+")",backgroundSize:"auto auto",backgroundRepeat:n?"repeat-y":"repeat-x"};En.edges[0].css(g),En.edges[1].css(g),o.remove()},0)}function wo(){var t={backgroundImage:"",backgroundSize:"",backgroundRepeat:"",backgroundColor:""};En.edges[0].css(t),En.edges[1].css(t)}function xo(t,e){for(var o=0,n=!0,i=function(){if(o--,0>=o){if(Nn.direction===Un.Horizontal){var t=ee().width;En.spacer||(En.spacer=y(),En.spacer.css({position:"absolute",top:"-1px",height:"1px"}),En.viewport.append(En.spacer)),En.spacer.width(t)}"function"==typeof e&&e.call(),ao()}},a=0;a<En.pageDivs.length;a++)if(En.pageDivs[a]._img){var r=En.pageDivs[a]._img.needsZoom()||En.pageDivs[a]._img.needsRotate();r&&(n=!1,o++,En.pageDivs[a]._img.needsRotate()?En.pageDivs[a]._img.rotate(i):En.pageDivs[a]._img.needsZoom()&&En.pageDivs[a]._img.zoom(t,i))}n&&i.call()}/**
        ...
        * @function fit
        */
function bo(t,e,o){null!=e?"function"==typeof e&&(o=e,e=Fn.number):e=Fn.number;var n=yo(t,e-1),i=n.zoom,a=Sn.Width===n.fit,r=Sn.Height===n.height;a&&xe(0,null,!1),r&&xe(null,0,!1),ho(i,o)}function yo(t,e){var o=de(),n=K(e,1,!1);(0===n.width||0===n.height)&&(t=null);var i=Nn.zoom;switch(t){case Sn.None:break;case Sn.Best:n.width/o.width>n.height/o.height?(i=o.width/n.width,t=Sn.Width):(i=o.height/n.height,t=Sn.Height);break;case Sn.Height:i=o.height/n.height;break;case Sn.Width:i=o.width/n.width;break;default:i=1,t=Sn.None}return{zoom:i,fit:t}}function zo(t){return Bn.document.getPageFitMultiplier(t)}function Do(t){return Nn.zoom*Bn.document.getPageFitMultiplier(t)}function Po(t){return Bn.document.getPageRotation(t)}function To(t,e){e=e||0;var o=Po(t),n=Do(t),i=le(t,e),a=Raphael.matrix();a.scale(n,n,0,0),a.rotate(o+e,0,0);var r=Ao(a,{x:i.width,y:i.height}),l=Math.min(0,r.x),s=Math.min(0,r.y),c=a.invert(),u=c.x(-l,-s),d=c.y(-l,-s);return a.translate(u,d),a}function Ao(t,e){return{x:t.x(e.x,e.y),y:t.y(e.x,e.y)}}function Vo(t){var e=zn.data(t.currentTarget,"_config"),o=zn.data(t.currentTarget,"_annoConfig");!o&&e&&(o={type:e.icon,rotatable:Nn.showrotatetools}),o&&(Bn.mouseTool.setTool(Ln.None,Ln.None),Bn.annotations.drawAnnotation(o,!1,Ho,Co))}function Co(){Bn.mouseTool.setTool(Ln.Pan,Ln.None)}function Ho(){Bn.mouseTool.setTool(Ln.Pan,Ln.None)}/**
        * Checks whether annotations support is enabled.
        * @private
        */
function Mo(){return Nn.allowannotations===!1&&w("InitError",'The "allowannotations" property in the WebDocumentViewer config is set to false.'),Nn.allowannotations}function Io(){for(var t=0;t<En.pageDivs.length;t++)En.pageDivs[t]._draw.toFront()}function ko(){for(var t=0;t<En.pageDivs.length;t++)En.pageDivs[t]._draw.reset()}function Eo(t,e,o){if(t){if(Wn.loading=!0,Fn.size.width=t.pagewidth,Fn.size.height=t.pageheight,Fn.count=t.pagecount,Fn.buffer=Nn.pagebuffersize,Fn.dpi=t.dpi,Fn.vector=t.vector===!0,Nn.allowannotations=o.allowannotations,Nn.allowforms=o.allowforms,Nn.allowtext=o.allowtext,Nn.documenturl=o.documenturl,Nn.annotationsurl=o.annotationsurl,Nn.formsurl=o.formsurl,Bn.document.__linkChanges(e),Bn.annotations&&(Bn.annotations.clear(),Bn.annotations.loadAnnotations(t)),Bn.forms&&(Bn.forms.clear(),t.forms&&Bn.forms.loadForms(t)),Bn.text&&Bn.text.search(""),Bn.mouseTool.setTool(Nn.mousetool.type&&!Pn?Nn.mousetool.type:Ln.Pan,Ln.None),Wn.zooming=!1,t.zoom)Nn.zoom=t.zoom;else{var n=yo(Nn.fitting,1);Nn.zoom=n.zoom}Wo(t.pagenumber||0),vo(),Wn.loading=!1,xo(),bn({type:"activedocumentchanged"})}}function Bo(t,e){e&&rn(!0);for(var o=0;o<t._controllers.document.getPageCount();++o){var n=t._controllers.document.getPageDefinition(o,Tn);n&&n.cacheIndex>=0&&En.loadedImgs[n.cacheIndex]&&(Bn.memory.deallocate(En.loadedImgs[n.cacheIndex]),En.loadedImgs[n.cacheIndex].dispose(),En.loadedImgs[n.cacheIndex].remove(),En.loadedImgs[n.cacheIndex]=void 0)}}function So(t,e){function o(t){Uo(t,e)}function n(t,o,n){Lo(t,o,n,e)}Wn.loading=!0;var i={atala_docurl:Nn.documenturl,atala_pagebuffer:Nn.pagebuffersize,atala_minwidth:Nn.minwidth};Pn&&(i.atala_thumb=Pn,i.atala_capt_format=Nn.thumbcaptionformat),null!=t&&("function"==typeof t&&(e=t,t=null),zn.extend(i,t));var a={type:"docinfo",serverurl:Nn.serverurl,query:"?ataladocinfo=",method:"GET",data:i,cancel:!1,info:{pagewidth:-1,pageheight:-1,pagecount:-1}};tn(a,o,n)}function Uo(t,e){if(t&&t.licensed!==!1)Fn.size.width=t.pagewidth,Fn.size.height=t.pageheight,Fn.count=t.pagecount,Fn.buffer=Nn.pagebuffersize,Fn.dpi=t.dpi,Fn.vector=t.vector===!0,Fn.caption=t.thumbcaptionformat||(Nn.showthumbcaption?"{0}":""),Qn.zero(),Bn.memory.clearEntries(),Bn.memory.setColorDepth(t.colordepth),Bn.memory.setPageSize(t.pagewidth,t.pageheight),bn({type:"documentinfochanged",info:{count:Fn.count,dpi:Fn.dpi,size:{height:Fn.size.height,width:Fn.size.width},vector:Fn.vector}}),Bn.text&&(Bn.text.clear(),t.text&&Bn.text.loadText(t)),Wn.loading&&(Nn.zoom=1,F(),xe(0,0),En.scrollV&&En.scrollV.pageNum(1),Fe(1),bo(Nn.fitting,1,function(){He(),Me(0,En.pageDivs.length-1);for(var o=0;o<En.pageDivs.length&&o<Fn.count;o++)En.content.append(En.pageDivs[o]),Ne(En.pageDivs[o],null,o);En.pageDivs.length>0&&En.pageDivs[0].addClass(Rn.atala_active_page),t.layers&&t.layers.length?Bn.annotations.loadAnnotations(t):Nn.annotationsurl&&Bn.annotations&&Bn.annotations.clear(),Bn.forms&&(Bn.forms.clear(),t.forms&&Bn.forms.loadForms(t)),Bn.mouseTool.setTool(Nn.mousetool.type&&!Pn?Nn.mousetool.type:Ln.Pan,Ln.None),Wn.loading=!1,vo(),"function"==typeof e&&e(t.error),t.error&&setTimeout(function(){w("DocumentLoadError",t.error)},0)})),Wn.loading=!1;else{var o,n;t&&t.licensed===!1?(o="LicenseException",n=t.error?t.error:"LicenseException: Handler was unable to find a valid license."):(o="DocumentLoadError",n="HandlerException: Handler did not return any data."),Wn.loading=!1,"function"==typeof e&&e.call(void 0,n),o&&n&&w(o,n)}}function Lo(t,e,o,n){if(t.responseText){var i=t.responseText.substr(t.responseText.indexOf("</html>")+7);i.indexOf("<!--")>=0?(i=i.replace("<!--","").replace("-->",""),i.length>0&&(o="<pre>"+i+"</pre>")):t.responseText.indexOf("web.config")>0&&t.responseText.indexOf("customErrors")>0&&(o+=": web.config customErrors attribute has disabled remote error messages.")}w("DocumentLoadError",o),"function"==typeof n&&n.call(void 0,o)}function Fo(){Wo()}function Wo(t){if(F(),En.pageDivs.length>0){var e=Bn.document.getPageCount(),o="number"==typeof t?t:En.pageDivs[0]._index;o=o>=0?Math.min(o,e-En.pageDivs.length):0;for(var n=0;n<En.pageDivs.length&&e>n;n++){var i=o+n;Oe(En.pageDivs[n]),En.content.append(En.pageDivs[n]),Ne(En.pageDivs[n],null,i)}}Me(En.pageDivs.length>0?En.pageDivs[0]._index:0,null),He(),Go(),ze();var a=En.scroller[0].scrollLeft,r=En.scroller[0].scrollTop,l=Y(a,r);Fe(l+1),t>=0&&l!==t&&Be(t)}function Ro(t,e){function o(t){Oo(t),"function"==typeof e&&e.call()}function n(t){var e=[];e.error=t.responseText,o(e)}var i={atala_docurl:Nn.documenturl,atala_spath:Nn.savepath};zn.extend(i,t);var a={type:"docsave",serverurl:Nn.serverurl,query:"?ataladocsave=",method:"POST",data:i,cancel:!1,info:{success:void 0,error:void 0}};tn(a,o,n)}function Oo(t){t.error?w("DocumentSaveError",t.error):pe("DocumentSave: success="+t.success),bn({type:"documentsaved",success:t.success})}function qo(t,e,o){var n=null;return"string"==typeof t?(n={},Wn.initialized&&o&&(t.length>0?n=o.createHandlerRequest(Nn.serverurl,t,e):0===t.length&&o.clear()),n.url=t):"undefined"!=typeof t&&null!=t&&w("openUrlError","string input expected for url."),n}function No(){wn({annotationsloaded:Ko})}function jo(t,e){Bn.annotations&&(No(),Bn.annotations.makeHandlerRequest(t,e))}function Qo(){wn({formsloaded:Jo})}function Zo(t,e){Bn.forms&&(Qo(),Bn.forms.makeHandlerRequest(t,e))}function Go(t){if(!(En.pageDivs.length>0&&"undefined"==typeof En.pageDivs[0]._index))for(var e=0;e<En.pageDivs.length;e++)$o(En.pageDivs[e],t)}function Xo(t,e){var o=to(t);o&&$o(o,e)}function $o(t,e){(Ne(t,Je(t._index),t._index)||e)&&(Bn.annotations&&Bn.annotations.showLayer(t._index,t),Bn.forms&&!Pn&&Bn.forms.showLayer(t._index,t),Bn.text&&!Pn&&Nn.allowtext&&Bn.text.showLayer(t._index,t))}function Ko(t){t.error&&(w("AnnotationsLoadError",t.error),Nn.annotationsurl=""),Bn.annotations&&xn({annotationsloaded:Ko})}function Jo(t){t.error&&(w("FormsLoadError",t.error),Nn.formsurl=""),Bn.forms&&xn({formsloaded:Jo})}function Yo(t){bn({type:"beforehandlerrequest",request:t})}function tn(t,e,o){var n=en(t,function(t){e(t.request.info)});Yo(t),t.cancel||(xn({handlerreturned:n}),t.serverurl&&!zn.isEmptyObject(t.data)&&(t.info instanceof jQuery&&"docpage"===t.type?t.info.attr("src",t.serverurl+t.query+"&"+zn.param(t.data)):zn.ajax({type:t.method,url:t.serverurl+t.query+"?",dataType:"json",data:t.data,success:e,error:o,crossDomain:"string"==typeof t.method&&"post"===t.method.toLowerCase()?!1:void 0})))}function en(t,e){var o=function n(o){o.request===t&&(xn({handlerreturned:n}),"function"==typeof e&&e.call(this,o))};return wn({handlerreturned:o}),o}function on(){var t={version:Atalasoft.Controls.Version.join(".")};return Nn.debug&&zn.extend(!0,t,{dom:En,controllers:Bn,page:Fn}),t}function nn(t){function e(){this.typeOf="__LVlinker",this._id=Tn,this._config=Nn,this._controllers=Bn,this._dom=En,this._page=Fn,this._state=Wn,this._annos=null,this._fields=null,this.stateManager=kn,this.__createDialog=C,this.__createDiv=y,this.__createDOM=b,this.__createDropDownButton=H,this.__createDropDownMenu=M,this.__createMenu=V,this.__getPageSize=se,this.__getTabularIndexOffset=re,this.__redrawVisiblePages=Go,this.__adjustVisiblePages=xo,this.__onDocumentChanged=Fo,this.__startDomManipulation=ro,this.__endDomManipulation=lo,this.__status=pe,this.__updatePageSize=f,this.__silentReloadPage=Ke,this.__isObjectInRect=ge,this.__getIndexFromPos=J,this.__showNext=Ee,this.__showPrevious=ke,this.__showPageAsync=Ue,this.__redrawVisiblePages=Go,this.__adjustEdgeHeights=Me}if(t&&"Atalasoft.Controls.WebDocumentThumbnailer"===t.typeOf){var o=new e;return Bn.document.__linkChanges(o),Nn.allowannotations&&(t!==Dn&&Nn.annotationsurl.length>0&&(Nn.annotationsurl=""),Bn.annotations.__linkAnnotations(o)),Nn.allowforms&&(t!==Dn&&Nn.formurl.length>0&&(Nn.formurl=""),Bn.forms.__linkForms(o)),Nn.allowtext&&Bn.text&&Bn.text.__linkText(o),o}}/**
...
/**
        ...
        * @function openUrl
        */
function pn(t,e,o,n){null==n&&("function"==typeof e?(n=e,e=null):"function"==typeof o&&(n=o,o=null));var i=0,a=!1,r={},l=qo(e,t,Bn.annotations),s=qo(o||t,t,Bn.forms);Nn.annotationsurl=l?l.url:Nn.annotationsurl,Nn.formsurl=s?s.url:Nn.formsurl;var c=function(t){i--,0>=i&&(Go(!0),bn({type:"documentloaded"}),"function"==typeof n&&n.call(void 0,t))};if("string"==typeof t)0===t.length?an(c):(Nn.documenturl=t,Wn.initialized&&(rn(),O(En.scrollH),O(En.scrollV),i++,0===t.length&&an(c),Nn.allowannotations&&l&&l.data&&(No(),zn.extend(r,l.data)),Nn.allowforms&&s&&s.data&&(Qo(),zn.extend(r,s.data)),a=!0,So(r,c)));else{var u=!(t||!(Nn.documenturl.length>0)||!e&&""!==e&&!o&&""!==o);u||w("openUrlError","string input expected for document url.")}a||(l&&(i++,jo(l,c)),s&&(i++,Zo(s,c)))}/**
        ...
        * @function save
         ...
         * _viewer.save(‘’, ‘tif’)
         */
function mn(t,e,o,n){"function"==typeof o&&(n=o,o={}),"function"==typeof e&&(n=e,e=Nn.savefileformat),"function"==typeof t&&(n=t,t=null),void 0===e&&(e=Nn.savefileformat);var i=zn.extend(!0,o,{atala_subpath:t||"",atala_sformat:e});Bn.annotations&&zn.extend(i,{atala_iuname:Nn.annotations.saveusername,atala_annos:Bn.annotations.stringifyChanges()}),Bn.forms&&zn.extend(i,{atala_forms:Bn.forms.stringifyChanges()}),Bn.document&&zn.extend(i,{atala_document:Bn.document.stringifyChanges()}),Ro(i,n)}/**
...
function _n(){return Fn.number-1}/**
         ...
         */
function vn(t){for(var e in Atalasoft.Utils.MouseToolType)if(Atalasoft.Utils.MouseToolType.hasOwnProperty(e)&&Atalasoft.Utils.MouseToolType[e]===t){Bn.mouseTool.setTool(t);break}}/**
...
status:null},Bn={annotations:null,document:null,forms:null,mouseTool:null,memory:null,text:null},Sn=Atalasoft.Utils.Fitting,Un=Atalasoft.Utils.ScrollDirection,Ln=Atalasoft.Utils.MouseToolType,Fn=a(),Wn=r(),Rn=Atalasoft.Controls.WebDocumentViewer.domclasses,On=Atalasoft.Controls.WebDocumentViewer.domattributes,qn={/**
...
return Dn.__getDebugInfo=on,/**
        ...
        */
Dn.__getViewerLink=nn,Dn.dispose=u,Dn.empty=an,Dn.fit=bo,Dn.getZoom=ln,Dn.isReady=sn,Dn.scrollTo=cn,Dn.scrollBy=un,Dn.next=dn,Dn.previous=hn,Dn.zoom=ho,Dn.zoomIn=gn,Dn.zoomOut=fn,Dn.openUrl=Dn.OpenUrl=pn,Dn.save=mn,Dn.getCurrentPageIndex=_n,Dn.bind=wn,Dn.unbind=xn,Dn.trigger=bn,Dn.getDocumentInfo=yn,Dn.setMouseTool=vn,Dn.isPageLoaded=Xe,Dn.reloadPage=$e,Dn.showPage=Be,Dn.showPageNumber=Se,Atalasoft.Annotations.AnnotationController(),Atalasoft.Document.ManipulationController(),Atalasoft.Forms.FormController(),Atalasoft.Text.TextController(),Dn.annotations=Atalasoft.Annotations.AnnotationController.__exposedApi,Dn.document=Atalasoft.Document.ManipulationController.__exposedApi,Dn.forms=Atalasoft.Forms.FormController.__exposedApi,Dn.text=Atalasoft.Text.TextController.__exposedApi,i(),Dn}}();
