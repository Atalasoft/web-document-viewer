...
//  Copyright 2003-2017 Atalasoft, Inc. All Rights Reserved.
//
...
Text:{},/**
     ...
     */
Utils:{}});!function(){Atalasoft.Controls.Version=[11,0,0,297];var t={instanceCounter:0};/**
...
function I(){if(qt.annos.length>0){if(qt.annos.length=0,Tt)for(var e=0;e<Tt.length;e++)Tt[e]._grips.clear(),Tt[e]._paper.forEach(m),Tt[e]._paper._trash.remove(),Tt[e]._paper._trash.clear(),Tt[e]._paper._annos.remove(),Tt[e]._paper._annos.clear();Ot.trigger({type:"annotationscleared"})}}/**
    ...
    */
function T(e,t,n){var a={};e.multiview?a=e:(e&&e.type&&Gt[e.type]&&Rt.extend(!0,a,Gt[e.type]),Rt.extend(!0,a,e));var o=new Atalasoft.Annotations.Annotation(a,qt);return o._pageindex=t,"undefined"==typeof qt.annos[t]&&(qt.annos[t]=[]),qt.annos[t].push(o),zt.redrawPageFromIndex(t,!0),"function"==typeof n&&n(o),gt(o),o}function E(e,t,n){var a=T(e,t,n).getClonedData();return Ot.trigger({type:Xt.annocreate,anno:a,annotation:a,page:t}),a}function U(e,t){M(t,e)}/**
    ...
    */
function M(e,t){var n=qt.annos[t].splice(e,1)[0];qt.activepage&&qt.activepage._paper._annos.exclude(n.getObject()),qt.activeanno===n&&(qt.activeanno=null),n.dispose(),qt.activepage&&qt.activepage._grips.repaint(),Ot.trigger({type:"annotationdeleted",page:t,index:e})}function L(e){var t=[];if(0===qt.annos.length||"undefined"==typeof qt.annos[e])return t;for(var n=0;n<qt.annos[e].length;n++)t[n]=qt.annos[e][n].getClonedData();return t}function j(e,t){var n;if(isFinite(t)){if(t<qt.annos.length)for(n=0;n<qt.annos[t].length;++n)if(qt.annos[t][n].isCloneSource(e))return qt.annos[t][n]}else for(n=0;n<qt.annos.length;++n){var a=j(e,n);if(a)return a}return null}function N(e,t,n,a){n=h(e,t,n),"function"==typeof a&&a(),Ot.trigger({type:Xt.layerinserted,srcurl:e,srcindex:t,index:n}),Ot.trigger(Xt.layerschanged)}function H(e,t){var n=v(e);"function"==typeof t&&t(),Ot.trigger({type:Xt.layerremoved,layer:n,index:e}),Ot.trigger(Xt.layerschanged)}function q(e,t,n){t=y(e,t),"function"==typeof n&&n(),Ot.trigger({type:Xt.layermoved,srcindex:e,destindex:t}),Ot.trigger(Xt.layerschanged)}function G(e){It.annotations.defaults=e;for(var t=0;t<e.length;t++)"string"==typeof e[t].type&&(Gt[e[t].type]=e[t]);return Ot}function Q(e){It.annotations.stamps=e;for(var t=0;t<e.length;t++)Dt(e[t]);if(Et){var n={type:"button",id:zt._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},a=zt.createDropDownButton(n);n.onclick=zt.drawAnnotation,zt.createDropDownMenu(a,n,e)}return Ot}function J(e){It.annotations.images=e;for(var t=0;t<e.length;t++)Pt(e[t]);if(Et){var n={type:"button",id:zt._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},a=zt.createDropDownButton(n);n.onclick=zt.drawAnnotation,zt.createDropDownMenu(a,n,e)}return Ot}/**
    ...
    */
function X(e){It.annotations.custom=e;for(var t=0;t<e.length;t++)Vt(e[t]);if(Et){var n={type:"button",id:zt._id+"_toolbar_Button_Custom",icon:"image",tooltip:"Draw Custom",text:""},a=zt.createDropDownButton(n);n.onclick=zt.drawAnnotation,zt.createDropDownMenu(a,n,e)}return Ot}function Z(e){return $(e,!0)}function Y(e){return $(e,!1)}function $(e,t){if("text"===e.type&&e){var n=e.getPageIndex(),a=j(e,n);if(t){var o=e.visible;o&&(zt.isPageInView(n)?K(a,n):Ot.showPage(e.getPageIndex(),function(){K(a,n)}))}else a.trigger("hideeditor")}}function K(e,t){e&&(e.get("selectable")!==!1&&Wt.select(e,t,!1),e.trigger("showeditor"))}function et(){var e={};return Rt.extend(!0,e,{data:qt,defaults:Gt,drawing:Qt,drawready:Jt,matrix:Ht,menu:Mt,menuconfig:Lt,pages:Tt,props:jt,viewport:Ut}),e}function tt(e){e&&(e._annos?Rt.isArray(e._annos)&&(qt.annos=e._annos):e._annos=qt.annos)}function nt(e){e&&(e instanceof jQuery||(e=Rt(e)),Ut=e)}function at(e,t,n){if(Qt)return null;var a=Rt.extend(!0,{},e);return e&&e.type&&Gt[e.type]&&(a=Rt.extend(!0,a,Gt[e.type])),a.rotation=0,qt.activeanno&&null===qt.activeanno.getObject()&&ct(),it(),qt.activeanno=new Atalasoft.Annotations.Annotation(a,qt),qt.activeanno.bind({drawn:pt,cancelled:ct}),"function"==typeof t&&(ot=t),"function"==typeof n&&(rt=n),qt.activeanno}function ot(){}function rt(){}function it(){if(!Jt){Ut.bind("mousedown",lt),Atalasoft.Utils.Browser.Features.Touch&&Ut.bind("touchstart",lt);for(var e=0;e<Tt.length;e++)Tt[e]._draw.toFront();Jt=!0}}function st(){if(Jt){Ut.unbind("mousedown",lt),Atalasoft.Utils.Browser.Features.Touch&&Ut.unbind("touchstart",lt);for(var e=0;e<Tt.length;e++)Tt[e]._draw.reset();Jt=!1}}function lt(e){Qt=!0,Ut.unbind("mousedown",lt),Atalasoft.Utils.Browser.Features.Touch&&Ut.unbind("touchstart",lt);var t=qt.activeanno.getClonedData();Ot.trigger({type:"annotationdrawstart",annotation:t,ann:t}),qt.activeanno._pageindex=qt.activepage._index,qt.activeanno.startDraw(e,qt.activepage._paper,{}),Atalasoft.Utils.Browser.Explorer&&parseInt(Atalasoft.Utils.Browser.Version,10)<8&&qt.activepage._draw.height(qt.activepage.height())}function pt(){ut(),ft(qt.activeanno),Atalasoft.Utils.Browser.Explorer&&parseInt(Atalasoft.Utils.Browser.Version,10)<8&&qt.activepage._draw.height("100%")}function ct(){qt.activeanno.dispose(),qt.activeanno=null,Qt&&ut(!0)}function dt(){Jt&&(Qt?ct():(qt.activeanno&&(qt.activeanno.dispose(),qt.activeanno=null),st()),rt({annotation:null}),rt=function(){})}function ut(e){Qt=!1,st();var t=e?null:qt.activeanno.getClonedData();Ot.trigger({type:"annotationdrawend",annotation:t,ann:t,cancelled:e?!0:!1})}function ft(e){var t=qt.activepage,n=t?t._index:0;qt.annos[n]?qt.annos[n].push(e):qt.annos[n]=[e],qt.activeanno.unbind({drawn:pt,cancelled:ct}),gt(qt.activeanno),Wt.select(qt.activeanno,t,!1),ot({annotation:e}),ot=function(){};var a=e.getClonedData();Ot.trigger({type:Xt.annocreate,anno:a,annotation:a,page:n})}function gt(e){function t(t){var n=e.getClonedData();Ot.trigger({type:Xt[t.type],anno:n,annotation:n})}e.bind({dragstart:function(){var t=e.getClonedData();Ot.trigger({type:"annotationdragstart",ann:t,annotation:t})},dragend:function(){var t=e.getClonedData();Ot.trigger({type:"annotationdragend",annotation:t,ann:t})},interactstart:function(){qt.activepage&&qt.activepage._paper===e.getObject().paper||A(e.getObject().paper._page),qt.activeanno=e},selected:ht,deselected:ht,reselected:ht,contextmenu:S,serverrenderurlrequested:vt,moved:t,rotated:t,annoresized:t,interactend:t,touchstart:t,touchmove:t,pinchmove:t,click:t,dblclick:t,rightclick:t,mousedown:t,mousedownleft:t,mousedownright:t,mousemove:t,mouseout:t,mouseup:t,mouseover:t,repaint:t})}function ht(e){var t=e.page||e.pageindex>=0?e.pageindex:qt.activepage;t=Wt.resolvePage(t),"selected"===e.type||"reselected"===e.type?(qt.activeanno=e.ann,Wt.select(e.ann,t,e.append),jt&&jt.isVisible()&&jt.show(e.ann)):(Wt.deselect(e.ann,t,e.append),jt&&jt.isVisible()&&jt.cancel()),t._grips.repaint()}function vt(e){var t=e.complete,n=mt(e.data);"function"==typeof t&&t.call(n)}function yt(){var e=[];for(var t in qt.annos)if(qt.annos.hasOwnProperty(t)){e[t]={items:[]};var n=0,a=zt.getPageScale(t),o=Raphael.matrix();if(zt._config.persistrotation){n=zt.getPageRotation(t),o=zt.getViewerTransform(t);var r=1/a;o.scale(r,r,0,0),o.e*=r,o.f*=r}for(var i in qt.annos[t])if(qt.annos[t].hasOwnProperty(i)){var s=Rt.extend(!0,{},qt.annos[t][i].get());if(s.rotation||n){var l=qt.annos[t][i].getBox(),p=l.width/2,c=l.height/2,d=Raphael.matrix();d.add(o),d.add(qt.annos[t][i].getTransform());var u={x:d.x(l.x+p,l.y+c),y:d.y(l.x+p,l.y+c)},f=u.x-p-l.x,g=u.y-c-l.y;if(s.points)for(var h=0;h<s.points.length;h++)if("line"===s.type){var v=d.x(s.points[h].x,s.points[h].y);s.points[h].y=d.y(s.points[h].x,s.points[h].y),s.points[h].x=v}else s.points[h].x+=f,s.points[h].y+=g;else"custom"!==s.type&&s.points||(s.x+=f,s.y+=g);s.rotation="line"!==s.type?(s.rotation+n)%360:0}e[t].items[i]=s,wt(s)}}return JSON.stringify(e)}function mt(e){return wt(e),JSON.stringify(e)}function wt(e){for(var t in e)if("color"===t&&null!=e[t]){var n=Raphael.getRGB(e[t]);n.error&&(n.hex="#000000"),e[t]=n.hex}else"points"!==t&&"object"===_typeof(e[t])&&wt(e[t])}function _t(e,t,n,a,o){n=n||Ot.config.documenturl;var r={type:"annodata",serverurl:e,query:"?atalaanndata=",method:"GET",data:{atala_annurl:t,atala_docurl:n,atala_a_ofs:a,atala_a_len:o},cancel:!1,info:{layers:[],offset:a||0,length:o,error:void 0}};for(var i in r.data)r.data.hasOwnProperty(i)&&null===r.data[i]&&(r.data[i]=void 0);return r}function xt(e,t,n){function a(a){if(void 0!==e.info.docIndex&&(a.offset=e.info.docIndex),!a.layers&&a.error&&t)for(var o=a.offset;o<a.offset+e.info.length;o++)qt.annos[o]=[];At(a),"function"==typeof n&&n.call()}"function"==typeof t&&(n=t,t=!1),t||I(),zt.makeHandlerRequest(e,a,a)}function bt(e,t,n,a,o,r,i){var s=Array.prototype.slice.call(arguments);i=s.pop(),"function"!=typeof i&&s.push(i),e=s.shift(),t=s.shift(),n=s.shift(),a=s.shift(),o=s.shift(),r=s.shift();var l=_t(e,t,n,a,o);void 0!==r&&(l.info.docIndex=r),xt(l,a>=0&&o>=1,i)}function At(e){if(e)if("undefined"!=typeof Raphael){var t={type:"annotationsloaded"};if(e.layers)for(var n=0;n<e.layers.length;n++){e.offset=e.offset||0;var o=e.offset+n;qt.annos[o]&&qt.annos[o].length>0?qt.annos[o].length=0:qt.annos[o]=[];var r=e.layers[n];if(r&&(r._index=isFinite(r._index)&&r._index>=0?r._index:o,r.visible=void 0!==r.visible?r.visible:!0,r.items))for(var i=0;i<r.items.length;i++){r.items[i].visible=r.items[i].visible&&r.visible,qt.annos[o][i]=new Atalasoft.Annotations.Annotation(r.items[i],qt),qt.annos[o][i]._pageindex=r._index;var s=qt.annos[o][i].getClonedData();Ot.trigger({type:Xt.annoload,anno:s,annotation:s}),gt(qt.annos[o][i])}}else e.error&&(t.error=e.error);t.offset=e.offset,t.length=e.layers?e.layers.length:0,Ot.trigger(t)}else a(function(){At(e)})}function Dt(e){return e.type="stamp",e.text&&(kt(e.text),e.text.readonly=!0),e}function kt(e){return e&&e.font&&e.font.size&&(e.font.size=parseFloat(e.font.size)),e}function Pt(e){return e.type="image",e}function Vt(e){e.type="custom"}var Rt=Atalasoft.$,Ct=2.1,St=this,Ot=e,zt=t,Wt=new Atalasoft.Annotations.AnnotationSelector,Ft={/**
...
contextmenu:null,/** Triggers when the Raphael dependency has finished loading.
         ...
         */
raphaelloaded:null},Bt={/** @lends Atalasoft.Controls.WebDocumentViewer~AnnotationController */
annotations:{events:Ft,/**
...
selectAllOnPage:Wt.selectPage,/**
             ...
             * @function
             */
deselectAllOnPage:Wt.deselectPage,/**
...
hideEditor:Y,/**
             ...
             * @param [AnnotationData[]]- Default configurations for different types of the annotations.
...
setDefaults:G,/**
             ...
             * @param [AnnotationData[]]- Default configurations image annotations.
             * @returns {Atalasoft.Controls.WebDocumentViewer}
             * @instance
             * @function
             */
setImages:J,/**
             ...
             * @param [AnnotationData[]]- Default configurations stamp annotations.
             * @returns {Atalasoft.Controls.WebDocumentViewer}
             * @instance
             * @function
             */
...
setImages:J,/**
         ...
         */
setStamps:Q};if(Atalasoft.Annotations.AnnotationController.__exposedApi=Bt.annotations,!e)return null;var It=t._config,Tt=t._pages,Et=!1,Ut=null,Mt=null,Lt=null,jt=null,Nt=[],Ht=null,qt={annos:[],activepage:null,activeanno:null,readonly:n?!0:!1,zoom:Ot.getZoom(),getZoom:zt.getPageScale,getViewerTransform:zt.getViewerTransform,getPageRotation:zt.getPageRotation},Gt={},Qt=!1,Jt=!1,Xt={click:"annotationclicked",dblclick:"annotationdoubleclicked",touchstart:"annotationtouchstart",interactend:"annotationtouchend",touchmove:"annotationtouchmove",pinchmove:"annotationpinchresize",rightclick:"annotationrightclicked",mousedown:"annotationmousedown",mousedownleft:"annotationmousedownleft",mousedownright:"annotationmousedownright",mousemove:"annotationmousemove",mouseout:"annotationmouseout",mouseup:"annotationmouseup",mouseover:"annotationmouseover",annocreate:"annotationcreated",annoload:"annotationloaded",moved:"annotationmoved",rotated:"annotationrotated",annoresized:"annotationresized",repaint:"annotationrepainted",layerinserted:"layerinserted",layerremoved:"layerremoved",layermoved:"layermoved",layerschanged:"layerschanged"};"undefined"==typeof Raphael?(Atalasoft.Utils._scriptLoader=Atalasoft.Utils.__loadDependencies(It.scripturl,It.allowannotations),Atalasoft.Utils._scriptLoader&&Atalasoft.Utils._scriptLoader.bind({scriptsloaded:r})):r(),p(),St.__exposedApi=Bt.annotations,St.addDrawingSurface=f,St.removeDrawingSurface=g,St.insertLayer=h,St.removeLayer=v,St.moveLayer=y,St.showLayer=x,St.clear=I,St.createAnnotation=T,St.deleteAnnoOnPage=U,St.drawAnnotation=at,St.getAnnosFromPage=L,St.setStamps=Q,St.setAnnotationDefaults=G,St.setImages=J,St.setCustom=X,St.dispose=s,/**
    * [Internal] Gets debug info object
    * @returns debug info object if available, otherwise null
    */
...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};Atalasoft.Annotations.AnnotationSelector=function(e,n){function t(e){m=e}function o(e){A=e}function r(){b=null,m=null,A=null,_.length=0}function l(e,n,t){i(!0,e,n,t)}function f(e,n,t){i(!1,e,n,t)}function i(e,n,t,o){var r,l,f=[].concat(n),i=null;i=a(t),i===t&&(t=i._index),o||p(i||t);for(var u=0;u<f.length;u++)r=f[u],l=h.inArray(r,_[t]),l>=0?e||_[t][l]!==r||_[t].splice(l,1):e&&(_[t]?_[t].push(r):_[t]=[r]),i&&(e?i._grips.push(r):i._grips.remove(r)),r.get("selected")!==e&&r.toggleSelected({append:!0,pageindex:t,page:i})}function u(e,n){var t="object"===("undefined"==typeof n?"undefined":_typeof(n))?n._index:n;m[t]&&i(e,m[t],n,!0)}function c(e){for(var n=[],t=0;t<e.length;t++)if(e[t]){n[t]=[];for(var o=0;o<e[t].length;o++)n[t][o]=e[t][o].getClonedData()}return n}function a(e){var n=null;if("object"===("undefined"==typeof e?"undefined":_typeof(e)))n=e;else{e=Math.max(e,0);var t=h.grep(A,function(n){return n._index===e});t.length>=1&&(n=t[0])}return n}function s(e){u(!0,e)}function p(e){var n=a(e);u(!1,n),n._grips.repaint()}function g(){for(var e=0;e<m.length;e++)s(e)}function d(){for(var e=0;e<m.length;e++)p(e)}function y(){return c(_)}/**
    ...
    */
function v(){return c(m)}var h=Atalasoft.$,b=this,m=e,A=n,_=[];b.dispose=r,b.select=l,b.deselect=f,b.setAnnos=t,b.setPages=o,b.resolvePage=a,b.deselectAll=d,b.deselectPage=p,b.getAnnotations=v,b.getSelected=y,b.selectAll=g,b.selectPage=s};
...
"use strict";Atalasoft.Annotations.DrawHandler=function(t,e,n,a,i){function r(){}function o(t){var e=Atalasoft.Utils.getMousePositionJquery(t);if(q.paper){var n=Atalasoft.Utils.getSVGOffset(q.paper.canvas,q.paper._page);e.x-=n.left,e.y-=n.top}return e}function s(t){var e=L.getViewerTransform(J._pageindex).invert(),n=e.x(t.x,t.y);return t.y=e.y(t.x,t.y),t.x=n,t}function p(){N.trigger.apply(N,arguments)}function u(t,e,n){q=e,G=n,t.stopPropagation(),t.preventDefault();var a=s(o(t));I.visible=!0,$={x:a.x,y:a.y},I.x=Math.round(a.x),I.y=Math.round(a.y),I.width=1,I.height=1,"path"===q.type&&"custom"!==I.type?"ellipse"!==I.type?(I.points=[{x:I.x,y:I.y}],("lines"===I.type||"polygon"===I.type)&&I.points.push({x:I.x,y:I.y}),I.x=0,I.y=0,Q=c,W=C):(Q=y,W=P):(Q=y,W=U),B(),O={events:Atalasoft.Utils.Browser.Features.Touch?{touchend:d,touchmove:l,mouseup:d,mousemove:l}:{mouseup:d,mousemove:l},src:z(t.srcElement||t.target),main:z(t.currentTarget)},O.src.bind(O.events),O.main.bind({mouseup:d})}function h(){O&&(O.src.unbind(O.events),O.main.unbind({mouseup:d}))}function l(t){t.stopPropagation(),Q(t),B()}function c(t){var e=s(o(t));switch(I.type){case"line":I.points[1]=e;break;case"freehand":I.points.push(e);break;case"lines":I.points[I.points.length-1]=e;break;case"polygon":I.points[I.points.length-1]=e}"path"===q.type&&("ellipse"===I.type?E():V(),q._&&0===q._.dirty&&(q._.dirty=1))}function y(t){var e=s(o(t)),n=$.x,a=$.y,i=Math.max(Math.abs(e.x-$.x),1),r=Math.max(Math.abs(e.y-$.y),1);if(I.aspectratio>0){var p=Math.abs((e.y-$.y)/(e.x-$.x));p>1/I.aspectratio?i=Math.round(r/I.aspectratio):r=Math.round(i/I.aspectratio)}e.x<$.x&&(n=$.x-i),e.y<$.y&&(a=$.y-r),I.x=n,I.y=a,I.width=i,I.height=r}function d(t){t.stopPropagation();var e=!1;if("lines"===I.type||"polygon"===I.type){if(L.activepage._index!==J._pageindex)return;if(I.points.push(s(o(t))),2!==t.button)return}else I.points?I.points&&I.points.length<2&&"custom"!==I.type&&(e=!0):(I.width<4&&I.height<4&&(I.width=100,I.height=100),B());h(),O=null,e?p("cancelled"):p("drawn")}function x(t){if(!L.readonly){t.originalEvent.stopPropagation();var e=J.getBox();$={x:e.x,y:e.y}}}function f(t){if(!L.readonly){t.originalEvent.stopPropagation();var e=s({x:0,y:0}),n=s({x:t.dx,y:t.dy});J.translate(n.x-e.x,n.y-e.y),p("moving")}}function g(t){if(!L.readonly){t.originalEvent.stopPropagation();var e=J.getBox();if(q.paper&&q.paper._page){var n=q.getBBox(),a={x:0,y:0,width:q.paper._page.width(),height:q.paper._page.height()};if(!X(a,n))return J.translate($.x-e.x,$.y-e.y),void 0}($.x!==e.x||$.y!==e.y)&&p("moved")}}function v(t){if(!I.points&&!L.readonly){var e=s({x:t.touches[0].clientX,y:t.touches[0].clientY}),n=s({x:t.touches[1].clientX,y:t.touches[1].clientY}),a=J.getBox();K={start:Atalasoft.Utils.CalcDistance(e.x,e.y,n.x,n.y),rect:a}}}function m(t){if(K){var e=s({x:t.touches[0].clientX,y:t.touches[0].clientY}),n=s({x:t.touches[1].clientX,y:t.touches[1].clientY}),a=Atalasoft.Utils.CalcDistance(e.x,e.y,n.x,n.y,K.start),i=a.x-K.start.x,r=a.y-K.start.y,o=K.rect.x-a.dx,p=K.rect.y-a.dy,u=K.rect.width+i,h=K.rect.height+r;I.points?J.transform(o,p,u,h):(I.x=o,I.y=p,I.width=u,I.height=h),q.paper&&q.paper._page&&q.paper._page._grips&&q.paper._page._grips.repaint(),B()}}function w(){p("resized"),p("annoresized"),K=null}function _(){B()}function b(t){q=t.annview,G=t.textview,"path"===q.type&&"custom"!==I.type?"ellipse"!==I.type?(Q=c,W=C):(Q=y,W=P):(Q=y,W=U)}function M(){q.transform(j.toTransformString()),G&&G.repaint()}function A(){q.transform(T()),B()}function B(){W(),q&&q.transform(T()),G&&G.repaint()}function T(){var t=Raphael.matrix();return t.add(L.getViewerTransform(J._pageindex)),t.add(J.getTransform()),t.toTransformString()}function U(){q.attr({x:I.x,y:I.y,width:I.width,height:I.height}),H&&H.render(q,I),Atalasoft.Utils.Browser.Features.VML&&q.transform(T())}function P(){E(),q._&&0===q._.dirty&&(q._.dirty=1)}function C(){V(),q._&&0===q._.dirty&&(q._.dirty=1)}function E(){var t=I.width/2,e=I.height/2,n=te*t,a=te*e,i=I.x+I.width/2,r=I.y+I.height/2,o=["M",i,r-e,"C",i+n,r-e,i+t,r-a,i+t,r,"C",i+t,r+a,i+n,r+e,i,r+e,"C",i-n,r+e,i-t,r+a,i-t,r,"C",i-t,r-a,i-n,r-e,i,r-e,"Z"];q.attr({path:o})}function V(){if(I.points&&0!==I.points.length){for(var t=["M",I.points[0].x,I.points[0].y],e=1;e<I.points.length;e++)t=t.concat(["L",I.points[e].x,I.points[e].y]);"polygon"===I.type&&t.push("Z"),q.attr({path:t}),D()}}/**
    ...
    */
function D(){if(Atalasoft.Utils.Browser.Explorer){var t=parseInt(Atalasoft.Utils.Browser.Version,10);t>=10&&12>t&&q.node&&q.node.parentNode&&q.node.parentNode.insertBefore(q.node,q.node)}}function R(){z.extend(I,Z(j,L.getZoom(J._pageindex))),A(),ee=null}function S(t,e,n,a){j=Raphael.matrix(n,0,0,a,t,e),ee||(ee=k(I,1)),j.add(ee),M()}function X(t,e){return Y(t,e.x,e.y)||Y(t,e.x+e.width,e.y)||Y(t,e.x,e.y+e.height)||Y(t,e.x+e.width,e.y+e.height)}function Y(t,e,n){return e>=t.x&&e<=t.x+t.width&&n>=t.y&&n<=t.y+t.height}function k(t,e){var n;if(t.points&&t.points.length>1){var a=J.getBox();n=Raphael.matrix(1,0,0,1,0,0),n.scale(1/a.width,1/a.height,0,0),n.translate(-a.x,-a.y)}else n=Raphael.matrix(e,0,0,e,0,0),n.translate(t.x,t.y),n.scale(t.width,t.height,0,0);return n}function Z(t,e){var n=t.split(),a={x:n.dx/e,y:n.dy/e,width:n.scalex/e,height:n.scaley/e};return a}var z=Atalasoft.$,F=this,I=t,L=e,N=n,q=null,G=null,H=i,J=a,O=null,$=null,j=null,K=null,Q=function(){},W=function(){};F.events={drawstart:u,drawmove:l,drawend:d,dragstart:x,dragmove:f,dragend:g,update:_,viewchanged:b,pinchstart:v,pinchmove:m,pinchend:w},r(),F.drawStart=u,F.unbindEvents=h,F.repaint=B,F.getTransform=T;var te=.5522847498307936;F.commitTransform=R,F.transformUI=S;var ee=null};
"use strict";/**
...
"use strict";Atalasoft.Annotations.AnnotationTextRenderer=function(t,e){function n(){i(),d=s("<canvas "+(c?'dir="rtl"':"")+"/>"),p=s('<span style="position:absolute; visibility:hidden; left: -5000px;">{[|,0123456789Thqkbfjplyg</span>'),s(document.body).append(p)}function i(){var t,e=document.body;e.currentStyle?t=e.currentStyle.direction:window.getComputedStyle&&(t=document.defaultView.getComputedStyle(e,null).getPropertyValue("direction")),"rtl"===t.toLowerCase()&&(c=!0)}function l(){f=null,g=null,x=null,d&&d.remove&&(d.remove(),d=null),p&&p.remove&&(p.remove(),p=null)}function o(t){d&&p||n(),x.applyTo(p),d[0].width=t.width,d[0].height=t.height;var e=d[0].getContext("2d"),i=u(e,g.text.value,t.width),l=r(i.length),o=g.text.autoscale?l:g.text.font.size,a=[g.text.font.italic?"italic":"normal",g.text.font.bold?"bold":"normal",o+"px",g.text.font.family];e.font=a.join(" "),e.fillStyle=g.text.font.color,e.textBaseline="top";var h,s=0,f=i.length?i[0]:"";for(h=0;h<i.length;h++)i[h].length>f.length&&(f=i[h]);var v=e.measureText(f).width,w=c?v:0;if(g.text.autoscale&&"left"!==g.text.align)switch(g.text.align){case"center":e.textAlign=g.text.align,w=v/2;break;case"right":e.textAlign=g.text.align,w=c?0:v;break;default:e.textAlign="start",w=c?v:0}if(g.text.autoscale){var m=t.width/v;e.scale(m,1)}for(h=0;h<i.length;h++)e.fillText(i[h],w,s,v),s+=l;return d[0].toDataURL()}function a(e,n){var i=w;i&&i.width===n.width&&i.height===n.height&&i.text===t.text.value&&i.align===t.text.align||(w={width:n.width,height:n.height,text:t.text.value,align:t.text.align},e.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",o(n)))}function r(t){if(g.text.autoscale){var e=Math.max(0,g.height-2*g.outline.width);return t>0?Math.floor(e/t):e}return x.applyTo(p,1),p[0].offsetHeight}function u(t,e,n){var i=[];if("string"==typeof e){var l="\n";if(g.text.autoscale)return e.split(l);for(var o=e,a=n,r=h(o),u="",f="",x=[],d=0;d<r.length;d++)if(u=f,f=r[d],t.measureText(f).width>a)for(var p=f.split(""),c=0;c<p.length;c++)x.push(p[c]),t.measureText(x.join("")).width>a&&(x.pop(),i.push(x.join("")),x.length=0,x.push(p[c]));else x.push(f),(t.measureText(s.trim(x.join(""))).width>a||u.indexOf(l)>=0)&&(x.pop(),i.push(x.join("")),x.length=0,x.push(f));x.length>0&&(i.push(x.join("")),x.length=0)}return i}function h(t){for(var e=[],n="",i=0,l=0;l<t.length;l++){var o=t[l];v[n]&&(e.push(t.substr(i,l-i)),i=l),n=o}return l>i&&e.push(t.substr(i,l-i)),e}var s=Atalasoft.$,f=this,g=t,x=e,d=null,p=null,c=!1,v={" ":!0,"-":!0,"?":!0,"\n":!0,"	":!0},w=null;f.dispose=l,f.renderToDataURL=o,f.renderToSVGImage=a};
...
"use strict";Atalasoft.Annotations.TextAnnotationUI=function(t,e,o){function n(){r(),x(),t.bind(R)}function r(){if(null==B&&(B=new Atalasoft.Annotations.FontUI(O.font)),S){var o=S.removed!==!0?S:null;k.unbind(o,{showeditor:d,hideeditor:c})}var n=j,r=O.autoscale;S=r?e.atalaImage():e.html(),(!S.isHtml||r)&&(S.renderer=new Atalasoft.Annotations.AnnotationTextRenderer(t.get(),B),m=w),null!=U&&e._page&&(e._page.append(U),e._page.bind(I)),Raphael.vml&&(t.getObject().node.style.overflow="hidden"),S.transform(v().toTransformString(!0)),k.bind(S,{showeditor:d,hideeditor:c}),n&&d()}function a(){U&&U.remove(),T&&T.remove(),B&&B.dispose(),S&&S.remove(),e&&e._page&&e._page.unbind(I),t.unbind(R),M=null,k=null,U=null,B=null,T=null,S=null,O=null}function i(t){t&&A.extend(O,t)}function l(t){return t?O[t]:O}function s(){return B}function d(){U||u(),g()}function h(e){e.stopPropagation(),O.value!==U.val()&&(O.value=U.val(),t.set({text:O}))}function u(){U=A("<textarea/>").hide(),e._page&&(e._page.append(U),e._page.bind(I)),U.bind("change keydown mouseup mousemove mousedown",h),U.bind({blur:c}),t.bind({deselected:c});var o=t.getObject();if(U.css({position:"absolute","overflow-x":"auto","overflow-y":"auto","z-index":99999,border:"0px solid",padding:"0px","background-color":"transparent"}),Atalasoft.Utils.Browser.Mobile.Any()){var n=t.get(),r=Atalasoft.Utils.getSVGOffset(e.canvas,e._page);U.css({left:n.x+r.left+"px",top:n.y+r.top+"px",width:n.width+"px","max-width":n.width+"px",height:n.height+"px","max-height":n.height+"px",border:o.attr("stroke")+" "+o.attr("strokewidth")+"px","background-color":o.attr("fill")})}B.setZoom(t.getZoom()),(Atalasoft.Utils.Browser.Chrome||Atalasoft.Utils.Browser.Safari)&&U.css({resize:"none"}),null!=O.value&&U.val(O.value),O.readonly&&U.prop("readonly","readonly"),B.repaint(U)}function g(){var e=t?t.get("visible"):!0;e&&((U.is(":hidden")||!j)&&(S.hide(),U.prop("readonly",O.readonly?"readonly":""),U.show(),x()),Atalasoft.Utils.Browser.Touch&&U.focus(function(){U[0].setSelectionRange(0,9999)}),Atalasoft.Utils.Browser.Explorer&&7===parseInt(Atalasoft.Utils.Browser.Version,10)||U[0].focus(),j=!0)}function c(){U&&((U.is(":visible")||j)&&(U.hide(),S.show(),x()),U[0].blur(),j=!1)}function f(){var e=t?t.get("visible"):!0;e?j?d():S.show():S.hide(),S.backgroundColor&&S.backgroundColor(t.get("fill").color)}function p(t){t&&(e!==t||S.removed)&&(e=t,null!=T&&(T.remove(),T=null),r(),f())}function x(o){if(p(o),m(),U&&(!U.is(":hidden")||j)){var n=t.get("outline").width/2,r=t.get(),a=t.getZoom(),i=t.getBox(),l=v(),s=y(l,i.x,i.y),d=y(l,i.x+i.width,i.y+i.height),h=i.width*a,u=i.height*a,g={x:(s.x+d.x-h)/2,y:(s.y+d.y-u)/2},c=V*a,f=n*a,x=2*(c+f),w=Math.max(Math.ceil(h-x),z.width),b=Math.max(Math.ceil(u-x),z.height),M=Atalasoft.Utils.getSVGOffset(e.canvas,e._page),k=r.rotation+_.getPageRotation(t._pageindex),T=0!==k?"rotate("+k+"deg)":"",S={left:Math.round(g.x+M.left+f)+"px",top:Math.round(g.y+M.top+f)+"px",width:w+"px",height:b+"px","max-width":w+"px","max-height":b+"px",padding:Math.ceil(c)+"px"};if(A.extend(S,Atalasoft.Utils.__htmlTransformStyle(T)),Atalasoft.Utils.Browser.Explorer8){var I=t.getObject(),R=I.attr("strokewidth")||1;U.css({border:"solid "+R+"px "+I.attr("stroke"),"background-color":I.attr("fill")})}U.css(S)}B&&(B.set(O.font),B.setZoom(t.getZoom()),B.repaint(U))}function m(){var e=t.get();T||(T=A('<textarea selectable="false"/>'),A(S.innerDom).append(T),T.css({"background-color":"transparent",border:"0px solid","overflow-x":"hidden","overflow-y":"hidden","-moz-user-select":"none","-khtml-user-select":"none","-webkit-user-select":"none","user-select":"none",resize:"none",cursor:"inherit"}),T.attr("readonly","readonly"),T.bind({focus:function(){return this.blur(),!1}}),T[0].raphaelParent=!0),T.val(O.value);var o=t.get("outline").width/2,n=Math.max(Math.ceil(e.width-2*(o+V)),1),r=Math.max(Math.ceil(e.height-2*(o+V)),1);if(B&&(B.set(O.font),B.repaint(T,1,!0)),T.css({width:n+"px",height:r+"px","max-width":n+"px","max-height":r+"px",padding:V+"px"}),S.attr({x:Math.round(o+e.x),y:Math.round(o+e.y),width:e.width,height:e.height}),e.cornerradius>=0){var a=t.getObject();A(a[0]).attr({rx:e.cornerradius||0,ry:e.cornerradius||0})}S.transform(v().toTransformString(!0))}function w(){var e=t.get("outline").width/2,o=t.get(),n=Math.max(Math.ceil(o.width-2*(e+V)),0),r=Math.max(Math.ceil(o.height-2*(e+V)),0);if(B&&B.set(O.font),S.attr({x:Math.round(e+V+o.x),y:Math.round(e+V+o.y),width:n,height:r}),o.cornerradius>=0){var a=t.getObject();A(a[0]).attr({rx:o.cornerradius||0,ry:o.cornerradius||0})}S.renderer&&S.renderer.renderToSVGImage(S[0],{width:n,height:r}),S.transform(v().toTransformString(!0))}function v(){var e=Raphael.matrix();return e.add(_.getViewerTransform(t._pageindex)),e.add(t.getTransform()),e}function b(){S&&x()}function y(t,e,o){return{x:t.x(e,o),y:t.y(e,o)}}var A=Atalasoft.$,M=this,_=o,k=t.getEventObject(),U=null,T=null,B=null,S=null,O=t.get("text"),j=!1,V=3,z=Atalasoft.Utils.Browser.Mobile.Any()?{width:200,height:200}:{width:1,height:1},I={},R={moving:b,resized:b,moved:b,rotated:b};n(),M.dispose=a,M.set=i,M.get=l,M.getFont=s,M.updateView=f,M.changepaper=p,M.repaint=x};
...
function P(){}function I(){}function M(){}/**
     ...
     * @returns {number}
     */
function T(){return Nt}function C(e){var t=1,o=function(){t--,0>=t&&(l()&&an&&Zt&&d(Zt,!0),"function"==typeof e&&e.call())};l()&&(an?an.closeDocument(n(),Jt):Zt.isReady()&&(t++,Zt.empty(o))),F(o)}function F(){}function q(){l()&&(an?an.closeDocument(n(),Jt):Zt.empty(),u()),A(),Zt=null,Gt=null}function A(){}function k(e,t,o,a){ct(),null==a&&("function"==typeof t?(a=t,t=null):"function"==typeof o&&(a=o,o=null));var i=function(e){O(),It(e,a)};"string"==typeof e&&an.closeDocument(n(),Jt),E(e,t,o,i)}function E(){}function O(){Bt.scrollTo(0,0,!1)}function S(e){sn.base&&(0>Nt&&(Nt=0),Yt.each(sn.base.dom.pageDivs,function(t,n){var o=!1;n._index===Nt&&e?(n.addClass(Bt.domclasses.atala_active_thumb),o=!0):n.removeClass(Bt.domclasses.atala_active_thumb),U(n,o)}))}/**
